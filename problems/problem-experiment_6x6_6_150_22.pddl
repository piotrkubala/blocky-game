(define (problem problem-experiment_6x6_6_150_22)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_19 key_brown)
            (contains room_22 terminal)
            (contains room_25 key_blue)
            (contains room_26 key_violet)
            (contains room_3 key_pink)
            (contains room_32 key_turquoise)
            ...
            (passage room_1 entrance_35 down)
            (passage room_1 entrance_36 up)
            (passage room_10 entrance_48 down)
            (passage room_13 entrance_21 right)
            (passage room_13 entrance_22 up)
            (passage room_13 entrance_31 down)
            (passage room_13 entrance_32 left)
            (passage room_14 entrance_4 up)
            (passage room_14 entrance_5 right)
            (passage room_15 entrance_6 left)
            ...
            (passage room_19 entrance_25 right)
            (passage room_2 entrance_23 down)
            (passage room_2 entrance_24 left)
            (passage room_2 entrance_29 right)
            (passage room_2 entrance_44 up)
            (passage room_21 entrance_16 right)
            ...
            (passage room_25 entrance_27 down)
            (passage room_25 entrance_42 right)
            (passage room_25 entrance_43 left)
            (passage room_26 entrance_41 down)
            (passage room_27 entrance_33 right)
            (passage room_27 entrance_34 up)
            (passage room_28 entrance_18 down)
            (passage room_28 entrance_19 up)
            (passage room_28 entrance_30 right)
            (passage room_29 entrance_46 down)
            (passage room_29 entrance_47 up)
            (passage room_3 entrance_1 down)
            (passage room_32 entrance_26 right)
            (passage room_33 entrance_13 down)
            (passage room_33 entrance_14 left)
            (passage room_33 entrance_28 right)
            (passage room_34 entrance_12 right)
            (passage room_6 entrance_39 right)
            (passage room_6 entrance_40 up)
            (passage room_8 entrance_2 up)
            (passage room_8 entrance_20 left)
            (passage room_8 entrance_3 down))
        (:goal
            (escaped player))
)
