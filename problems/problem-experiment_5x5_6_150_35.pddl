(define (problem problem-experiment_5x5_6_150_35)
    (:domain blocky-game)
        (:objects
            grey - colour
            indigo - colour
        ...
        (:init
            ...
            (passage room_11 entrance_12 left)
            (passage room_11 entrance_13 right)
            ...
            (passage room_17 entrance_25 right)
            ...
            (passage room_4 entrance_10 down)
