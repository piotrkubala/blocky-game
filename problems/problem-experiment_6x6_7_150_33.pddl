(define (problem problem-experiment_6x6_7_150_33)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_23 entrance_12 down)
            (passage room_23 entrance_13 left)
            ...
            (passage room_32 entrance_16 up)
            ...
            (passage room_33 entrance_5 right)
            (passage room_34 entrance_6 left)
            (passage room_34 entrance_9 right)
            (passage room_4 entrance_25 down)
            (passage room_8 entrance_23 down)
            (passage room_8 entrance_24 up))
        (:goal
            (escaped player))
)
