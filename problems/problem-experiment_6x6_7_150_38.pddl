(define (problem problem-experiment_6x6_7_150_38)
    (:domain blocky-game)
        (:objects
            beige - colour
            gold - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_0 key_red)
            (contains room_21 key_orange)
            (contains room_25 main_exit)
            (contains room_28 key_white)
            (contains room_29 key_grey)
            (contains room_31 terminal)
            (contains room_33 key_gold)
            (contains room_4 key_beige)
            (contains room_5 key_yellow)
            (free place63)
            ...
            (has_door entrance_40 yellow)
            (has_door entrance_41 yellow)
            ...
            (passage room_0 entrance_49 right)
            (passage room_0 entrance_61 left)
            (passage room_1 entrance_47 down)
            (passage room_1 entrance_48 left)
            (passage room_1 entrance_60 right)
            (passage room_10 entrance_4 right)
            (passage room_10 entrance_5 left)
            (passage room_11 entrance_2 up)
            (passage room_11 entrance_3 left)
            (passage room_11 entrance_53 down)
            (passage room_11 entrance_59 right)
            (passage room_13 entrance_12 up)
            (passage room_13 entrance_13 down)
            (passage room_14 entrance_30 down)
            (passage room_14 entrance_31 up)
            (passage room_15 entrance_43 down)
            (passage room_15 entrance_44 left)
            (passage room_16 entrance_45 right)
            (passage room_16 entrance_46 up)
            (passage room_18 entrance_16 right)
            (passage room_18 entrance_17 down)
            (passage room_19 entrance_14 up)
            (passage room_19 entrance_15 left)
            (passage room_2 entrance_56 left)
            (passage room_2 entrance_57 right)
            (passage room_20 entrance_26 left)
            (passage room_20 entrance_27 up)
            (passage room_20 entrance_38 down)
            (passage room_21 entrance_36 left)
            (passage room_24 entrance_18 up)
            (passage room_24 entrance_19 down)
            (passage room_25 entrance_62 left)
            (passage room_26 entrance_28 down)
            (passage room_26 entrance_29 up)
            (passage room_27 entrance_24 left)
            (passage room_27 entrance_25 right)
            (passage room_28 entrance_52 up)
            (passage room_29 entrance_50 down)
            (passage room_30 entrance_20 up)
            (passage room_30 entrance_21 right)
            (passage room_31 entrance_22 left)
            (passage room_31 entrance_23 right)
            (passage room_31 entrance_37 up)
            (passage room_31 entrance_51 down)
            (passage room_32 entrance_40 right)
            (passage room_32 entrance_41 up)
            (passage room_33 entrance_58 left)
            (passage room_34 entrance_34 left)
            (passage room_34 entrance_35 right)
            (passage room_34 entrance_39 down)
            (passage room_4 entrance_33 down)
            (passage room_5 entrance_1 down)
            (passage room_6 entrance_54 left)
            (passage room_6 entrance_55 right)
            (passage room_7 entrance_10 right)
            (passage room_7 entrance_11 down)
            (passage room_7 entrance_32 up)
            (passage room_8 entrance_42 down)
            (passage room_8 entrance_8 right)
            (passage room_8 entrance_9 left)
            (passage room_9 entrance_6 right)
            (passage room_9 entrance_7 left))
        (:goal
            (escaped player))
)
