(define (problem problem-experiment_6x6_9_150_6)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_1 entrance_13 down)
            (passage room_1 entrance_22 up)
            (passage room_10 entrance_19 left)
            (passage room_11 entrance_24 down)
            (passage room_11 entrance_25 up)
            (passage room_13 entrance_34 left)
            ...
            (passage room_17 entrance_30 right)
            (passage room_18 entrance_10 right)
            (passage room_18 entrance_11 left)
            (passage room_18 entrance_40 down)
            (passage room_19 entrance_37 left)
            (passage room_20 entrance_1 down)
            (passage room_21 entrance_26 down)
            (passage room_21 entrance_27 up)
            (passage room_22 entrance_28 down)
            (passage room_24 entrance_21 up)
            (passage room_24 entrance_6 right)
            (passage room_24 entrance_7 down)
            (passage room_25 entrance_4 right)
            (passage room_25 entrance_5 left)
            (passage room_26 entrance_17 down)
            (passage room_26 entrance_18 right)
            (passage room_26 entrance_2 up)
            (passage room_26 entrance_3 left)
