(define (problem problem-experiment_6x6_7_150_36)
    (:domain blocky-game)
        (:objects
            brown - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_17 entrance_3 up)
            (passage room_17 entrance_4 left)
            (passage room_21 entrance_33 right)
            (passage room_22 entrance_27 left)
            ...
            (passage room_26 entrance_21 left)
            (passage room_31 entrance_17 up)
            (passage room_31 entrance_18 right)
            (passage room_34 entrance_25 left)
            (passage room_34 entrance_26 right)
