(define (problem problem-experiment_5x5_6_150_14)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_1 entrance_21 left)
            (passage room_1 entrance_22 right)
            ...
            (passage room_12 entrance_3 down)
