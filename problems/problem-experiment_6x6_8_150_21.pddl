(define (problem problem-experiment_6x6_8_150_21)
    (:domain blocky-game)
        (:objects
            cyan - colour
            green - colour
        ...
        (:init
            ...
            (passage room_0 entrance_38 left)
            (passage room_10 entrance_40 up)
            (passage room_11 entrance_1 down)
            (passage room_15 entrance_15 down)
            (passage room_15 entrance_16 up)
            (passage room_16 entrance_19 left)
            (passage room_16 entrance_20 up)
            (passage room_16 entrance_4 right)
            (passage room_16 entrance_5 down)
            (passage room_17 entrance_2 up)
            (passage room_17 entrance_3 left)
            (passage room_17 entrance_45 right)
            (passage room_19 entrance_41 up)
            (passage room_19 entrance_42 down)
            (passage room_19 entrance_46 left)
            (passage room_2 entrance_36 down)
            (passage room_2 entrance_37 right)
            (passage room_20 entrance_11 down)
            (passage room_20 entrance_12 right)
            (passage room_20 entrance_23 left)
            (passage room_21 entrance_22 left)
            (passage room_21 entrance_33 up)
            ...
            (passage room_24 entrance_30 down)
            (passage room_24 entrance_31 up)
            (passage room_25 entrance_24 right)
            (passage room_25 entrance_25 left)
            (passage room_26 entrance_43 right)
            (passage room_27 entrance_52 left)
            (passage room_28 entrance_10 up)
            (passage room_28 entrance_9 left)
            (passage room_29 entrance_13 left)
            (passage room_29 entrance_14 up)
            (passage room_3 entrance_34 down)
            (passage room_3 entrance_35 up)
            (passage room_3 entrance_44 left)
            (passage room_31 entrance_26 right)
            (passage room_31 entrance_27 up)
            (passage room_32 entrance_49 right)
            (passage room_32 entrance_50 up)
            (passage room_34 entrance_53 down)
            (passage room_4 entrance_21 down)
            (passage room_5 entrance_17 down)
            (passage room_5 entrance_18 right)
            (passage room_6 entrance_32 down)
            (passage room_6 entrance_47 right)
            (passage room_6 entrance_48 left)
            (passage room_8 entrance_51 down)
            (passage room_9 entrance_28 down)
            (passage room_9 entrance_29 up))
        (:goal
            (escaped player))
)
