(define (problem problem-experiment_6x6_9_150_19)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_14 entrance_25 right)
            (passage room_14 entrance_26 left)
            ...
            (passage room_2 entrance_18 down)
            (passage room_20 entrance_31 right)
            (passage room_21 entrance_43 left)
            (passage room_21 entrance_44 right)
            (passage room_23 entrance_40 up)
            (passage room_23 entrance_41 right)
            (passage room_24 entrance_10 up)
            (passage room_24 entrance_11 right)
            (passage room_24 entrance_32 left)
            ...
            (passage room_26 entrance_45 left)
            (passage room_26 entrance_46 down)
            (passage room_27 entrance_37 up)
            (passage room_27 entrance_38 down)
            (passage room_27 entrance_47 right)
            (passage room_28 entrance_49 up)
            (passage room_29 entrance_22 up)
            (passage room_29 entrance_39 down)
            (passage room_33 entrance_42 left)
            (passage room_33 entrance_48 down)
            (passage room_34 entrance_35 up)
            (passage room_34 entrance_36 down)
            (passage room_4 entrance_28 right)
            (passage room_4 entrance_29 left)
            (passage room_6 entrance_2 up)
            (passage room_6 entrance_3 right)
            (passage room_6 entrance_34 down)
            (passage room_7 entrance_17 up)
            (passage room_7 entrance_4 left)
            (passage room_7 entrance_5 down)
            (passage room_8 entrance_19 right)
            (passage room_8 entrance_20 left)
            (passage room_9 entrance_15 down)
            (passage room_9 entrance_21 right))
        (:goal
            (escaped player))
)
