(define (problem problem-experiment_6x6_7_150_6)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_18 entrance_35 left)
            ...
            (passage room_23 entrance_29 right)
            ...
            (passage room_6 entrance_36 down)
