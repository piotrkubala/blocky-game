(define (problem problem-experiment_6x6_6_150_34)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_10 entrance_23 left)
            ...
            (passage room_27 entrance_36 left)
