(define (problem problem-experiment_6x6_8_150_23)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (contains room_1 key_black)
            (contains room_10 main_exit)
            (contains room_17 key_gold)
            (contains room_22 key_indigo)
            (contains room_23 key_yellow)
            (contains room_24 key_violet)
            (contains room_25 key_beige)
            (contains room_27 key_pink)
            ...
            (passage room_0 entrance_49 down)
            (passage room_1 entrance_36 down)
            (passage room_1 entrance_39 right)
            (passage room_1 entrance_40 up)
            (passage room_10 entrance_60 down)
            (passage room_12 entrance_58 down)
            (passage room_12 entrance_59 up)
            (passage room_14 entrance_10 right)
            (passage room_14 entrance_11 left)
            (passage room_14 entrance_30 down)
            (passage room_14 entrance_31 up)
            (passage room_15 entrance_32 down)
            (passage room_15 entrance_33 up)
            (passage room_15 entrance_8 right)
            (passage room_15 entrance_9 left)
            (passage room_16 entrance_57 up)
            (passage room_16 entrance_6 down)
            (passage room_16 entrance_7 left)
            (passage room_17 entrance_34 down)
            (passage room_18 entrance_15 right)
            (passage room_18 entrance_16 up)
            (passage room_19 entrance_55 right)
            (passage room_19 entrance_56 up)
            (passage room_2 entrance_47 right)
            (passage room_2 entrance_48 up)
            (passage room_21 entrance_4 down)
            (passage room_21 entrance_5 up)
            (passage room_22 entrance_28 up)
            (passage room_23 entrance_12 right)
            (passage room_23 entrance_25 up)
            (passage room_23 entrance_50 left)
            (passage room_24 entrance_19 down)
            (passage room_24 entrance_35 up)
            (passage room_24 entrance_37 right)
            (passage room_24 entrance_38 left)
            (passage room_25 entrance_43 down)
            (passage room_27 entrance_1 right)
            (passage room_28 entrance_2 left)
            (passage room_28 entrance_20 right)
            (passage room_28 entrance_3 up)
            (passage room_29 entrance_17 down)
            (passage room_29 entrance_18 up)
            (passage room_3 entrance_51 right)
            (passage room_3 entrance_52 left)
            (passage room_30 entrance_13 down)
            (passage room_30 entrance_14 left)
            (passage room_30 entrance_44 right)
            (passage room_32 entrance_26 left)
            (passage room_32 entrance_27 down)
            (passage room_33 entrance_53 right)
            (passage room_33 entrance_54 left)
            (passage room_6 entrance_21 left)
            (passage room_6 entrance_22 down)
            (passage room_6 entrance_29 up)
            (passage room_7 entrance_23 up)
            (passage room_7 entrance_24 down)
            (passage room_8 entrance_45 right)
            (passage room_8 entrance_46 left)
            (passage room_9 entrance_41 down)
            (passage room_9 entrance_42 up))
        (:goal
            (escaped player))
)
