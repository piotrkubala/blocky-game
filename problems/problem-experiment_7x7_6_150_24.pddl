(define (problem problem-experiment_7x7_6_150_24)
    (:domain blocky-game)
        (:objects
            black - colour
            navy - colour
        ...
        (:init
            ...
            (passage room_11 entrance_3 right)
            (passage room_12 entrance_14 down)
            (passage room_12 entrance_4 left)
            (passage room_12 entrance_5 up)
            ...
            (passage room_24 entrance_33 up)
            (passage room_25 entrance_26 right)
            (passage room_25 entrance_27 left)
            (passage room_26 entrance_17 up)
            (passage room_26 entrance_18 down)
            (passage room_26 entrance_25 left)
            (passage room_28 entrance_24 up)
            ...
            (passage room_35 entrance_28 right)
            (passage room_35 entrance_29 left)
            (passage room_46 entrance_30 right)
            (passage room_46 entrance_31 down)
            (passage room_47 entrance_19 up)
            (passage room_47 entrance_20 down)
            (passage room_5 entrance_12 right)
            (passage room_5 entrance_6 down)
            (passage room_8 entrance_32 up)
            (passage room_9 entrance_11 right))
        (:goal
            (escaped player))
)
