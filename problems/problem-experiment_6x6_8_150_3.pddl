(define (problem problem-experiment_6x6_8_150_3)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_14 entrance_35 up)
            (passage room_14 entrance_4 left)
            (passage room_14 entrance_43 right)
            (passage room_14 entrance_5 down)
            (passage room_16 entrance_40 up)
            (passage room_18 entrance_24 down)
            ...
            (passage room_20 entrance_41 right)
            (passage room_20 entrance_6 up)
            (passage room_20 entrance_7 left)
            (passage room_21 entrance_49 left)
            ...
            (passage room_28 entrance_52 left)
            (passage room_29 entrance_46 up)
            (passage room_29 entrance_47 left)
            ...
            (passage room_32 entrance_45 up)
