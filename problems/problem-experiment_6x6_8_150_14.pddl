(define (problem problem-experiment_6x6_8_150_14)
    (:domain blocky-game)
        (:objects
            black - colour
            green - colour
        ...
        (:init
            ...
            (passage room_13 entrance_26 right)
            ...
            (passage room_19 entrance_8 right)
            (passage room_19 entrance_9 up)
            (passage room_20 entrance_11 up)
            (passage room_20 entrance_6 right)
            (passage room_20 entrance_7 left)
            (passage room_21 entrance_4 right)
            ...
            (passage room_7 entrance_33 down)
            (passage room_7 entrance_34 right)
            (passage room_8 entrance_31 left)
