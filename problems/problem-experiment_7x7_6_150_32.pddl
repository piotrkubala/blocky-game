(define (problem problem-experiment_7x7_6_150_32)
    (:domain blocky-game)
        (:objects
            black - colour
            grey - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_13 key_turquoise)
            (contains room_19 key_red)
            (contains room_2 main_exit)
            (contains room_26 terminal)
            (contains room_29 key_black)
            (contains room_32 key_purple)
            (contains room_42 key_grey)
            (contains room_44 key_white)
            (free place72)
            ...
            (passage room_3 entrance_30 down)
            (passage room_3 entrance_31 up)
            (passage room_30 entrance_14 right)
            (passage room_30 entrance_15 left)
            (passage room_30 entrance_37 down)
            (passage room_31 entrance_12 down)
            (passage room_31 entrance_13 left)
            (passage room_32 entrance_1 right)
            (passage room_33 entrance_2 left)
            ...
            (passage room_36 entrance_17 left)
            (passage room_37 entrance_10 right)
            (passage room_37 entrance_11 up)
            (passage room_38 entrance_8 right)
            (passage room_38 entrance_9 left)
            (passage room_39 entrance_6 down)
            (passage room_39 entrance_7 left)
            (passage room_42 entrance_18 right)
            (passage room_44 entrance_40 right)
            (passage room_9 entrance_44 down)
            (passage room_9 entrance_45 up))
        (:goal
            (escaped player))
)
