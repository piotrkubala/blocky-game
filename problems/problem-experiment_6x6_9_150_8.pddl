(define (problem problem-experiment_6x6_9_150_8)
    (:domain blocky-game)
        (:objects
            black - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_16 entrance_30 right)
            (passage room_16 entrance_31 left)
            (passage room_17 entrance_18 down)
            (passage room_17 entrance_19 left)
            (passage room_18 entrance_22 right)
            ...
            (passage room_21 entrance_29 left)
            ...
            (passage room_25 entrance_34 down)
            (passage room_28 entrance_35 up)
            (passage room_29 entrance_21 right)
            ...
            (passage room_5 entrance_27 left)
