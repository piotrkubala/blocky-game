(define (problem problem-experiment_7x7_6_150_1)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_10 entrance_15 right)
            ...
            (passage room_18 entrance_16 left)
            (passage room_20 entrance_29 left)
            (passage room_20 entrance_30 right)
            (passage room_22 entrance_4 up)
            (passage room_22 entrance_5 down)
            (passage room_23 entrance_42 left)
            (passage room_24 entrance_8 left)
            (passage room_24 entrance_9 up)
            (passage room_27 entrance_19 left)
            (passage room_27 entrance_20 up)
            (passage room_27 entrance_24 right)
            (passage room_29 entrance_37 down)
            (passage room_29 entrance_6 up)
            (passage room_29 entrance_7 right)
            (passage room_32 entrance_38 up)
            (passage room_32 entrance_39 right)
            (passage room_34 entrance_21 down)
            (passage room_34 entrance_22 up)
            (passage room_34 entrance_27 left)
            (passage room_34 entrance_28 right)
            (passage room_38 entrance_31 left)
            (passage room_38 entrance_32 down)
            (passage room_39 entrance_35 up)
            (passage room_45 entrance_33 up)
            (passage room_45 entrance_34 down)
            (passage room_5 entrance_25 left)
            (passage room_5 entrance_26 right)
            (passage room_6 entrance_23 down)
            (passage room_7 entrance_36 down)
            (passage room_9 entrance_12 down)
            (passage room_9 entrance_13 right)
            (passage room_9 entrance_17 up))
        (:goal
            (escaped player))
)
