(define (problem problem-experiment_6x6_7_150_3)
    (:domain blocky-game)
        ...
        (:init
            ...
            (passage room_0 entrance_23 up)
            (passage room_1 entrance_14 right)
            (passage room_1 entrance_15 down)
            ...
            (passage room_19 entrance_34 left)
            ...
            (passage room_8 entrance_26 up)
            (passage room_8 entrance_37 left)
            (passage room_8 entrance_38 right)
