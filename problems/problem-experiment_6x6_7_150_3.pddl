(define (problem problem-experiment_6x6_7_150_3)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (contains room_27 key_turquoise)
            ...
            (passage room_1 entrance_45 left)
            (passage room_10 entrance_4 up)
            (passage room_10 entrance_5 down)
            (passage room_11 entrance_32 up)
            (passage room_11 entrance_33 left)
            ...
            (passage room_16 entrance_46 right)
            (passage room_16 entrance_8 left)
            (passage room_16 entrance_9 down)
            (passage room_19 entrance_34 right)
            (passage room_2 entrance_18 right)
            (passage room_2 entrance_19 left)
            (passage room_20 entrance_27 up)
            (passage room_20 entrance_28 left)
            (passage room_21 entrance_10 up)
            ...
            (passage room_27 entrance_35 up)
            (passage room_28 entrance_12 up)
            (passage room_28 entrance_13 down)
            (passage room_29 entrance_38 up)
            (passage room_29 entrance_39 left)
            (passage room_3 entrance_1 right)
            (passage room_30 entrance_30 right)
            (passage room_30 entrance_31 down)
            (passage room_33 entrance_14 up)
            (passage room_34 entrance_21 up)
            (passage room_34 entrance_22 down)
            (passage room_4 entrance_15 right)
            (passage room_4 entrance_2 left)
            (passage room_4 entrance_3 down)
            (passage room_5 entrance_16 right)
            (passage room_5 entrance_17 left)
            (passage room_7 entrance_20 right)
            (passage room_9 entrance_23 up)
            (passage room_9 entrance_24 down)
            (passage room_9 entrance_41 right))
        (:goal
            (escaped player))
)
