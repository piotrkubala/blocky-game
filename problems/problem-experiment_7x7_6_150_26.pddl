(define (problem problem-experiment_7x7_6_150_26)
    (:domain blocky-game)
        (:objects
            gold - colour
            indigo - colour
        ...
        (:init
            ...
            (contains room_26 key_indigo)
            (contains room_27 key_pink)
            (contains room_3 main_exit)
            (contains room_32 terminal)
            (contains room_34 key_turquoise)
            (contains room_38 key_gold)
            (free place15)
            ...
            (passage room_10 entrance_44 down)
            (passage room_10 entrance_45 left)
            (passage room_11 entrance_17 right)
            (passage room_11 entrance_18 down)
            (passage room_12 entrance_55 down)
            (passage room_12 entrance_56 right)
            (passage room_15 entrance_6 up)
            (passage room_15 entrance_7 down)
            (passage room_16 entrance_33 up)
            (passage room_16 entrance_34 down)
            ...
            (passage room_2 entrance_57 up)
            (passage room_21 entrance_46 right)
            (passage room_22 entrance_25 right)
            (passage room_22 entrance_8 up)
            (passage room_22 entrance_9 down)
            (passage room_23 entrance_19 up)
            (passage room_23 entrance_20 down)
            (passage room_24 entrance_21 up)
            (passage room_24 entrance_22 down)
            (passage room_24 entrance_35 left)
            (passage room_25 entrance_40 left)
            (passage room_25 entrance_41 down)
            (passage room_26 entrance_42 up)
            (passage room_26 entrance_54 left)
            (passage room_27 entrance_38 up)
            (passage room_28 entrance_28 right)
            (passage room_28 entrance_29 left)
            (passage room_29 entrance_10 up)
            (passage room_29 entrance_11 right)
            (passage room_29 entrance_27 left)
            (passage room_3 entrance_60 down)
            (passage room_30 entrance_12 left)
            (passage room_30 entrance_13 right)
            (passage room_31 entrance_14 left)
            (passage room_31 entrance_15 right)
            (passage room_31 entrance_26 up)
            (passage room_32 entrance_16 left)
            (passage room_32 entrance_39 right)
            (passage room_32 entrance_43 up)
            (passage room_33 entrance_47 left)
            (passage room_33 entrance_48 up)
            (passage room_34 entrance_32 up)
            (passage room_35 entrance_30 right)
            (passage room_35 entrance_31 down)
            (passage room_38 entrance_49 down)
            (passage room_38 entrance_52 left)
            (passage room_38 entrance_53 right)
            (passage room_43 entrance_50 down)
            (passage room_43 entrance_51 right)
            (passage room_47 entrance_23 up)
            (passage room_47 entrance_24 left)
            (passage room_7 entrance_58 down)
            (passage room_7 entrance_59 up)
