(define (problem problem-experiment_6x6_8_150_35)
    (:domain blocky-game)
        (:objects
            brown - colour
            indigo - colour
        ...
        (:init
            ...
            (contains room_34 key_violet)
            (contains room_4 key_navy)
            (contains room_8 key_orange)
            (contains room_9 key_pink)
            (free place46)
            ...
            (has_door entrance_44 navy)
            (has_door entrance_45 pink)
            (has_door entrance_46 brown)
            (has_door entrance_47 brown)
            ...
            (passage room_0 entrance_36 up)
            (passage room_0 entrance_37 down)
            (passage room_1 entrance_4 right)
            (passage room_1 entrance_5 down)
            (passage room_1 entrance_54 left)
            (passage room_10 entrance_43 up)
            (passage room_13 entrance_8 up)
            (passage room_13 entrance_9 down)
            (passage room_14 entrance_27 left)
            (passage room_14 entrance_28 right)
            (passage room_16 entrance_16 left)
            (passage room_16 entrance_17 right)
            (passage room_16 entrance_49 down)
            (passage room_17 entrance_29 left)
            (passage room_17 entrance_30 up)
            (passage room_17 entrance_39 down)
            (passage room_18 entrance_22 up)
            (passage room_18 entrance_23 left)
            (passage room_18 entrance_52 down)
            (passage room_19 entrance_10 up)
            (passage room_19 entrance_11 right)
            (passage room_19 entrance_21 down)
            (passage room_19 entrance_41 left)
            (passage room_2 entrance_2 right)
            (passage room_2 entrance_3 left)
            (passage room_21 entrance_55 right)
            (passage room_21 entrance_56 left)
            (passage room_22 entrance_14 left)
            (passage room_22 entrance_15 right)
            (passage room_22 entrance_42 down)
            (passage room_22 entrance_51 up)
            (passage room_25 entrance_12 left)
            (passage room_25 entrance_13 right)
            (passage room_25 entrance_59 up)
            (passage room_26 entrance_18 left)
            (passage room_26 entrance_19 down)
            (passage room_27 entrance_60 right)
            (passage room_28 entrance_50 up)
            (passage room_3 entrance_1 left)
            (passage room_30 entrance_34 right)
            (passage room_30 entrance_35 down)
            (passage room_30 entrance_47 up)
            (passage room_30 entrance_48 left)
            (passage room_31 entrance_57 right)
            (passage room_31 entrance_58 down)
            (passage room_32 entrance_31 down)
            (passage room_32 entrance_44 up)
            (passage room_32 entrance_53 left)
            (passage room_33 entrance_32 up)
            (passage room_33 entrance_33 left)
            (passage room_33 entrance_46 down)
            (passage room_34 entrance_20 up)
            (passage room_4 entrance_38 right)
            (passage room_6 entrance_24 right)
            (passage room_6 entrance_25 down)
            (passage room_6 entrance_45 up)
            (passage room_7 entrance_6 up)
            (passage room_7 entrance_7 down)
            (passage room_8 entrance_40 up)
            (passage room_9 entrance_26 up))
        (:goal
            (escaped player))
)
