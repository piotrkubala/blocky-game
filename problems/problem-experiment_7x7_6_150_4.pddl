(define (problem problem-experiment_7x7_6_150_4)
    (:domain blocky-game)
        (:objects
            brown - colour
            green - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_0 key_white)
            (contains room_11 key_green)
            (contains room_16 main_exit)
            (contains room_28 key_brown)
            (contains room_3 key_violet)
            (contains room_32 key_purple)
            (contains room_43 terminal)
            (contains room_46 key_grey)
            (free place37)
            (has_door entrance_1 violet)
            (has_door entrance_10 violet)
            ...
            (has_door entrance_7 violet)
            (has_door entrance_8 violet)
            (has_door entrance_9 violet)
            (in player room_3)
            (is key_brown brown)
            (is key_green green)
            (is key_grey grey)
            ...
            (passage room_1 entrance_51 down)
            (passage room_1 entrance_52 up)
            (passage room_10 entrance_2 up)
            (passage room_10 entrance_3 down)
            (passage room_11 entrance_29 down)
            (passage room_11 entrance_47 left)
            (passage room_11 entrance_48 right)
            (passage room_13 entrance_36 left)
            (passage room_13 entrance_37 right)
            (passage room_16 entrance_54 down)
            (passage room_17 entrance_4 up)
            (passage room_17 entrance_5 down)
            (passage room_18 entrance_27 down)
            (passage room_18 entrance_28 up)
            (passage room_20 entrance_41 down)
            (passage room_20 entrance_42 up)
            (passage room_21 entrance_43 down)
            (passage room_21 entrance_44 up)
            (passage room_22 entrance_19 down)
            (passage room_22 entrance_20 right)
            (passage room_23 entrance_6 up)
            (passage room_23 entrance_7 down)
            (passage room_24 entrance_25 left)
            (passage room_24 entrance_26 up)
            (passage room_28 entrance_46 down)
            (passage room_28 entrance_53 up)
            (passage room_29 entrance_10 right)
            (passage room_29 entrance_11 down)
            (passage room_3 entrance_1 down)
            (passage room_30 entrance_18 down)
            (passage room_30 entrance_8 up)
            (passage room_30 entrance_9 left)
            (passage room_31 entrance_23 down)
            (passage room_31 entrance_24 right)
            (passage room_32 entrance_45 down)
            (passage room_33 entrance_49 left)
            (passage room_33 entrance_50 up)
            (passage room_36 entrance_12 up)
            (passage room_36 entrance_13 down)
            (passage room_37 entrance_16 left)
            (passage room_37 entrance_17 up)
            (passage room_38 entrance_21 left)
            (passage room_38 entrance_22 up)
            (passage room_41 entrance_30 left)
            (passage room_41 entrance_31 right)
            (passage room_42 entrance_32 left)
            (passage room_42 entrance_33 right)
            (passage room_43 entrance_14 up)
            (passage room_43 entrance_15 right)
            (passage room_43 entrance_39 left)
            (passage room_45 entrance_34 left)
            (passage room_45 entrance_35 right)
            (passage room_46 entrance_38 left))
        (:goal
            (escaped player))
)
