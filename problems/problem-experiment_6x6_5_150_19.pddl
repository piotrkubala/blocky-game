(define (problem problem-experiment_6x6_5_150_19)
    (:domain blocky-game)
        (:objects
            black - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_18 entrance_32 left)
            ...
            (passage room_25 entrance_36 up)
            ...
            (passage room_28 entrance_22 right)
            ...
            (passage room_32 entrance_34 down)
            (passage room_8 entrance_4 up)
            (passage room_8 entrance_5 down)
            (passage room_9 entrance_24 right)
