(define (problem problem-experiment_6x6_7_150_19)
    (:domain blocky-game)
        (:objects
            cyan - colour
            grey - colour
        ...
        (:init
            ...
            (passage room_27 entrance_18 right)
            (passage room_27 entrance_19 left)
            (passage room_27 entrance_23 up)
            (passage room_28 entrance_10 down)
            (passage room_28 entrance_9 right)
            (passage room_3 entrance_29 down)
            (passage room_3 entrance_30 left)
            (passage room_30 entrance_11 up)
            ...
            (passage room_8 entrance_31 right)
            (passage room_8 entrance_32 left)
