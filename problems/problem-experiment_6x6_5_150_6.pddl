(define (problem problem-experiment_6x6_5_150_6)
    (:domain blocky-game)
        (:objects
            blue - colour
            green - colour
        ...
        (:init
            ...
            (contains room_27 key_violet)
            (contains room_31 key_green)
            (contains room_32 key_blue)
            ...
            (passage room_1 entrance_37 down)
            ...
            (passage room_2 entrance_33 left)
            ...
            (passage room_22 entrance_18 down)
            (passage room_24 entrance_25 up)
            (passage room_24 entrance_26 down)
            (passage room_27 entrance_21 up)
            (passage room_28 entrance_27 up)
            (passage room_28 entrance_28 down)
            (passage room_3 entrance_8 left)
            (passage room_3 entrance_9 right)
            (passage room_31 entrance_31 up)
            ...
            (passage room_5 entrance_10 left)
