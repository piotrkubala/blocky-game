(define (problem problem-experiment_6x6_5_150_34)
    (:domain blocky-game)
        (:objects
            blue - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_21 entrance_14 up)
            (passage room_21 entrance_15 down)
            (passage room_21 entrance_28 left)
            ...
            (passage room_29 entrance_30 left)
            (passage room_33 entrance_33 right)
            (passage room_33 entrance_34 left)
            (passage room_34 entrance_16 up)
            (passage room_4 entrance_12 right)
            (passage room_4 entrance_13 down)
            (passage room_5 entrance_37 up)
            (passage room_6 entrance_27 right)
            (passage room_7 entrance_26 left)
            (passage room_7 entrance_6 right)
            (passage room_7 entrance_7 up)
