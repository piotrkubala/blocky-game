(define (problem problem-experiment_5x5_6_150_33)
    (:domain blocky-game)
        (:objects
            black - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_11 entrance_18 right)
            ...
            (passage room_18 entrance_27 right)
            (passage room_19 entrance_38 right)
            (passage room_2 entrance_19 down)
            (passage room_2 entrance_20 left)
            ...
            (passage room_3 entrance_25 right)
            (passage room_3 entrance_26 left)
