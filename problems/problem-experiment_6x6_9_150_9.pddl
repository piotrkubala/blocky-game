(define (problem problem-experiment_6x6_9_150_9)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_18 key_indigo)
            (contains room_21 key_green)
            ...
            (contains room_33 key_orange)
            (contains room_4 key_blue)
            ...
            (passage room_10 entrance_40 right)
            (passage room_10 entrance_41 left)
            ...
            (passage room_16 entrance_42 right)
            (passage room_16 entrance_43 down)
            (passage room_18 entrance_26 right)
            (passage room_18 entrance_47 down)
            (passage room_18 entrance_48 left)
            (passage room_19 entrance_33 right)
            ...
            (passage room_22 entrance_15 down)
            (passage room_22 entrance_16 right)
            ...
            (passage room_25 entrance_38 down)
            (passage room_26 entrance_2 down)
            (passage room_26 entrance_3 up)
            (passage room_28 entrance_36 right)
            (passage room_29 entrance_18 down)
            ...
            (passage room_34 entrance_23 up)
            (passage room_4 entrance_17 left)
            (passage room_5 entrance_45 right)
            (passage room_5 entrance_46 up)
            (passage room_7 entrance_10 down)
            (passage room_7 entrance_11 left)
            (passage room_7 entrance_14 up)
            (passage room_8 entrance_27 right)
            (passage room_8 entrance_28 left)
            (passage room_9 entrance_31 right)
            (passage room_9 entrance_32 left))
        (:goal
            (escaped player))
)
