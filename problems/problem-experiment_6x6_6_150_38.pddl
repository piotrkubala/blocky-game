(define (problem problem-experiment_6x6_6_150_38)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_11 key_turquoise)
            (contains room_12 key_orange)
            (contains room_15 key_black)
            (contains room_16 key_beige)
            (contains room_18 key_brown)
            ...
            (passage room_0 entrance_23 right)
            (passage room_0 entrance_29 up)
            (passage room_10 entrance_41 right)
            (passage room_10 entrance_42 left)
            (passage room_11 entrance_50 down)
            (passage room_12 entrance_34 up)
            (passage room_13 entrance_11 up)
            (passage room_13 entrance_12 down)
            (passage room_13 entrance_17 left)
            (passage room_14 entrance_52 down)
            (passage room_14 entrance_53 left)
            (passage room_15 entrance_28 left)
            (passage room_16 entrance_24 left)
            (passage room_16 entrance_43 right)
            (passage room_16 entrance_44 up)
            (passage room_17 entrance_5 right)
            (passage room_17 entrance_6 down)
            (passage room_18 entrance_13 up)
            (passage room_2 entrance_39 right)
            (passage room_2 entrance_40 left)
            (passage room_20 entrance_35 right)
            (passage room_20 entrance_36 left)
            (passage room_20 entrance_54 up)
            (passage room_21 entrance_2 down)
            (passage room_21 entrance_3 right)
            (passage room_21 entrance_45 up)
            (passage room_22 entrance_14 down)
            (passage room_22 entrance_25 right)
            (passage room_22 entrance_4 left)
            (passage room_22 entrance_51 up)
            (passage room_24 entrance_18 up)
            (passage room_24 entrance_19 right)
            (passage room_25 entrance_46 down)
            (passage room_25 entrance_47 up)
            (passage room_26 entrance_48 down)
            (passage room_26 entrance_49 up)
            (passage room_27 entrance_1 up)
            (passage room_28 entrance_55 down)
            (passage room_28 entrance_56 up)
            (passage room_29 entrance_61 down)
            (passage room_3 entrance_7 up)
            (passage room_3 entrance_8 down)
            (passage room_30 entrance_32 right)
            (passage room_30 entrance_33 down)
            (passage room_32 entrance_20 left)
            (passage room_32 entrance_21 right)
            (passage room_33 entrance_59 down)
            (passage room_33 entrance_60 up)
            (passage room_4 entrance_15 up)
            (passage room_4 entrance_16 right)
            (passage room_6 entrance_37 right)
            (passage room_6 entrance_38 left)
            (passage room_7 entrance_30 right)
            (passage room_7 entrance_31 left)
            (passage room_8 entrance_26 left)
            (passage room_8 entrance_27 right)
            (passage room_8 entrance_57 down)
            (passage room_8 entrance_58 up)
            (passage room_9 entrance_10 down)
            (passage room_9 entrance_9 up))
        (:goal
            (escaped player))
)
