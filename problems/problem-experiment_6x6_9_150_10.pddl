(define (problem problem-experiment_6x6_9_150_10)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_18 entrance_23 right)
            (passage room_19 entrance_6 left)
            (passage room_19 entrance_7 up)
            (passage room_2 entrance_31 left)
            (passage room_2 entrance_35 right)
            (passage room_20 entrance_34 down)
            (passage room_21 entrance_21 right)
            (passage room_22 entrance_17 down)
            (passage room_22 entrance_18 up)
            (passage room_24 entrance_41 left)
            (passage room_25 entrance_28 down)
            (passage room_25 entrance_29 up)
            (passage room_26 entrance_10 left)
            ...
            (passage room_27 entrance_16 up)
            (passage room_28 entrance_44 down)
            (passage room_30 entrance_14 left)
            (passage room_30 entrance_26 right)
            (passage room_31 entrance_8 down)
            (passage room_31 entrance_9 right)
            ...
            (passage room_5 entrance_42 left)
            (passage room_7 entrance_19 down)
            (passage room_8 entrance_39 left)
            (passage room_8 entrance_40 right)
            (passage room_9 entrance_27 left))
        (:goal
            (escaped player))
)
