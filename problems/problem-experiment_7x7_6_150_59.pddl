(define (problem problem-experiment_7x7_6_150_59)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_10 key_gold)
            (contains room_25 key_cyan)
            (contains room_29 key_turquoise)
            (contains room_3 main_exit)
            (contains room_33 terminal)
            (contains room_42 key_orange)
            (contains room_43 key_purple)
            (contains room_44 key_indigo)
            (free place27)
            ...
            (has_door entrance_61 gold)
            (has_door entrance_62 gold)
            (has_door entrance_63 gold)
            (has_door entrance_64 gold)
            (has_door entrance_65 cyan)
            (has_door entrance_66 cyan)
            (has_door entrance_67 indigo)
            (has_door entrance_68 purple)
            (has_door entrance_69 purple)
            (has_door entrance_7 orange)
            (has_door entrance_70 purple)
            (has_door entrance_71 cyan)
            (has_door entrance_72 purple)
            (has_door entrance_73 turquoise)
            (has_door entrance_74 turquoise)
            ...
            (passage room_0 entrance_64 right)
            (passage room_0 entrance_65 left)
            (passage room_10 entrance_25 down)
            (passage room_10 entrance_46 left)
            (passage room_11 entrance_19 down)
            (passage room_11 entrance_20 left)
            (passage room_11 entrance_57 up)
            (passage room_13 entrance_58 down)
            (passage room_13 entrance_59 up)
            (passage room_15 entrance_35 down)
            (passage room_15 entrance_36 up)
            (passage room_15 entrance_68 left)
            (passage room_16 entrance_23 down)
            (passage room_16 entrance_24 up)
            (passage room_17 entrance_17 right)
            (passage room_17 entrance_18 up)
            (passage room_19 entrance_44 right)
            (passage room_19 entrance_45 up)
            (passage room_2 entrance_47 right)
            (passage room_2 entrance_48 left)
            (passage room_22 entrance_21 right)
            (passage room_22 entrance_22 up)
            (passage room_22 entrance_37 down)
            (passage room_22 entrance_38 left)
            (passage room_23 entrance_30 right)
            (passage room_23 entrance_31 up)
            (passage room_24 entrance_32 down)
            (passage room_24 entrance_33 left)
            (passage room_25 entrance_49 right)
            (passage room_26 entrance_15 right)
            (passage room_26 entrance_16 left)
            (passage room_26 entrance_43 down)
            (passage room_28 entrance_39 right)
            (passage room_28 entrance_40 left)
            (passage room_29 entrance_69 right)
            (passage room_29 entrance_70 down)
            (passage room_29 entrance_71 up)
            (passage room_3 entrance_74 down)
            (passage room_30 entrance_8 down)
            (passage room_30 entrance_9 right)
            (passage room_31 entrance_10 left)
            (passage room_31 entrance_11 right)
            (passage room_32 entrance_12 left)
            (passage room_32 entrance_13 right)
            (passage room_32 entrance_54 up)
            (passage room_33 entrance_14 left)
            (passage room_33 entrance_42 up)
            (passage room_35 entrance_2 down)
            (passage room_35 entrance_3 right)
            (passage room_35 entrance_34 up)
            (passage room_36 entrance_4 left)
            (passage room_36 entrance_5 right)
            (passage room_37 entrance_6 left)
            (passage room_37 entrance_7 up)
            (passage room_39 entrance_50 right)
            (passage room_39 entrance_51 up)
            (passage room_39 entrance_67 down)
            (passage room_4 entrance_60 down)
            (passage room_4 entrance_61 up)
            (passage room_40 entrance_26 right)
            (passage room_40 entrance_27 left)
            (passage room_42 entrance_1 up)
            (passage room_43 entrance_66 right)
            (passage room_44 entrance_41 right)
            (passage room_45 entrance_52 down)
            (passage room_45 entrance_53 left)
            (passage room_46 entrance_55 down)
            (passage room_46 entrance_56 up)
            (passage room_47 entrance_28 right)
            (passage room_47 entrance_29 left)
            (passage room_6 entrance_72 down)
            (passage room_6 entrance_73 up)
            (passage room_7 entrance_62 down)
            (passage room_7 entrance_63 left))
        (:goal
            (escaped player))
)
