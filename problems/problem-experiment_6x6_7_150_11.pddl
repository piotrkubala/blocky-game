(define (problem problem-experiment_6x6_7_150_11)
    (:domain blocky-game)
        (:objects
            blue - colour
            magenta - colour
        ...
        (:init
            ...
            (contains room_30 key_purple)
            (contains room_31 main_exit)
            (contains room_4 key_navy)
            (contains room_6 key_blue)
            ...
            (is key_white white)
            (passage room_0 entrance_11 right)
            (passage room_0 entrance_12 down)
            (passage room_1 entrance_48 right)
            (passage room_1 entrance_49 left)
            (passage room_10 entrance_1 left)
            (passage room_11 entrance_21 right)
            (passage room_11 entrance_5 up)
            ...
            (passage room_12 entrance_46 left)
            (passage room_14 entrance_34 down)
            ...
            (passage room_17 entrance_42 up)
            ...
            (passage room_22 entrance_31 down)
            (passage room_22 entrance_39 right)
            (passage room_22 entrance_52 up)
            (passage room_23 entrance_7 up)
            (passage room_23 entrance_8 left)
            (passage room_24 entrance_17 up)
            (passage room_24 entrance_50 right)
            (passage room_24 entrance_51 down)
            (passage room_25 entrance_36 right)
            (passage room_25 entrance_37 up)
            ...
            (passage room_30 entrance_28 right)
            ...
            (passage room_5 entrance_19 right)
