(define (problem problem-experiment_7x7_6_150_13)
    (:domain blocky-game)
        (:objects
            blue - colour
            magenta - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place24)
            (contains room_10 key_magenta)
            (contains room_11 key_pink)
            (contains room_29 key_turquoise)
            (contains room_36 main_exit)
            (contains room_38 key_navy)
            (contains room_41 key_blue)
            (contains room_8 key_yellow)
            ...
            (passage room_11 entrance_47 down)
            ...
            (passage room_15 entrance_12 left)
            (passage room_15 entrance_13 right)
            (passage room_15 entrance_30 down)
            (passage room_15 entrance_42 up)
            (passage room_16 entrance_14 left)
            ...
            (passage room_23 entrance_45 down)
            (passage room_23 entrance_46 up)
            (passage room_27 entrance_4 down)
            (passage room_27 entrance_5 up)
            (passage room_28 entrance_43 down)
            (passage room_28 entrance_44 up)
            (passage room_28 entrance_48 right)
            (passage room_28 entrance_49 left)
            (passage room_29 entrance_34 right)
            (passage room_30 entrance_24 up)
            (passage room_30 entrance_25 down)
            (passage room_30 entrance_38 right)
            (passage room_30 entrance_39 left)
            (passage room_34 entrance_2 down)
            (passage room_34 entrance_3 up)
            (passage room_34 entrance_40 right)
            (passage room_36 entrance_50 right)
            (passage room_37 entrance_36 right)
            (passage room_37 entrance_37 left)
            (passage room_38 entrance_26 up)
            (passage room_4 entrance_28 down)
            (passage room_4 entrance_29 up)
            (passage room_41 entrance_1 up)
            ...
            (passage room_6 entrance_33 left)
            (passage room_8 entrance_41 down)
            (passage room_9 entrance_16 down)
