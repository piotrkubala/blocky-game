(define (problem problem-experiment_6x6_8_150_11)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (at room_8 place24)
            (at room_9 place25)
            (contains room_12 key_brown)
            (contains room_14 key_magenta)
            (contains room_15 key_red)
            (contains room_18 key_grey)
            (contains room_2 terminal)
            (contains room_24 key_violet)
            (contains room_26 key_orange)
            (contains room_31 key_cyan)
            (contains room_34 key_blue)
            ...
            (passage room_0 entrance_49 left)
            (passage room_1 entrance_11 up)
            (passage room_1 entrance_12 right)
            (passage room_10 entrance_50 right)
            (passage room_10 entrance_51 left)
            (passage room_11 entrance_34 right)
            (passage room_11 entrance_35 left)
            (passage room_12 entrance_27 right)
            (passage room_13 entrance_6 down)
            (passage room_13 entrance_7 up)
            (passage room_14 entrance_25 left)
            (passage room_15 entrance_44 up)
            (passage room_16 entrance_57 right)
            (passage room_16 entrance_58 down)
            (passage room_18 entrance_38 up)
            (passage room_18 entrance_59 left)
            (passage room_19 entrance_4 down)
            (passage room_19 entrance_5 up)
            (passage room_2 entrance_10 down)
            (passage room_2 entrance_16 right)
            (passage room_2 entrance_26 left)
            (passage room_2 entrance_28 up)
            (passage room_21 entrance_55 up)
            (passage room_21 entrance_56 left)
            (passage room_23 entrance_46 right)
            (passage room_23 entrance_47 left)
            (passage room_24 entrance_52 right)
            (passage room_25 entrance_2 right)
            (passage room_25 entrance_3 up)
            (passage room_26 entrance_1 left)
            (passage room_27 entrance_53 right)
            (passage room_27 entrance_54 down)
            (passage room_28 entrance_36 right)
            (passage room_28 entrance_37 down)
            (passage room_28 entrance_39 up)
            (passage room_28 entrance_40 left)
            (passage room_29 entrance_31 right)
            (passage room_29 entrance_32 left)
            (passage room_3 entrance_17 left)
            (passage room_3 entrance_18 right)
            (passage room_30 entrance_42 up)
            (passage room_30 entrance_43 down)
            (passage room_31 entrance_15 up)
            (passage room_32 entrance_29 down)
            (passage room_32 entrance_30 left)
            ...
            (passage room_6 entrance_13 left)
            (passage room_6 entrance_14 down)
            (passage room_7 entrance_45 left)
            (passage room_7 entrance_8 down)
            (passage room_7 entrance_9 up)
            (passage room_8 entrance_23 left)
            (passage room_8 entrance_24 right)
            (passage room_9 entrance_19 left)
            (passage room_9 entrance_20 right)
