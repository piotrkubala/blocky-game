(define (problem problem-experiment_6x6_7_150_21)
    (:domain blocky-game)
        (:objects
            cyan - colour
            green - colour
        ...
        (:init
            ...
            (contains room_31 key_indigo)
            (contains room_33 key_pink)
            (contains room_4 key_cyan)
            (contains room_8 key_red)
            (free place55)
            ...
            (passage room_0 entrance_36 right)
            (passage room_1 entrance_1 down)
            (passage room_11 entrance_40 up)
            (passage room_11 entrance_41 down)
            ...
            (passage room_16 entrance_18 up)
            (passage room_18 entrance_27 up)
            ...
            (passage room_23 entrance_44 up)
            (passage room_24 entrance_10 up)
            (passage room_24 entrance_11 down)
            (passage room_24 entrance_14 left)
            (passage room_25 entrance_49 right)
            (passage room_25 entrance_50 left)
            (passage room_26 entrance_15 down)
            (passage room_26 entrance_16 up)
            (passage room_29 entrance_12 up)
            (passage room_29 entrance_13 right)
            ...
            (passage room_4 entrance_42 up)
            (passage room_5 entrance_38 up)
            (passage room_5 entrance_39 down)
            (passage room_6 entrance_30 up)
            (passage room_6 entrance_31 down)
            (passage room_7 entrance_2 up)
            (passage room_7 entrance_3 down)
            (passage room_8 entrance_28 down)
            (passage room_8 entrance_33 left)
            (passage room_8 entrance_34 right)
            (passage room_9 entrance_19 down)
            (passage room_9 entrance_20 up)
            (passage room_9 entrance_46 right)
            (passage room_9 entrance_47 left))
        (:goal
            (escaped player))
)
