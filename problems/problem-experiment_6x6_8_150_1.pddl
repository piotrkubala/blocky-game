(define (problem problem-experiment_6x6_8_150_1)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_17 key_yellow)
            (contains room_23 key_navy)
            (contains room_24 key_blue)
            (contains room_26 key_red)
            (contains room_3 key_white)
            ...
            (passage room_0 entrance_10 left)
            ...
            (passage room_11 entrance_44 left)
            (passage room_11 entrance_45 right)
            (passage room_13 entrance_17 right)
            (passage room_13 entrance_18 down)
            (passage room_14 entrance_6 down)
            (passage room_14 entrance_7 up)
            (passage room_17 entrance_13 right)
            (passage room_17 entrance_33 left)
            (passage room_17 entrance_34 up)
            (passage room_18 entrance_30 left)
            (passage room_18 entrance_31 right)
            (passage room_19 entrance_4 right)
            (passage room_19 entrance_5 up)
            (passage room_2 entrance_23 down)
            (passage room_2 entrance_24 up)
            (passage room_20 entrance_2 down)
            (passage room_20 entrance_3 left)
            (passage room_22 entrance_39 down)
            ...
            (passage room_30 entrance_36 up)
            (passage room_30 entrance_42 left)
            (passage room_31 entrance_47 up)
            (passage room_33 entrance_28 left)
            (passage room_33 entrance_29 right)
            ...
            (passage room_7 entrance_46 down)
            (passage room_8 entrance_14 left)
            (passage room_8 entrance_20 right)
            (passage room_8 entrance_22 up)
