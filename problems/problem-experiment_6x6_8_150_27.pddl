(define (problem problem-experiment_6x6_8_150_27)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (contains room_17 key_black)
            (contains room_2 key_magenta)
            (contains room_21 key_navy)
            (contains room_22 terminal)
            (contains room_3 key_gold)
            (contains room_31 main_exit)
            (contains room_32 key_violet)
            ...
            (passage room_10 entrance_6 left)
            (passage room_10 entrance_7 up)
            (passage room_12 entrance_20 down)
            (passage room_12 entrance_21 up)
            (passage room_14 entrance_42 right)
            (passage room_15 entrance_16 down)
            (passage room_15 entrance_17 up)
            (passage room_16 entrance_37 down)
            ...
            (passage room_19 entrance_43 right)
            (passage room_19 entrance_44 up)
            (passage room_2 entrance_40 down)
            (passage room_20 entrance_29 down)
            (passage room_20 entrance_30 left)
            (passage room_21 entrance_1 right)
            (passage room_22 entrance_19 up)
            (passage room_22 entrance_2 left)
            (passage room_22 entrance_3 right)
            (passage room_24 entrance_24 down)
            (passage room_24 entrance_25 up)
            (passage room_26 entrance_31 right)
            (passage room_26 entrance_32 left)
            (passage room_26 entrance_47 down)
            (passage room_26 entrance_48 up)
            (passage room_27 entrance_36 up)
            (passage room_27 entrance_8 down)
            (passage room_27 entrance_9 right)
            (passage room_28 entrance_27 down)
            (passage room_28 entrance_28 up)
            (passage room_3 entrance_18 down)
            (passage room_31 entrance_49 down)
            (passage room_32 entrance_35 right)
            (passage room_34 entrance_33 right)
            (passage room_4 entrance_45 down)
            (passage room_4 entrance_46 left)
            (passage room_5 entrance_12 down)
            (passage room_5 entrance_13 up)
            (passage room_7 entrance_22 down)
            ...
            (passage room_9 entrance_39 down))
        (:goal
            (escaped player))
)
