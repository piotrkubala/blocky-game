(define (problem problem-experiment_6x6_7_150_14)
    (:domain blocky-game)
        (:objects
            cyan - colour
            indigo - colour
        ...
        (:init
            ...
            (contains room_12 key_white)
            (contains room_20 main_exit)
            (contains room_21 key_orange)
            (contains room_23 key_cyan)
            (contains room_27 key_magenta)
            (contains room_34 terminal)
            (contains room_6 key_navy)
            (contains room_9 key_indigo)
            (free place43)
            ...
            (passage room_11 entrance_26 right)
            (passage room_11 entrance_37 left)
            (passage room_12 entrance_47 left)
            (passage room_13 entrance_43 left)
            (passage room_13 entrance_44 right)
            (passage room_14 entrance_16 down)
            (passage room_14 entrance_17 right)
            (passage room_14 entrance_42 left)
            (passage room_15 entrance_27 left)
            (passage room_15 entrance_28 right)
            (passage room_18 entrance_38 left)
            (passage room_18 entrance_39 right)
            (passage room_19 entrance_45 left)
            (passage room_19 entrance_46 right)
            (passage room_20 entrance_49 up)
            (passage room_21 entrance_20 left)
            (passage room_23 entrance_1 down)
            (passage room_24 entrance_29 left)
            (passage room_24 entrance_30 up)
            (passage room_25 entrance_34 left)
            (passage room_25 entrance_35 down)
            (passage room_26 entrance_18 left)
            (passage room_26 entrance_19 right)
            (passage room_27 entrance_40 left)
            (passage room_29 entrance_2 up)
            (passage room_29 entrance_3 right)
            (passage room_30 entrance_4 left)
            (passage room_30 entrance_48 down)
            (passage room_30 entrance_5 right)
            (passage room_31 entrance_14 down)
            ...
            (passage room_32 entrance_9 right)
            (passage room_33 entrance_10 left)
            (passage room_33 entrance_11 right)
            (passage room_33 entrance_41 down)
            (passage room_34 entrance_12 left)
            (passage room_34 entrance_13 up)
            (passage room_34 entrance_22 right)
            (passage room_6 entrance_36 up)
            (passage room_7 entrance_31 down)
            (passage room_7 entrance_32 up)
            (passage room_9 entrance_21 right)
            (passage room_9 entrance_23 left)
