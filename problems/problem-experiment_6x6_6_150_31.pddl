(define (problem problem-experiment_6x6_6_150_31)
    (:domain blocky-game)
        (:objects
            cyan - colour
            green - colour
        ...
        (:init
            ...
            (passage room_30 entrance_17 right)
