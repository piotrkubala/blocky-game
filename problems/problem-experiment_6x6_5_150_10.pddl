(define (problem problem-experiment_6x6_5_150_10)
    (:domain blocky-game)
        (:objects
            brown - colour
            grey - colour
        ...
        (:init
            ...
            (passage room_17 entrance_23 up)
            (passage room_18 entrance_8 down)
            (passage room_18 entrance_9 up)
            ...
            (passage room_21 entrance_38 left)
            (passage room_22 entrance_31 down)
            (passage room_22 entrance_32 left)
            (passage room_22 entrance_33 right)
            (passage room_24 entrance_6 right)
            (passage room_24 entrance_7 up)
            ...
            (passage room_31 entrance_2 right)
            (passage room_31 entrance_3 up)
            (passage room_32 entrance_1 left)
            (passage room_34 entrance_29 down)
            (passage room_4 entrance_17 up)
            (passage room_4 entrance_18 right)
            (passage room_6 entrance_14 up)
            (passage room_6 entrance_15 left)
