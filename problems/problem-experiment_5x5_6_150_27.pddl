(define (problem problem-experiment_5x5_6_150_27)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_0 entrance_8 up)
            (passage room_0 entrance_9 down)
            (passage room_1 entrance_33 left)
            (passage room_1 entrance_6 right)
            (passage room_1 entrance_7 down)
            ...
            (passage room_13 entrance_23 down)
            (passage room_13 entrance_3 left)
            (passage room_15 entrance_29 down)
