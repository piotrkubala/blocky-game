(define (problem problem-experiment_7x7_6_150_35)
    (:domain blocky-game)
        (:objects
            gold - colour
            indigo - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_15 key_violet)
            (contains room_17 main_exit)
            (contains room_19 key_gold)
            (contains room_21 key_navy)
            (contains room_31 terminal)
            (contains room_35 key_magenta)
            (contains room_45 key_indigo)
            (contains room_9 key_turquoise)
            (free place44)
            ...
            (passage room_0 entrance_28 down)
            (passage room_0 entrance_29 up)
            (passage room_1 entrance_26 down)
            (passage room_1 entrance_27 up)
            (passage room_1 entrance_43 right)
            (passage room_15 entrance_37 left)
            (passage room_15 entrance_41 down)
            (passage room_15 entrance_42 up)
            (passage room_16 entrance_33 down)
            (passage room_16 entrance_34 up)
            (passage room_16 entrance_48 right)
            (passage room_17 entrance_49 up)
            (passage room_19 entrance_14 down)
            (passage room_21 entrance_30 down)
            (passage room_23 entrance_6 down)
            (passage room_23 entrance_7 right)
            (passage room_24 entrance_8 left)
            (passage room_24 entrance_9 right)
            (passage room_27 entrance_24 down)
            (passage room_27 entrance_25 up)
            (passage room_28 entrance_44 left)
            (passage room_28 entrance_45 right)
            (passage room_29 entrance_22 down)
            (passage room_29 entrance_23 up)
            (passage room_31 entrance_15 left)
            (passage room_31 entrance_38 right)
            (passage room_31 entrance_4 down)
            (passage room_31 entrance_5 up)
            (passage room_32 entrance_10 left)
            (passage room_32 entrance_11 up)
            (passage room_34 entrance_35 down)
            (passage room_34 entrance_36 right)
            (passage room_34 entrance_40 up)
            (passage room_35 entrance_39 left)
            (passage room_36 entrance_18 right)
            (passage room_36 entrance_19 up)
            (passage room_38 entrance_2 down)
            (passage room_38 entrance_3 up)
            (passage room_38 entrance_47 left)
            (passage room_41 entrance_20 down)
            (passage room_41 entrance_21 up)
            (passage room_42 entrance_16 right)
            (passage room_42 entrance_17 left)
            (passage room_43 entrance_31 down)
            (passage room_43 entrance_32 up)
            (passage room_45 entrance_1 up)
            (passage room_47 entrance_12 down)
            (passage room_47 entrance_13 up)
            (passage room_9 entrance_46 left))
        (:goal
            (escaped player))
)
