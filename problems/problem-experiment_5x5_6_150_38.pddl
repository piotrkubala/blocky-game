(define (problem problem-experiment_5x5_6_150_38)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_12 entrance_16 left)
            (passage room_12 entrance_17 up)
            (passage room_12 entrance_30 right)
            (passage room_13 entrance_19 down)
            ...
            (passage room_18 entrance_28 left)
            (passage room_18 entrance_29 right)
            (passage room_19 entrance_13 up)
            (passage room_19 entrance_26 down)
            ...
            (passage room_6 entrance_32 up)
            (passage room_9 entrance_22 left)
