(define (problem problem-experiment_5x5_6_150_28)
    (:domain blocky-game)
        (:objects
            cyan - colour
            magenta - colour
        ...
        (:init
            ...
            (passage room_12 entrance_17 right)
            (passage room_12 entrance_18 left)
            (passage room_14 entrance_1 down)
            (passage room_16 entrance_10 left)
            (passage room_16 entrance_11 down)
            (passage room_17 entrance_26 left)
            ...
            (passage room_5 entrance_24 left)
