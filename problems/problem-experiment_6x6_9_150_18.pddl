(define (problem problem-experiment_6x6_9_150_18)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (at room_8 place24)
            (at room_9 place25)
            (contains room_0 key_magenta)
            (contains room_15 key_beige)
            (contains room_17 key_black)
            (contains room_22 key_turquoise)
            (contains room_24 key_grey)
            (contains room_25 terminal)
            (contains room_32 key_purple)
            (contains room_33 key_red)
            (contains room_34 key_navy)
            (contains room_7 main_exit)
            (contains room_8 key_green)
            (free place22)
            ...
            (has_door entrance_53 purple)
            (has_door entrance_54 purple)
            (has_door entrance_55 navy)
            ...
            (passage room_0 entrance_52 down)
            (passage room_0 entrance_53 up)
            (passage room_11 entrance_23 down)
            (passage room_11 entrance_24 up)
            (passage room_12 entrance_27 left)
            (passage room_12 entrance_28 right)
            (passage room_13 entrance_11 left)
            (passage room_13 entrance_12 up)
            (passage room_14 entrance_33 left)
            (passage room_14 entrance_34 right)
            (passage room_15 entrance_35 left)
            (passage room_16 entrance_16 left)
            (passage room_16 entrance_17 right)
            (passage room_17 entrance_22 down)
            (passage room_17 entrance_50 up)
            (passage room_18 entrance_10 right)
            (passage room_18 entrance_9 left)
            (passage room_2 entrance_25 down)
            (passage room_2 entrance_26 right)
            (passage room_22 entrance_1 down)
            (passage room_23 entrance_20 down)
            (passage room_23 entrance_21 up)
            (passage room_24 entrance_36 left)
            (passage room_25 entrance_19 up)
            (passage room_25 entrance_46 down)
            (passage room_25 entrance_48 left)
            (passage room_25 entrance_8 right)
            (passage room_26 entrance_54 down)
            (passage room_26 entrance_55 up)
            (passage room_26 entrance_6 right)
            (passage room_26 entrance_7 left)
            (passage room_27 entrance_4 right)
            (passage room_27 entrance_5 left)
            (passage room_28 entrance_2 up)
            (passage room_28 entrance_3 left)
            (passage room_3 entrance_31 left)
            (passage room_3 entrance_32 right)
            (passage room_30 entrance_43 down)
            (passage room_30 entrance_44 left)
            (passage room_30 entrance_51 up)
            ...
            (passage room_34 entrance_47 up)
            (passage room_34 entrance_49 right)
            (passage room_4 entrance_14 left)
            (passage room_4 entrance_15 right)
            (passage room_5 entrance_29 left)
            (passage room_5 entrance_30 right)
            (passage room_7 entrance_56 down)
            (passage room_8 entrance_13 down)
            (passage room_8 entrance_39 right)
            (passage room_9 entrance_40 down)
            (passage room_9 entrance_41 up))
        (:goal
            (escaped player))
)
