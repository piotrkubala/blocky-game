(define (problem problem-experiment_7x7_6_150_18)
    (:domain blocky-game)
        (:objects
            brown - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_38 key_white)
            (contains room_40 key_brown)
            ...
            (passage room_1 entrance_23 right)
            ...
            (passage room_19 entrance_6 down)
            (passage room_19 entrance_7 up)
            (passage room_20 entrance_36 right)
            (passage room_20 entrance_37 left)
            ...
            (passage room_25 entrance_38 right)
            (passage room_25 entrance_39 left)
            ...
            (passage room_28 entrance_19 right)
            (passage room_28 entrance_20 left)
            (passage room_30 entrance_12 up)
            (passage room_32 entrance_24 down)
            (passage room_32 entrance_25 up)
            (passage room_32 entrance_35 left)
            (passage room_33 entrance_2 down)
            (passage room_33 entrance_3 up)
            (passage room_36 entrance_28 down)
            (passage room_36 entrance_29 left)
            (passage room_38 entrance_13 up)
            (passage room_40 entrance_1 up)
            (passage room_41 entrance_17 right)
            (passage room_41 entrance_18 left)
            (passage room_43 entrance_30 right)
            (passage room_43 entrance_31 left)
            (passage room_46 entrance_40 right)
            (passage room_9 entrance_34 down))
        (:goal
            (escaped player))
)
