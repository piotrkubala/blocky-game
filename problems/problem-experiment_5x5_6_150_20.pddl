(define (problem problem-experiment_5x5_6_150_20)
    (:domain blocky-game)
        (:objects
            beige - colour
            magenta - colour
        ...
        (:init
            ...
            (passage room_3 entrance_6 left)
            (passage room_3 entrance_7 right)
            ...
            (passage room_7 entrance_17 left)
