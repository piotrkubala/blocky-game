(define (problem problem-experiment_6x6_5_150_37)
    (:domain blocky-game)
        (:objects
            cyan - colour
            grey - colour
        ...
        (:init
            ...
            (contains room_28 key_yellow)
            (contains room_3 key_cyan)
            (contains room_30 key_turquoise)
            ...
            (passage room_10 entrance_32 right)
            (passage room_11 entrance_49 down)
            (passage room_12 entrance_30 down)
            (passage room_12 entrance_31 left)
            (passage room_13 entrance_16 right)
            (passage room_13 entrance_17 left)
            (passage room_14 entrance_38 left)
            (passage room_14 entrance_39 up)
            (passage room_15 entrance_12 down)
            (passage room_15 entrance_13 up)
            (passage room_17 entrance_34 left)
            (passage room_17 entrance_35 right)
            (passage room_19 entrance_36 left)
            (passage room_19 entrance_37 right)
            (passage room_2 entrance_26 down)
            (passage room_2 entrance_27 up)
            (passage room_21 entrance_10 down)
            (passage room_21 entrance_11 up)
            (passage room_22 entrance_28 down)
            (passage room_22 entrance_29 up)
            (passage room_23 entrance_20 right)
            (passage room_23 entrance_21 left)
            (passage room_24 entrance_44 right)
            (passage room_24 entrance_45 left)
            (passage room_26 entrance_6 down)
            (passage room_26 entrance_7 right)
            (passage room_27 entrance_8 left)
            (passage room_27 entrance_9 up)
            (passage room_28 entrance_43 down)
            (passage room_29 entrance_18 right)
            (passage room_29 entrance_19 left)
            (passage room_3 entrance_46 right)
            (passage room_30 entrance_1 right)
            (passage room_31 entrance_2 left)
            (passage room_31 entrance_3 right)
            (passage room_32 entrance_4 left)
            (passage room_32 entrance_42 down)
            (passage room_32 entrance_5 up)
            (passage room_33 entrance_47 down)
            (passage room_33 entrance_48 up)
            (passage room_34 entrance_40 down)
            (passage room_34 entrance_41 up)
            (passage room_7 entrance_24 down)
            (passage room_8 entrance_22 right)
            (passage room_8 entrance_23 up)
            (passage room_8 entrance_33 down)
            (passage room_9 entrance_14 down)
            (passage room_9 entrance_15 left)
            (passage room_9 entrance_25 up))
        (:goal
            (escaped player))
)
