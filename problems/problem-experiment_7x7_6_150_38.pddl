(define (problem problem-experiment_7x7_6_150_38)
    (:domain blocky-game)
        (:objects
            blue - colour
            grey - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_30 key_white)
            (contains room_32 terminal)
            (contains room_33 key_blue)
            (contains room_39 key_orange)
            (contains room_43 key_yellow)
            (contains room_45 main_exit)
            (contains room_6 key_indigo)
            ...
            (passage room_20 entrance_29 up)
            (passage room_24 entrance_8 down)
            ...
            (passage room_29 entrance_6 right)
            (passage room_29 entrance_7 up)
            ...
            (passage room_32 entrance_17 left)
            (passage room_32 entrance_2 down)
            (passage room_32 entrance_3 up)
            (passage room_32 entrance_32 right)
            (passage room_33 entrance_31 down)
            (passage room_33 entrance_40 left)
            (passage room_37 entrance_18 right)
            (passage room_37 entrance_19 down)
            (passage room_38 entrance_37 up)
            (passage room_38 entrance_38 down)
            (passage room_39 entrance_1 up)
            (passage room_43 entrance_20 up)
            (passage room_43 entrance_35 left)
            (passage room_43 entrance_36 down)
            (passage room_44 entrance_21 right)
            (passage room_44 entrance_22 up)
            (passage room_45 entrance_41 up)
            (passage room_6 entrance_16 right)
