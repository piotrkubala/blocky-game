(define (problem problem-experiment_6x6_9_150_35)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_15 key_green)
            (contains room_16 key_pink)
            (contains room_27 key_orange)
            (contains room_28 key_brown)
            (contains room_29 terminal)
            (contains room_3 main_exit)
            (contains room_4 key_beige)
            (contains room_8 key_purple)
            (free place56)
            ...
            (passage room_1 entrance_24 left)
            (passage room_10 entrance_25 left)
            (passage room_10 entrance_26 down)
            (passage room_12 entrance_40 up)
            ...
            (passage room_16 entrance_31 up)
            (passage room_17 entrance_46 left)
            (passage room_17 entrance_47 right)
            (passage room_18 entrance_13 left)
            ...
            (passage room_23 entrance_43 down)
            ...
            (passage room_26 entrance_34 left)
            (passage room_26 entrance_39 down)
            (passage room_26 entrance_42 up)
            (passage room_27 entrance_45 right)
            (passage room_28 entrance_38 left)
            (passage room_29 entrance_12 right)
            (passage room_29 entrance_19 down)
            (passage room_29 entrance_41 left)
            (passage room_3 entrance_48 left)
            (passage room_30 entrance_10 up)
            (passage room_30 entrance_11 left)
            (passage room_32 entrance_20 up)
            (passage room_32 entrance_21 down)
            ...
            (passage room_6 entrance_36 left)
            (passage room_7 entrance_22 up)
            (passage room_7 entrance_23 right)
            (passage room_8 entrance_17 left)
            (passage room_8 entrance_32 up)
