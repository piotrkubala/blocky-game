(define (problem problem-experiment_6x6_7_150_34)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_2 key_indigo)
            (contains room_23 main_exit)
            (contains room_26 key_gold)
            (contains room_29 key_pink)
            (contains room_31 key_yellow)
            (contains room_32 key_navy)
            ...
            (passage room_1 entrance_13 up)
            (passage room_1 entrance_15 left)
            (passage room_11 entrance_39 up)
            (passage room_13 entrance_41 right)
            (passage room_13 entrance_8 down)
            (passage room_13 entrance_9 up)
            (passage room_14 entrance_23 up)
            ...
            (passage room_2 entrance_14 down)
            (passage room_20 entrance_21 up)
            (passage room_20 entrance_22 down)
            (passage room_21 entrance_28 up)
            (passage room_21 entrance_29 down)
            ...
            (passage room_26 entrance_27 down)
            (passage room_27 entrance_30 up)
            (passage room_27 entrance_31 left)
            (passage room_27 entrance_44 right)
            ...
            (passage room_3 entrance_33 left)
            (passage room_31 entrance_26 up)
            (passage room_31 entrance_34 right)
            (passage room_31 entrance_35 down)
