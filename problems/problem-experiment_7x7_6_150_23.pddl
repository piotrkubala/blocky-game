(define (problem problem-experiment_7x7_6_150_23)
    (:domain blocky-game)
        (:objects
            brown - colour
            gold - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_10 key_brown)
            (contains room_15 terminal)
            (contains room_18 key_turquoise)
            (contains room_20 key_green)
            (contains room_22 main_exit)
            (contains room_37 key_red)
            (contains room_39 key_grey)
            (contains room_41 key_gold)
            (free place64)
            ...
            (passage room_22 entrance_47 down)
            (passage room_23 entrance_25 right)
            (passage room_23 entrance_36 left)
            (passage room_23 entrance_4 down)
            (passage room_23 entrance_5 up)
            (passage room_24 entrance_16 left)
            (passage room_24 entrance_17 down)
            (passage room_26 entrance_43 down)
            (passage room_26 entrance_44 left)
            (passage room_29 entrance_10 up)
            (passage room_29 entrance_11 down)
            (passage room_30 entrance_14 left)
            (passage room_30 entrance_15 right)
            (passage room_30 entrance_2 down)
            (passage room_30 entrance_3 up)
            (passage room_31 entrance_20 left)
            (passage room_31 entrance_21 right)
            (passage room_36 entrance_12 up)
            (passage room_36 entrance_13 right)
            (passage room_37 entrance_1 up)
            (passage room_39 entrance_22 left)
            (passage room_4 entrance_33 right)
            (passage room_4 entrance_34 left)
            (passage room_40 entrance_37 right)
            (passage room_40 entrance_38 left)
            (passage room_41 entrance_23 up)
            (passage room_43 entrance_18 up)
            (passage room_43 entrance_19 right))
        (:goal
            (escaped player))
)
