(define (problem problem-experiment_7x7_6_150_57)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (contains room_37 main_exit)
            (contains room_41 key_white)
            (contains room_42 key_navy)
            ...
            (passage room_16 entrance_25 left)
            ...
            (passage room_23 entrance_33 up)
            (passage room_27 entrance_22 down)
            ...
            (passage room_29 entrance_21 up)
            (passage room_30 entrance_31 left)
            (passage room_35 entrance_10 down)
            (passage room_35 entrance_11 right)
            (passage room_36 entrance_29 down)
            (passage room_36 entrance_30 right)
            (passage room_37 entrance_39 left)
            (passage room_41 entrance_17 down)
            (passage room_42 entrance_16 left)
            (passage room_43 entrance_8 right)
            (passage room_43 entrance_9 up)
            (passage room_44 entrance_14 up)
            (passage room_44 entrance_6 right)
            (passage room_44 entrance_7 left)
            (passage room_45 entrance_4 right)
            (passage room_45 entrance_5 left)
            (passage room_46 entrance_2 right)
            (passage room_46 entrance_3 left)
            (passage room_46 entrance_36 down)
            (passage room_47 entrance_1 left)
            (passage room_9 entrance_37 left)
            (passage room_9 entrance_38 right))
        (:goal
            (escaped player))
)
