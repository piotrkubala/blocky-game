(define (problem problem-experiment_5x5_6_150_31)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_1 entrance_16 down)
            ...
            (passage room_13 entrance_11 right)
            ...
            (passage room_18 entrance_17 left)
