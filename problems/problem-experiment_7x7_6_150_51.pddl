(define (problem problem-experiment_7x7_6_150_51)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_11 key_orange)
            (contains room_21 terminal)
            (contains room_27 main_exit)
            (contains room_33 key_pink)
            (contains room_40 key_turquoise)
            (contains room_45 key_beige)
            (contains room_47 key_cyan)
            (free place13)
            ...
            (passage room_0 entrance_39 left)
            (passage room_0 entrance_40 right)
            (passage room_1 entrance_43 up)
            (passage room_1 entrance_48 left)
            (passage room_1 entrance_49 right)
            (passage room_11 entrance_21 down)
            (passage room_11 entrance_50 left)
            (passage room_11 entrance_51 right)
            (passage room_14 entrance_65 right)
            (passage room_14 entrance_66 left)
            (passage room_15 entrance_13 left)
            (passage room_15 entrance_14 up)
            (passage room_15 entrance_29 right)
            (passage room_16 entrance_44 left)
            (passage room_16 entrance_45 down)
            (passage room_17 entrance_19 down)
            (passage room_17 entrance_20 up)
            (passage room_18 entrance_54 up)
            (passage room_18 entrance_55 down)
            (passage room_2 entrance_15 down)
            (passage room_2 entrance_16 right)
            (passage room_20 entrance_27 left)
            (passage room_20 entrance_28 down)
            (passage room_21 entrance_12 right)
            (passage room_21 entrance_22 down)
            (passage room_21 entrance_60 left)
            (passage room_22 entrance_10 right)
            (passage room_22 entrance_11 left)
            (passage room_23 entrance_8 right)
            (passage room_23 entrance_9 left)
            (passage room_24 entrance_6 down)
            (passage room_24 entrance_7 left)
            (passage room_25 entrance_52 left)
            (passage room_25 entrance_53 down)
            (passage room_27 entrance_67 right)
            (passage room_3 entrance_41 left)
            (passage room_3 entrance_42 down)
            (passage room_3 entrance_46 up)
            (passage room_3 entrance_47 right)
            (passage room_30 entrance_17 left)
            (passage room_30 entrance_18 up)
            (passage room_31 entrance_4 down)
            (passage room_31 entrance_5 up)
            (passage room_33 entrance_58 up)
            (passage room_34 entrance_32 left)
            (passage room_34 entrance_33 down)
            (passage room_35 entrance_25 up)
            (passage room_35 entrance_26 right)
            (passage room_38 entrance_2 down)
            (passage room_38 entrance_3 up)
            (passage room_39 entrance_36 left)
            (passage room_39 entrance_37 right)
            (passage room_40 entrance_59 up)
            (passage room_41 entrance_30 left)
            (passage room_41 entrance_31 right)
            (passage room_43 entrance_63 right)
            (passage room_43 entrance_64 left)
            (passage room_44 entrance_34 up)
            (passage room_44 entrance_35 right)
            (passage room_45 entrance_1 up)
            (passage room_47 entrance_38 left)
            (passage room_5 entrance_56 up)
            (passage room_5 entrance_57 down)
            (passage room_6 entrance_23 up)
            (passage room_6 entrance_24 down)
            (passage room_9 entrance_61 right)
            (passage room_9 entrance_62 left))
        (:goal
            (escaped player))
)
