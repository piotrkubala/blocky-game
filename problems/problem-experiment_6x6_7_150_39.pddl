(define (problem problem-experiment_6x6_7_150_39)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_0 entrance_34 down)
            (passage room_1 entrance_41 left)
            (passage room_10 entrance_39 up)
            (passage room_12 entrance_26 right)
            (passage room_12 entrance_27 up)
            (passage room_13 entrance_13 right)
            (passage room_13 entrance_14 up)
            (passage room_18 entrance_42 right)
            (passage room_19 entrance_35 down)
            (passage room_19 entrance_36 up)
            (passage room_2 entrance_32 right)
            (passage room_2 entrance_33 up)
            (passage room_22 entrance_20 right)
            (passage room_22 entrance_21 up)
            (passage room_23 entrance_2 down)
            (passage room_23 entrance_25 up)
            (passage room_23 entrance_3 right)
            (passage room_24 entrance_15 down)
            (passage room_24 entrance_16 up)
            ...
            (passage room_28 entrance_23 up)
            (passage room_28 entrance_38 down)
            (passage room_28 entrance_40 right)
            (passage room_29 entrance_1 up)
            (passage room_30 entrance_28 down)
            (passage room_30 entrance_29 left)
            (passage room_31 entrance_22 down)
            (passage room_4 entrance_37 down)
            (passage room_7 entrance_30 right)
            (passage room_7 entrance_31 left)
            (passage room_8 entrance_19 down))
        (:goal
            (escaped player))
)
