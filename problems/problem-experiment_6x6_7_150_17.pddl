(define (problem problem-experiment_6x6_7_150_17)
    (:domain blocky-game)
        (:objects
            brown - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_33 key_yellow)
            (contains room_4 main_exit)
            (contains room_5 key_brown)
            (contains room_6 key_orange)
            (free place31)
            ...
            (passage room_12 entrance_12 right)
            (passage room_12 entrance_13 down)
            (passage room_12 entrance_19 up)
            (passage room_12 entrance_26 left)
            (passage room_13 entrance_10 right)
            (passage room_13 entrance_11 left)
            (passage room_14 entrance_8 up)
            (passage room_14 entrance_9 left)
            (passage room_15 entrance_30 right)
            (passage room_15 entrance_31 left)
            (passage room_16 entrance_27 right)
