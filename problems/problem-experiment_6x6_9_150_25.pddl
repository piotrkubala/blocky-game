(define (problem problem-experiment_6x6_9_150_25)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (at room_8 place24)
            (at room_9 place25)
            (contains room_0 key_violet)
            (contains room_10 key_indigo)
            (contains room_11 terminal)
            (contains room_15 key_beige)
            (contains room_16 key_gold)
            (contains room_25 key_green)
            (contains room_26 key_orange)
            (contains room_3 key_turquoise)
            (contains room_34 main_exit)
            (contains room_4 key_red)
            (contains room_6 key_cyan)
            (free place12)
            ...
            (has_door entrance_55 violet)
            (has_door entrance_56 violet)
            ...
            (passage room_0 entrance_27 down)
            (passage room_0 entrance_32 right)
            (passage room_1 entrance_19 down)
            (passage room_1 entrance_20 right)
            (passage room_1 entrance_42 left)
            (passage room_1 entrance_51 up)
            (passage room_10 entrance_30 right)
            (passage room_10 entrance_62 left)
            (passage room_10 entrance_63 up)
            (passage room_11 entrance_10 right)
            (passage room_11 entrance_22 down)
            (passage room_11 entrance_26 up)
            (passage room_11 entrance_31 left)
            (passage room_12 entrance_41 up)
            (passage room_12 entrance_8 right)
            (passage room_12 entrance_9 left)
            (passage room_13 entrance_6 right)
            (passage room_13 entrance_7 left)
            (passage room_14 entrance_4 down)
            (passage room_14 entrance_5 left)
            (passage room_15 entrance_50 down)
            (passage room_15 entrance_56 right)
            (passage room_15 entrance_57 left)
            (passage room_16 entrance_58 right)
            (passage room_18 entrance_60 left)
            (passage room_18 entrance_61 right)
            (passage room_19 entrance_11 left)
            (passage room_19 entrance_12 right)
            (passage room_2 entrance_43 right)
            (passage room_2 entrance_44 up)
            (passage room_20 entrance_2 down)
            (passage room_20 entrance_3 up)
            (passage room_21 entrance_45 down)
            (passage room_21 entrance_46 up)
            (passage room_21 entrance_54 right)
            (passage room_21 entrance_55 left)
            (passage room_25 entrance_25 up)
            (passage room_25 entrance_66 down)
            (passage room_26 entrance_1 up)
            (passage room_27 entrance_13 left)
            (passage room_27 entrance_14 up)
            (passage room_27 entrance_47 down)
            (passage room_28 entrance_28 up)
            (passage room_28 entrance_29 left)
            (passage room_28 entrance_52 down)
            (passage room_29 entrance_38 left)
            (passage room_29 entrance_39 right)
            (passage room_3 entrance_21 left)
            (passage room_31 entrance_23 up)
            (passage room_31 entrance_24 down)
            (passage room_33 entrance_48 down)
            (passage room_33 entrance_49 up)
            (passage room_34 entrance_67 down)
            (passage room_4 entrance_33 up)
            (passage room_5 entrance_36 left)
            (passage room_5 entrance_37 right)
            (passage room_5 entrance_53 up)
            (passage room_6 entrance_40 left)
            (passage room_6 entrance_64 down)
            (passage room_6 entrance_65 up)
            (passage room_7 entrance_34 left)
            (passage room_7 entrance_35 right)
            (passage room_8 entrance_15 down)
            (passage room_8 entrance_16 right)
            (passage room_8 entrance_59 left)
            (passage room_9 entrance_17 left)
            (passage room_9 entrance_18 up))
        (:goal
            (escaped player))
)
