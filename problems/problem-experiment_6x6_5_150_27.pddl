(define (problem problem-experiment_6x6_5_150_27)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_23 entrance_28 right)
            ...
            (passage room_32 entrance_39 up)
            ...
            (passage room_5 entrance_37 down)
            (passage room_6 entrance_22 right)
            (passage room_6 entrance_23 left)
            (passage room_7 entrance_20 up)
            (passage room_7 entrance_21 left))
        (:goal
            (escaped player))
)
