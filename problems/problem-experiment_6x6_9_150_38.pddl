(define (problem problem-experiment_6x6_9_150_38)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_1 entrance_30 up)
            (passage room_11 entrance_38 right)
            (passage room_12 entrance_17 down)
            (passage room_12 entrance_18 up)
            (passage room_13 entrance_45 right)
            ...
            (passage room_21 entrance_9 up)
            (passage room_22 entrance_40 left)
            ...
            (passage room_26 entrance_22 left)
            ...
            (passage room_31 entrance_44 up)
            ...
            (passage room_34 entrance_37 left)
            (passage room_7 entrance_27 down)
            (passage room_7 entrance_28 left)
