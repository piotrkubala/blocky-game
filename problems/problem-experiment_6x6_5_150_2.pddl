(define (problem problem-experiment_6x6_5_150_2)
    (:domain blocky-game)
        (:objects
            grey - colour
            indigo - colour
        ...
        (:init
            ...
            (passage room_12 entrance_15 up)
            ...
            (passage room_24 entrance_14 up)
            (passage room_24 entrance_32 left)
            (passage room_24 entrance_33 right)
            ...
            (passage room_6 entrance_13 down)
