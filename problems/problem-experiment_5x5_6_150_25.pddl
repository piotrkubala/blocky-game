(define (problem problem-experiment_5x5_6_150_25)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_0 entrance_15 down)
            ...
            (passage room_5 entrance_5 right)
            (passage room_6 entrance_6 left)
            (passage room_6 entrance_7 right)
            (passage room_7 entrance_20 right)
            (passage room_7 entrance_26 up)
            (passage room_7 entrance_8 left)
