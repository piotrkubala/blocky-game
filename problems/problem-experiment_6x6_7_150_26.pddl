(define (problem problem-experiment_6x6_7_150_26)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (contains room_20 key_gold)
            (contains room_29 key_brown)
            (contains room_3 main_exit)
            (contains room_31 key_black)
            ...
            (is key_white white)
            (passage room_1 entrance_35 up)
            (passage room_1 entrance_6 down)
            (passage room_1 entrance_7 left)
            (passage room_11 entrance_1 right)
            (passage room_12 entrance_2 left)
            (passage room_12 entrance_3 up)
            (passage room_12 entrance_38 right)
            (passage room_14 entrance_36 down)
            (passage room_15 entrance_18 up)
            (passage room_15 entrance_19 down)
            (passage room_18 entrance_34 down)
            (passage room_19 entrance_10 up)
            (passage room_19 entrance_11 down)
            (passage room_2 entrance_20 up)
            (passage room_2 entrance_21 down)
            (passage room_2 entrance_37 left)
            (passage room_20 entrance_15 up)
            (passage room_21 entrance_26 right)
            (passage room_21 entrance_27 left)
            (passage room_23 entrance_12 up)
            (passage room_23 entrance_13 down)
            ...
            (passage room_27 entrance_23 left)
            (passage room_29 entrance_28 right)
            (passage room_29 entrance_41 down)
            (passage room_29 entrance_42 up)
            (passage room_3 entrance_43 down)
            (passage room_31 entrance_14 up)
            (passage room_33 entrance_39 right)
            (passage room_33 entrance_40 up)
            (passage room_4 entrance_16 up)
            ...
            (passage room_6 entrance_5 up)
            (passage room_7 entrance_8 right)
            (passage room_7 entrance_9 down)
            (passage room_9 entrance_31 right))
        (:goal
            (escaped player))
)
