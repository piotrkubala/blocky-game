(define (problem problem-experiment_5x5_6_150_19)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_15 entrance_22 right)
            ...
            (passage room_22 entrance_31 left)
            (passage room_23 entrance_20 up)
