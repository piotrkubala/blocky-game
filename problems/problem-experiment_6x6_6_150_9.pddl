(define (problem problem-experiment_6x6_6_150_9)
    (:domain blocky-game)
        (:objects
            indigo - colour
            orange - colour
        ...
        (:init
            ...
            (passage room_0 entrance_43 down)
