(define (problem problem-experiment_6x6_5_150_5)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_14 entrance_13 right)
            (passage room_15 entrance_29 left)
            (passage room_15 entrance_30 up)
            (passage room_15 entrance_40 right)
            (passage room_18 entrance_8 down)
            (passage room_18 entrance_9 right)
            (passage room_2 entrance_31 down)
            ...
            (passage room_29 entrance_23 down)
            (passage room_29 entrance_24 up)
            (passage room_31 entrance_21 left)
            (passage room_31 entrance_22 up)
            (passage room_32 entrance_6 right)
            (passage room_32 entrance_7 up)
            (passage room_33 entrance_35 up)
            (passage room_33 entrance_4 right)
            (passage room_33 entrance_5 left)
            (passage room_34 entrance_2 up)
            (passage room_34 entrance_3 left)
            (passage room_4 entrance_33 left)
            (passage room_6 entrance_19 down)
            (passage room_6 entrance_34 right)
