(define (problem problem-experiment_7x7_6_150_55)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_13 key_orange)
            (contains room_19 main_exit)
            (contains room_21 key_purple)
            (contains room_22 key_brown)
            ...
            (passage room_0 entrance_4 down)
            (passage room_0 entrance_5 right)
            (passage room_1 entrance_6 left)
            (passage room_1 entrance_7 right)
            (passage room_12 entrance_41 up)
            (passage room_12 entrance_46 left)
            (passage room_12 entrance_47 right)
            ...
            (passage room_15 entrance_32 right)
            (passage room_16 entrance_15 left)
            (passage room_16 entrance_16 right)
            (passage room_17 entrance_17 left)
            (passage room_17 entrance_18 down)
            (passage room_19 entrance_51 left)
            (passage room_2 entrance_8 left)
            (passage room_2 entrance_9 right)
            (passage room_21 entrance_43 up)
            (passage room_22 entrance_19 up)
            (passage room_22 entrance_38 left)
            (passage room_22 entrance_39 right)
            (passage room_25 entrance_35 left)
            (passage room_26 entrance_40 left)
            (passage room_26 entrance_49 up)
            (passage room_26 entrance_50 right)
            (passage room_27 entrance_29 up)
            (passage room_27 entrance_30 right)
            (passage room_3 entrance_10 left)
            (passage room_3 entrance_11 down)
            (passage room_3 entrance_20 right)
            (passage room_34 entrance_44 left)
            (passage room_34 entrance_45 right)
            (passage room_43 entrance_33 left)
            (passage room_43 entrance_34 right)
            (passage room_5 entrance_23 up)
            ...
            (passage room_7 entrance_48 left)
            (passage room_8 entrance_25 left)
            (passage room_8 entrance_26 down)
            (passage room_8 entrance_37 right)
            (passage room_8 entrance_42 up)
