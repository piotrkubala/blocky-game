(define (problem problem-experiment_6x6_6_150_24)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_6 entrance_9 right)
            (passage room_8 entrance_32 down)
