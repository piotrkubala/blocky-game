(define (problem problem-experiment_6x6_9_150_34)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_1 key_violet)
            (contains room_10 key_purple)
            (contains room_24 key_white)
            (contains room_25 key_navy)
            (contains room_26 terminal)
            (contains room_27 main_exit)
            (contains room_28 key_green)
            (contains room_32 key_magenta)
            (contains room_7 key_yellow)
            (contains room_9 key_blue)
            (free place52)
            ...
            (has_door entrance_29 brown)
            (has_door entrance_29 navy)
            (has_door entrance_3 green)
            (has_door entrance_30 brown)
            ...
            (passage room_0 entrance_64 up)
            (passage room_1 entrance_37 right)
            (passage room_10 entrance_53 down)
            (passage room_14 entrance_13 left)
            (passage room_14 entrance_14 up)
            (passage room_14 entrance_41 down)
            (passage room_14 entrance_61 right)
            (passage room_15 entrance_25 right)
            (passage room_15 entrance_26 up)
            (passage room_15 entrance_40 down)
            (passage room_15 entrance_54 left)
            (passage room_17 entrance_30 up)
            (passage room_17 entrance_31 left)
            (passage room_18 entrance_32 right)
            (passage room_18 entrance_33 left)
            (passage room_19 entrance_11 down)
            (passage room_19 entrance_12 right)
            (passage room_2 entrance_44 right)
            (passage room_2 entrance_45 left)
            (passage room_2 entrance_62 up)
            (passage room_2 entrance_63 down)
            (passage room_20 entrance_55 right)
            (passage room_20 entrance_56 up)
            (passage room_21 entrance_27 left)
            (passage room_21 entrance_6 right)
            (passage room_21 entrance_7 down)
            (passage room_22 entrance_4 right)
            (passage room_22 entrance_5 left)
            (passage room_23 entrance_2 down)
            (passage room_23 entrance_3 left)
            (passage room_24 entrance_59 right)
            (passage room_25 entrance_39 right)
            (passage room_26 entrance_20 right)
            (passage room_26 entrance_29 down)
            (passage room_26 entrance_38 left)
            (passage room_26 entrance_8 up)
            (passage room_27 entrance_65 right)
            (passage room_28 entrance_1 up)
            (passage room_29 entrance_10 up)
            (passage room_29 entrance_9 down)
            (passage room_30 entrance_42 right)
            (passage room_30 entrance_43 left)
            (passage room_31 entrance_21 left)
            (passage room_31 entrance_22 right)
            (passage room_31 entrance_24 down)
            (passage room_31 entrance_60 up)
            (passage room_32 entrance_23 left)
            (passage room_32 entrance_58 right)
            (passage room_33 entrance_35 down)
            (passage room_33 entrance_36 left)
            (passage room_34 entrance_48 right)
            (passage room_34 entrance_49 up)
            (passage room_5 entrance_46 right)
            (passage room_5 entrance_47 left)
            (passage room_6 entrance_17 down)
            (passage room_6 entrance_18 right)
            (passage room_6 entrance_52 up)
            (passage room_7 entrance_34 right)
            (passage room_8 entrance_15 down)
            (passage room_8 entrance_16 up)
            (passage room_8 entrance_57 left)
            (passage room_9 entrance_28 right)
