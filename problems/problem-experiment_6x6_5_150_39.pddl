(define (problem problem-experiment_6x6_5_150_39)
    (:domain blocky-game)
        (:objects
            blue - colour
            magenta - colour
        ...
        (:init
            ...
            (passage room_1 entrance_28 right)
            ...
            (passage room_14 entrance_30 right)
            ...
            (passage room_24 entrance_14 down)
