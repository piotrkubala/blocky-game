(define (problem problem-experiment_7x7_6_150_37)
    (:domain blocky-game)
        (:objects
            blue - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_23 key_blue)
            (contains room_27 key_green)
            (contains room_42 key_cyan)
            (contains room_45 key_purple)
            (contains room_47 key_pink)
            ...
            (passage room_1 entrance_19 right)
            (passage room_1 entrance_20 left)
            (passage room_12 entrance_15 down)
            (passage room_12 entrance_16 up)
            ...
            (passage room_25 entrance_46 right)
            (passage room_25 entrance_47 left)
            (passage room_27 entrance_42 right)
            (passage room_3 entrance_8 left)
            (passage room_3 entrance_9 right)
            (passage room_31 entrance_29 right)
            (passage room_31 entrance_30 left)
            (passage room_32 entrance_27 up)
            (passage room_32 entrance_28 left)
            (passage room_33 entrance_38 up)
            (passage room_33 entrance_39 down)
            (passage room_33 entrance_44 left)
            (passage room_37 entrance_33 right)
            (passage room_37 entrance_34 down)
            (passage room_37 entrance_48 left)
            (passage room_4 entrance_10 left)
            (passage room_4 entrance_11 right)
            (passage room_42 entrance_37 right)
            (passage room_43 entrance_35 up)
            (passage room_43 entrance_36 left)
            (passage room_45 entrance_41 up)
            (passage room_47 entrance_40 up)
            ...
            (passage room_9 entrance_4 down)
            (passage room_9 entrance_5 up))
        (:goal
            (escaped player))
)
