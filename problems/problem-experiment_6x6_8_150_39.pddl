(define (problem problem-experiment_6x6_8_150_39)
    (:domain blocky-game)
        (:objects
            black - colour
            indigo - colour
        ...
        (:init
            ...
            (contains room_16 key_magenta)
            (contains room_17 key_red)
            (contains room_2 terminal)
            (contains room_21 key_white)
            (contains room_23 key_indigo)
            (contains room_24 key_yellow)
            (contains room_32 key_black)
            (contains room_34 key_purple)
            (contains room_7 key_orange)
            (free place55)
            ...
            (passage room_10 entrance_56 down)
            (passage room_11 entrance_19 up)
            (passage room_11 entrance_20 left)
            (passage room_13 entrance_17 up)
            (passage room_13 entrance_18 down)
            ...
            (passage room_15 entrance_26 down)
            (passage room_16 entrance_38 down)
            (passage room_17 entrance_45 right)
            (passage room_19 entrance_34 down)
            (passage room_19 entrance_35 right)
            (passage room_2 entrance_12 down)
            ...
            (passage room_21 entrance_52 left)
            (passage room_21 entrance_53 up)
            (passage room_22 entrance_50 left)
            (passage room_22 entrance_51 right)
            (passage room_23 entrance_21 right)
            (passage room_24 entrance_1 right)
            (passage room_25 entrance_2 left)
            (passage room_25 entrance_3 right)
            (passage room_26 entrance_4 left)
            (passage room_26 entrance_44 right)
            (passage room_26 entrance_5 up)
            (passage room_27 entrance_28 right)
            (passage room_27 entrance_29 left)
            (passage room_3 entrance_13 up)
            (passage room_3 entrance_14 left)
            (passage room_30 entrance_48 left)
            (passage room_30 entrance_49 right)
            (passage room_31 entrance_30 right)
            (passage room_31 entrance_31 down)
            (passage room_32 entrance_32 up)
            (passage room_34 entrance_40 left)
            (passage room_4 entrance_23 right)
            (passage room_4 entrance_24 left)
            (passage room_5 entrance_15 right)
            (passage room_5 entrance_16 down)
            (passage room_5 entrance_55 up)
            (passage room_6 entrance_46 up)
            ...
            (passage room_9 entrance_36 left)
