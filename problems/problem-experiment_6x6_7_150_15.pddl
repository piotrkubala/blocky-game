(define (problem problem-experiment_6x6_7_150_15)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_18 entrance_4 up)
            (passage room_18 entrance_5 down)
            (passage room_2 entrance_36 left)
            ...
            (passage room_26 entrance_15 up)
            ...
            (passage room_6 entrance_10 right)
