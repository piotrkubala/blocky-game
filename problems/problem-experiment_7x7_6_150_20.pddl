(define (problem problem-experiment_7x7_6_150_20)
    (:domain blocky-game)
        (:objects
            blue - colour
            magenta - colour
        ...
        (:init
            ...
            (contains room_37 key_pink)
            (contains room_40 key_blue)
            ...
            (passage room_10 entrance_17 down)
            (passage room_10 entrance_18 right)
            (passage room_12 entrance_19 left)
            (passage room_12 entrance_20 up)
            (passage room_14 entrance_14 right)
            (passage room_14 entrance_31 left)
            (passage room_14 entrance_40 up)
            (passage room_14 entrance_8 down)
            (passage room_15 entrance_45 left)
            (passage room_16 entrance_1 down)
            (passage room_19 entrance_43 down)
            (passage room_19 entrance_44 right)
            (passage room_21 entrance_6 right)
            (passage room_21 entrance_7 up)
            (passage room_22 entrance_4 right)
            (passage room_22 entrance_5 left)
            (passage room_23 entrance_2 up)
            ...
            (passage room_25 entrance_34 right)
            (passage room_25 entrance_35 down)
            (passage room_30 entrance_10 right)
            (passage room_30 entrance_9 up)
            (passage room_31 entrance_41 down)
            (passage room_31 entrance_42 up)
            (passage room_33 entrance_28 up)
            (passage room_33 entrance_29 down)
            (passage room_36 entrance_39 up)
            (passage room_37 entrance_13 up)
            (passage room_37 entrance_36 down)
            (passage room_38 entrance_11 left)
            (passage room_38 entrance_12 down)
            (passage room_39 entrance_26 up)
            (passage room_39 entrance_27 down)
            (passage room_40 entrance_30 up)
            (passage room_42 entrance_37 up)
            (passage room_42 entrance_38 down)
            (passage room_43 entrance_32 right)
            (passage room_43 entrance_33 left)
            (passage room_47 entrance_24 up)
            (passage room_47 entrance_25 down)
            (passage room_6 entrance_21 down))
        (:goal
            (escaped player))
)
