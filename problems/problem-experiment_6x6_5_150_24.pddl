(define (problem problem-experiment_6x6_5_150_24)
    (:domain blocky-game)
        (:objects
            green - colour
            pink - colour
        ...
        (:init
            ...
            (passage room_13 entrance_35 left)
            (passage room_13 entrance_36 right)
            (passage room_14 entrance_17 right)
            (passage room_14 entrance_18 up)
            (passage room_15 entrance_2 up)
