(define (problem problem-experiment_7x7_6_150_33)
    (:domain blocky-game)
        (:objects
            cyan - colour
            green - colour
        ...
        (:init
            ...
            (contains room_35 key_magenta)
            (contains room_43 key_white)
            (contains room_45 key_violet)
            ...
            (is key_white white)
            (passage room_0 entrance_32 left)
            (passage room_14 entrance_16 right)
            (passage room_14 entrance_17 down)
            (passage room_14 entrance_21 left)
            (passage room_14 entrance_25 up)
            (passage room_15 entrance_14 right)
            (passage room_15 entrance_15 left)
            (passage room_16 entrance_12 right)
            (passage room_16 entrance_13 left)
            (passage room_17 entrance_10 down)
            (passage room_17 entrance_11 left)
            (passage room_20 entrance_42 down)
            (passage room_22 entrance_30 down)
            (passage room_22 entrance_31 right)
            (passage room_24 entrance_8 right)
            (passage room_24 entrance_9 up)
            (passage room_25 entrance_6 down)
            (passage room_25 entrance_7 left)
            (passage room_28 entrance_35 down)
            (passage room_3 entrance_22 right)
            (passage room_3 entrance_23 down)
            (passage room_31 entrance_28 left)
            (passage room_31 entrance_29 up)
            (passage room_32 entrance_4 down)
            (passage room_32 entrance_5 up)
            (passage room_34 entrance_33 left)
            (passage room_34 entrance_34 up)
            (passage room_34 entrance_36 down)
            (passage room_35 entrance_24 up)
            (passage room_36 entrance_18 up)
            (passage room_36 entrance_19 right)
            (passage room_38 entrance_40 down)
            (passage room_38 entrance_41 up)
            (passage room_39 entrance_2 down)
            (passage room_39 entrance_3 up)
            (passage room_43 entrance_20 left)
            (passage room_43 entrance_26 down)
            (passage room_43 entrance_27 right)
            (passage room_44 entrance_37 up)
            (passage room_44 entrance_38 right)
            (passage room_45 entrance_1 up)
            (passage room_47 entrance_39 left))
        (:goal
            (escaped player))
)
