(define (problem problem-experiment_5x5_6_150_18)
    (:domain blocky-game)
        (:objects
            black - colour
            grey - colour
        ...
        (:init
            ...
            (passage room_17 entrance_2 right)
            (passage room_17 entrance_3 up)
            (passage room_18 entrance_1 left)
            (passage room_19 entrance_20 right)
            (passage room_19 entrance_21 left)
            (passage room_20 entrance_22 right)
            ...
            (passage room_8 entrance_25 down)
