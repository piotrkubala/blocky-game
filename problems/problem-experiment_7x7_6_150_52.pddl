(define (problem problem-experiment_7x7_6_150_52)
    (:domain blocky-game)
        (:objects
            black - colour
            green - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_13 key_navy)
            (contains room_19 key_black)
            (contains room_2 key_pink)
            (contains room_27 main_exit)
            (contains room_28 key_white)
            (contains room_37 terminal)
            (contains room_47 key_green)
            (contains room_5 key_indigo)
            (free place26)
            ...
            (passage room_10 entrance_13 right)
            (passage room_11 entrance_28 left)
            (passage room_11 entrance_29 up)
            (passage room_11 entrance_50 right)
            (passage room_13 entrance_56 right)
            (passage room_16 entrance_22 down)
            (passage room_16 entrance_23 up)
            (passage room_16 entrance_36 left)
            (passage room_16 entrance_37 right)
            (passage room_17 entrance_8 left)
            (passage room_17 entrance_9 up)
            (passage room_18 entrance_14 left)
            (passage room_18 entrance_15 up)
            (passage room_19 entrance_53 down)
            (passage room_2 entrance_33 down)
            (passage room_20 entrance_24 down)
            (passage room_20 entrance_25 right)
            (passage room_21 entrance_10 down)
            (passage room_21 entrance_11 up)
            (passage room_21 entrance_26 left)
            (passage room_21 entrance_27 right)
            (passage room_22 entrance_54 right)
            (passage room_22 entrance_55 left)
            (passage room_24 entrance_40 down)
            (passage room_24 entrance_41 right)
            (passage room_26 entrance_42 left)
            (passage room_26 entrance_43 up)
            (passage room_27 entrance_59 up)
            (passage room_28 entrance_1 down)
            (passage room_29 entrance_34 left)
            (passage room_29 entrance_35 right)
            (passage room_32 entrance_51 left)
            (passage room_32 entrance_52 up)
            (passage room_33 entrance_18 left)
            (passage room_33 entrance_19 up)
            (passage room_35 entrance_2 up)
            (passage room_35 entrance_3 right)
            (passage room_36 entrance_4 left)
            (passage room_36 entrance_5 right)
            (passage room_37 entrance_21 up)
            (passage room_37 entrance_6 left)
            (passage room_37 entrance_7 right)
            (passage room_4 entrance_16 down)
            (passage room_4 entrance_17 right)
            (passage room_4 entrance_32 up)
            (passage room_40 entrance_46 down)
            (passage room_40 entrance_47 right)
            (passage room_41 entrance_57 left)
            (passage room_41 entrance_58 down)
            (passage room_46 entrance_38 down)
            (passage room_46 entrance_39 up)
            (passage room_46 entrance_49 right)
            (passage room_47 entrance_48 left)
            (passage room_5 entrance_20 down)
            (passage room_6 entrance_44 down)
            (passage room_6 entrance_45 up)
            (passage room_9 entrance_30 down)
            (passage room_9 entrance_31 up))
        (:goal
            (escaped player))
)
