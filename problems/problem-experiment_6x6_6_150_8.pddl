(define (problem problem-experiment_6x6_6_150_8)
    (:domain blocky-game)
        (:objects
            green - colour
            indigo - colour
        ...
        (:init
            ...
            (passage room_21 entrance_20 down)
            ...
            (passage room_23 entrance_40 down)
            ...
            (passage room_32 entrance_47 right)
            ...
            (passage room_6 entrance_46 right)
            (passage room_7 entrance_30 down)
            (passage room_7 entrance_31 up)
