(define (problem problem-experiment_6x6_6_150_26)
    (:domain blocky-game)
        (:objects
            grey - colour
            magenta - colour
        ...
        (:init
            ...
            (passage room_1 entrance_17 right)
            ...
            (passage room_13 entrance_20 down)
            ...
            (passage room_4 entrance_9 right)
            (passage room_5 entrance_28 up)
            (passage room_6 entrance_13 right)
            (passage room_6 entrance_14 left)
            (passage room_9 entrance_35 left)
            (passage room_9 entrance_36 right))
        (:goal
            (escaped player))
)
