(define (problem problem-experiment_7x7_6_150_42)
    (:domain blocky-game)
        (:objects
            black - colour
            green - colour
        ...
        (:init
            ...
            (contains room_34 key_yellow)
            (contains room_46 key_pink)
            (free place62)
            ...
            (passage room_13 entrance_51 right)
            ...
            (passage room_32 entrance_45 right)
            (passage room_32 entrance_46 left)
            (passage room_34 entrance_6 left)
            (passage room_37 entrance_35 right)
            (passage room_37 entrance_36 down)
            (passage room_37 entrance_44 left)
