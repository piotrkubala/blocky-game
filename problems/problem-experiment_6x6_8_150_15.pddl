(define (problem problem-experiment_6x6_8_150_15)
    (:domain blocky-game)
        (:objects
            black - colour
            cyan - colour
        ...
        (:init
            ...
            (at room_8 place24)
            (at room_9 place25)
            (contains room_14 terminal)
            (contains room_19 key_purple)
            (contains room_20 main_exit)
            (contains room_26 key_turquoise)
            (contains room_28 key_black)
            (contains room_30 key_pink)
            (contains room_31 key_white)
            (contains room_4 key_magenta)
            (contains room_6 key_navy)
            (contains room_9 key_cyan)
            (free place14)
            ...
            (is key_white white)
            (passage room_0 entrance_25 down)
            (passage room_0 entrance_8 right)
            (passage room_0 entrance_9 left)
            (passage room_10 entrance_39 up)
            (passage room_10 entrance_40 down)
            (passage room_11 entrance_47 up)
            (passage room_11 entrance_48 down)
            (passage room_12 entrance_19 right)
            (passage room_12 entrance_20 up)
            (passage room_13 entrance_2 down)
            (passage room_13 entrance_3 right)
            (passage room_13 entrance_5 left)
            (passage room_14 entrance_17 up)
            (passage room_14 entrance_37 down)
            (passage room_14 entrance_4 left)
            (passage room_16 entrance_32 down)
            (passage room_16 entrance_33 left)
            (passage room_19 entrance_1 up)
            (passage room_2 entrance_26 right)
            (passage room_2 entrance_27 left)
            (passage room_2 entrance_41 up)
            (passage room_2 entrance_42 down)
            (passage room_20 entrance_56 up)
            (passage room_21 entrance_34 right)
            (passage room_21 entrance_35 down)
            (passage room_22 entrance_23 right)
            (passage room_22 entrance_24 up)
            ...
            (passage room_24 entrance_13 down)
            (passage room_25 entrance_6 right)
            (passage room_25 entrance_7 left)
            (passage room_26 entrance_30 left)
            (passage room_26 entrance_43 up)
            (passage room_28 entrance_36 up)
            (passage room_28 entrance_38 down)
            (passage room_29 entrance_14 up)
            (passage room_29 entrance_15 down)
            (passage room_3 entrance_21 down)
            (passage room_3 entrance_22 left)
            (passage room_3 entrance_29 right)
            (passage room_3 entrance_31 up)
            (passage room_30 entrance_16 up)
            (passage room_31 entrance_44 right)
            (passage room_4 entrance_18 down)
            (passage room_4 entrance_52 up)
            (passage room_4 entrance_53 left)
            (passage room_6 entrance_51 right)
            (passage room_7 entrance_49 up)
            (passage room_7 entrance_50 left)
            (passage room_8 entrance_45 up)
            (passage room_8 entrance_46 down)
            (passage room_8 entrance_55 right)
