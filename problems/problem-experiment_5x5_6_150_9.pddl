(define (problem problem-experiment_5x5_6_150_9)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_1 entrance_21 up)
            (passage room_1 entrance_22 left)
            (passage room_1 entrance_38 down)
            (passage room_10 entrance_17 right)
            (passage room_10 entrance_18 down)
            (passage room_10 entrance_37 up)
            ...
            (passage room_2 entrance_7 left)
            ...
            (passage room_22 entrance_26 right)
            ...
            (passage room_6 entrance_15 right)
            (passage room_6 entrance_16 left)
            (passage room_7 entrance_12 up)
