(define (problem problem-experiment_7x7_6_150_47)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_16 key_brown)
            (contains room_18 key_gold)
            (contains room_22 key_beige)
            (contains room_26 main_exit)
            (contains room_35 terminal)
            (contains room_47 key_navy)
            (contains room_6 key_red)
            (free place74)
            ...
            (has_door entrance_18 brown)
            (has_door entrance_18 gold)
            (has_door entrance_19 brown)
            ...
            (passage room_0 entrance_26 right)
            ...
            (passage room_14 entrance_4 right)
            (passage room_14 entrance_5 down)
            (passage room_15 entrance_2 right)
            (passage room_15 entrance_27 down)
            (passage room_15 entrance_28 up)
            (passage room_15 entrance_3 left)
            (passage room_16 entrance_1 left)
            (passage room_18 entrance_23 down)
            (passage room_18 entrance_32 up)
            (passage room_20 entrance_49 down)
            (passage room_20 entrance_50 up)
            (passage room_21 entrance_6 up)
            (passage room_21 entrance_7 down)
            (passage room_22 entrance_25 right)
            (passage room_26 entrance_51 down)
            (passage room_27 entrance_40 down)
            (passage room_27 entrance_41 right)
            (passage room_28 entrance_14 right)
            (passage room_28 entrance_8 up)
            (passage room_28 entrance_9 down)
            (passage room_3 entrance_47 right)
            (passage room_3 entrance_48 up)
            (passage room_31 entrance_17 left)
            (passage room_31 entrance_18 up)
            (passage room_32 entrance_19 down)
            (passage room_32 entrance_20 up)
            (passage room_33 entrance_36 down)
            (passage room_33 entrance_37 up)
            (passage room_35 entrance_10 up)
            (passage room_35 entrance_11 right)
            (passage room_35 entrance_24 left)
            (passage room_36 entrance_15 left)
            (passage room_36 entrance_16 right)
            (passage room_36 entrance_29 down)
            (passage room_37 entrance_30 left)
            (passage room_37 entrance_31 up)
            (passage room_38 entrance_44 down)
            (passage room_38 entrance_45 up)
            (passage room_39 entrance_38 down)
            (passage room_39 entrance_39 right)
            (passage room_39 entrance_43 up)
            (passage room_42 entrance_12 left)
            (passage room_42 entrance_13 up)
            (passage room_47 entrance_35 left)
            (passage room_47 entrance_46 down)
