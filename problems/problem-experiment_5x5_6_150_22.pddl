(define (problem problem-experiment_5x5_6_150_22)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_15 entrance_3 up)
            (passage room_17 entrance_22 right)
            (passage room_17 entrance_23 left)
            (passage room_18 entrance_19 right)
            (passage room_18 entrance_20 up)
            ...
            (passage room_4 entrance_14 down)
            (passage room_4 entrance_15 left)
            (passage room_4 entrance_27 up)
