(define (problem problem-experiment_6x6_9_150_39)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_16 key_violet)
            (contains room_18 terminal)
            (contains room_21 key_orange)
            (contains room_23 key_brown)
            ...
            (passage room_11 entrance_23 up)
            (passage room_11 entrance_41 right)
            (passage room_13 entrance_2 up)
            (passage room_13 entrance_28 right)
            (passage room_13 entrance_29 left)
            (passage room_13 entrance_3 down)
            (passage room_16 entrance_18 down)
            (passage room_18 entrance_20 down)
            (passage room_18 entrance_40 left)
            (passage room_18 entrance_6 right)
            (passage room_18 entrance_7 up)
            (passage room_19 entrance_4 up)
            (passage room_19 entrance_5 left)
            (passage room_2 entrance_44 right)
            (passage room_2 entrance_45 up)
            (passage room_21 entrance_21 up)
            (passage room_22 entrance_32 up)
            (passage room_22 entrance_33 left)
            (passage room_23 entrance_48 down)
            (passage room_25 entrance_46 down)
            (passage room_25 entrance_47 up)
            (passage room_26 entrance_34 right)
            (passage room_27 entrance_12 down)
            (passage room_27 entrance_13 right)
            (passage room_28 entrance_24 down)
            (passage room_28 entrance_25 left)
            (passage room_29 entrance_14 left)
            (passage room_29 entrance_15 up)
            (passage room_29 entrance_36 down)
            (passage room_29 entrance_37 right)
            (passage room_30 entrance_35 up)
            (passage room_30 entrance_42 down)
            (passage room_30 entrance_43 left)
            (passage room_31 entrance_50 left)
            (passage room_32 entrance_10 right)
            (passage room_32 entrance_38 left)
            (passage room_33 entrance_16 down)
            (passage room_33 entrance_17 up)
            (passage room_33 entrance_26 right)
            (passage room_33 entrance_27 left)
            (passage room_34 entrance_11 up)
            (passage room_34 entrance_8 down)
            (passage room_34 entrance_9 left)
            (passage room_4 entrance_30 right)
            (passage room_4 entrance_31 down)
            (passage room_7 entrance_1 down)
