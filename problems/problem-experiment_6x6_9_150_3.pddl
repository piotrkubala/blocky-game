(define (problem problem-experiment_6x6_9_150_3)
    (:domain blocky-game)
        (:objects
            black - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_12 key_red)
            (contains room_14 key_white)
            (contains room_20 key_green)
            (contains room_23 key_black)
            (contains room_28 key_gold)
            (contains room_30 main_exit)
            (contains room_31 key_purple)
            (contains room_34 key_magenta)
            (contains room_5 terminal)
            (contains room_8 key_cyan)
            (free place32)
            ...
            (is key_red red)
            (is key_white white)
            (passage room_1 entrance_42 down)
            (passage room_10 entrance_38 up)
            (passage room_10 entrance_6 down)
            (passage room_10 entrance_7 right)
            (passage room_11 entrance_8 left)
            (passage room_11 entrance_9 up)
            (passage room_12 entrance_35 left)
            (passage room_14 entrance_28 down)
            (passage room_14 entrance_36 right)
            (passage room_14 entrance_37 up)
            (passage room_15 entrance_4 down)
            (passage room_15 entrance_41 left)
            (passage room_15 entrance_43 right)
            (passage room_15 entrance_5 up)
            (passage room_16 entrance_12 right)
            (passage room_16 entrance_13 down)
            (passage room_18 entrance_30 down)
            (passage room_18 entrance_31 up)
            (passage room_19 entrance_44 left)
            (passage room_19 entrance_45 down)
            (passage room_20 entrance_1 right)
            (passage room_21 entrance_2 left)
            (passage room_21 entrance_3 up)
            (passage room_21 entrance_39 down)
            (passage room_21 entrance_40 right)
            (passage room_23 entrance_32 down)
            (passage room_24 entrance_18 right)
            (passage room_24 entrance_19 down)
            (passage room_24 entrance_53 left)
            (passage room_25 entrance_16 right)
            (passage room_25 entrance_17 left)
            (passage room_27 entrance_14 up)
            (passage room_27 entrance_15 left)
            (passage room_28 entrance_23 right)
            (passage room_28 entrance_49 left)
            (passage room_29 entrance_24 right)
            (passage room_29 entrance_25 left)
            (passage room_29 entrance_52 up)
            (passage room_3 entrance_26 right)
            ...
            (passage room_5 entrance_11 left)
            (passage room_5 entrance_29 up)
            (passage room_5 entrance_34 right)
            (passage room_6 entrance_20 up)
            (passage room_6 entrance_21 left)
            (passage room_6 entrance_46 down)
            (passage room_8 entrance_51 left)
            (passage room_9 entrance_47 up)
            (passage room_9 entrance_48 right))
        (:goal
            (escaped player))
)
