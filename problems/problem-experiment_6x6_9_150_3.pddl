(define (problem problem-experiment_6x6_9_150_3)
    (:domain blocky-game)
        ...
        (:init
            ...
            (contains room_13 key_cyan)
            (contains room_17 key_brown)
            (contains room_18 key_beige)
            (contains room_19 key_white)
            (contains room_22 key_pink)
            (contains room_23 key_turquoise)
            (contains room_30 key_green)
            (contains room_31 main_exit)
            (contains room_7 key_black)
            (free place64)
            ...
            (passage room_0 entrance_48 up)
            (passage room_10 entrance_1 right)
            (passage room_11 entrance_10 up)
            (passage room_11 entrance_16 right)
            (passage room_11 entrance_2 left)
            (passage room_12 entrance_35 left)
            (passage room_12 entrance_36 right)
            (passage room_13 entrance_24 left)
            (passage room_15 entrance_28 down)
            (passage room_15 entrance_3 right)
            (passage room_15 entrance_4 left)
            (passage room_16 entrance_22 down)
            (passage room_16 entrance_23 right)
            (passage room_17 entrance_41 right)
            (passage room_18 entrance_37 left)
            (passage room_19 entrance_25 down)
            (passage room_19 entrance_26 left)
            (passage room_19 entrance_27 right)
            (passage room_2 entrance_13 down)
            (passage room_2 entrance_14 right)
            (passage room_2 entrance_19 up)
            ...
            (passage room_22 entrance_42 right)
            (passage room_22 entrance_43 up)
            (passage room_23 entrance_33 left)
            (passage room_24 entrance_7 right)
            (passage room_24 entrance_8 left)
            (passage room_25 entrance_44 down)
            ...
            (passage room_30 entrance_34 down)
            (passage room_30 entrance_9 right)
            (passage room_31 entrance_51 right)
            (passage room_34 entrance_17 left)
            (passage room_34 entrance_18 up)
            (passage room_4 entrance_29 up)
            (passage room_4 entrance_30 right)
            (passage room_5 entrance_39 right)
            (passage room_5 entrance_40 left)
            (passage room_6 entrance_11 down)
            (passage room_6 entrance_12 up)
            (passage room_7 entrance_15 left)
            (passage room_9 entrance_5 right)
            (passage room_9 entrance_6 left))
        (:goal
            (escaped player))
)
