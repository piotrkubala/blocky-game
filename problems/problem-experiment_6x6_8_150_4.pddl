(define (problem problem-experiment_6x6_8_150_4)
    (:domain blocky-game)
        (:objects
            blue - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_17 entrance_45 up)
            (passage room_17 entrance_46 left)
            (passage room_19 entrance_2 down)
            ...
            (passage room_23 entrance_49 down)
            (passage room_24 entrance_38 down)
            (passage room_24 entrance_39 left)
            (passage room_25 entrance_1 up)
            (passage room_26 entrance_42 right)
            (passage room_27 entrance_27 up)
            (passage room_27 entrance_28 down)
            (passage room_28 entrance_18 up)
            (passage room_29 entrance_34 up)
            (passage room_29 entrance_35 left)
            (passage room_30 entrance_14 right)
            (passage room_31 entrance_12 up)
            (passage room_31 entrance_13 left)
