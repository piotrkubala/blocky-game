(define (problem problem-experiment_7x7_6_150_10)
    (:domain blocky-game)
        ...
        (:init
            ...
            (passage room_0 entrance_27 left)
            (passage room_12 entrance_19 right)
            (passage room_12 entrance_20 left)
