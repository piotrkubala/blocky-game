(define (problem problem-experiment_7x7_6_150_10)
    (:domain blocky-game)
        (:objects
            black - colour
            cyan - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_10 key_pink)
            (contains room_12 main_exit)
            (contains room_19 key_cyan)
            (contains room_25 terminal)
            (contains room_35 key_orange)
            (contains room_40 key_black)
            (contains room_5 key_white)
            (contains room_8 key_turquoise)
            (free place12)
            ...
            (is key_white white)
            (passage room_10 entrance_1 down)
            (passage room_11 entrance_25 up)
            (passage room_11 entrance_26 down)
            (passage room_12 entrance_53 left)
            (passage room_15 entrance_17 down)
            (passage room_15 entrance_18 up)
            (passage room_16 entrance_16 up)
            (passage room_16 entrance_7 right)
            (passage room_16 entrance_8 left)
            (passage room_17 entrance_2 up)
            (passage room_17 entrance_3 down)
            (passage room_19 entrance_34 up)
            (passage room_2 entrance_19 down)
            (passage room_2 entrance_20 right)
            (passage room_20 entrance_13 right)
            (passage room_20 entrance_14 left)
            (passage room_20 entrance_39 up)
            (passage room_20 entrance_40 down)
            (passage room_21 entrance_11 down)
            (passage room_21 entrance_12 left)
            (passage room_22 entrance_50 left)
            (passage room_22 entrance_51 down)
            (passage room_23 entrance_10 up)
            (passage room_23 entrance_9 right)
            (passage room_24 entrance_29 down)
            (passage room_24 entrance_4 up)
            (passage room_24 entrance_5 right)
            (passage room_25 entrance_22 up)
            (passage room_25 entrance_24 down)
            (passage room_25 entrance_35 right)
            (passage room_25 entrance_6 left)
            (passage room_26 entrance_30 up)
            (passage room_26 entrance_31 left)
            (passage room_33 entrance_32 right)
            (passage room_33 entrance_33 down)
            (passage room_34 entrance_41 up)
            (passage room_34 entrance_42 down)
            (passage room_35 entrance_15 right)
            (passage room_36 entrance_45 up)
            (passage room_36 entrance_46 right)
            (passage room_40 entrance_47 left)
            (passage room_42 entrance_27 up)
            (passage room_42 entrance_28 down)
            (passage room_42 entrance_52 right)
            (passage room_43 entrance_43 up)
            (passage room_43 entrance_44 down)
            (passage room_44 entrance_37 up)
            (passage room_44 entrance_38 down)
            (passage room_44 entrance_48 left)
            (passage room_44 entrance_49 right)
            (passage room_5 entrance_23 down)
            (passage room_8 entrance_21 left)
            (passage room_8 entrance_36 down))
        (:goal
            (escaped player))
)
