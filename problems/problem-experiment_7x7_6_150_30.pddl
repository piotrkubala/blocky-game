(define (problem problem-experiment_7x7_6_150_30)
    (:domain blocky-game)
        (:objects
            blue - colour
            gold - colour
        ...
        (:init
            ...
            (contains room_15 key_gold)
            (contains room_22 key_blue)
            (contains room_37 key_violet)
            (contains room_40 main_exit)
            (contains room_44 key_purple)
            (contains room_8 key_magenta)
            (contains room_9 key_yellow)
            (free place61)
            ...
            (passage room_1 entrance_44 up)
            (passage room_1 entrance_45 down)
            (passage room_10 entrance_2 left)
            (passage room_10 entrance_3 right)
            (passage room_11 entrance_4 left)
            (passage room_11 entrance_5 right)
            (passage room_12 entrance_6 left)
            (passage room_12 entrance_7 right)
            (passage room_13 entrance_31 down)
            (passage room_13 entrance_47 right)
            (passage room_13 entrance_8 left)
            (passage room_14 entrance_39 right)
            ...
            (passage room_17 entrance_28 right)
            (passage room_17 entrance_32 down)
            (passage room_19 entrance_10 up)
            (passage room_19 entrance_18 left)
            (passage room_19 entrance_29 down)
            (passage room_19 entrance_9 right)
            (passage room_2 entrance_22 right)
            (passage room_2 entrance_23 left)
            (passage room_20 entrance_13 right)
            (passage room_20 entrance_14 left)
            (passage room_20 entrance_19 up)
            (passage room_20 entrance_25 down)
            (passage room_22 entrance_24 right)
            (passage room_22 entrance_54 down)
            (passage room_27 entrance_11 down)
            ...
            (passage room_3 entrance_52 up)
            (passage room_3 entrance_53 left)
            (passage room_31 entrance_37 up)
            (passage room_31 entrance_38 left)
            (passage room_37 entrance_30 up)
            (passage room_39 entrance_48 left)
            (passage room_39 entrance_49 down)
            (passage room_40 entrance_55 up)
            (passage room_41 entrance_42 up)
            (passage room_41 entrance_43 down)
            (passage room_44 entrance_50 up)
