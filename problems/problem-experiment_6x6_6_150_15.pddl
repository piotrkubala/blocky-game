(define (problem problem-experiment_6x6_6_150_15)
    (:domain blocky-game)
        (:objects
            cyan - colour
            green - colour
        ...
        (:init
            ...
            (passage room_0 entrance_14 up)
            (passage room_10 entrance_45 down)
            (passage room_11 entrance_25 down)
            (passage room_11 entrance_26 up)
            (passage room_12 entrance_47 down)
            (passage room_12 entrance_48 right)
            (passage room_13 entrance_53 down)
            (passage room_14 entrance_37 down)
            (passage room_14 entrance_38 right)
            (passage room_15 entrance_11 down)
            (passage room_15 entrance_49 left)
            (passage room_15 entrance_50 right)
            (passage room_16 entrance_41 left)
            (passage room_16 entrance_42 up)
            (passage room_16 entrance_46 down)
            (passage room_18 entrance_39 left)
            (passage room_18 entrance_40 right)
            (passage room_19 entrance_4 right)
            (passage room_19 entrance_5 down)
            (passage room_2 entrance_33 down)
            (passage room_2 entrance_34 right)
            (passage room_20 entrance_2 right)
            (passage room_20 entrance_3 left)
            (passage room_20 entrance_43 down)
            (passage room_20 entrance_44 up)
            (passage room_21 entrance_1 left)
            (passage room_22 entrance_19 left)
            (passage room_22 entrance_20 right)
            (passage room_23 entrance_23 down)
            (passage room_23 entrance_24 up)
            (passage room_24 entrance_12 right)
            (passage room_24 entrance_28 up)
            (passage room_24 entrance_8 left)
            (passage room_25 entrance_6 up)
            (passage room_25 entrance_7 right)
            (passage room_27 entrance_29 down)
            (passage room_27 entrance_30 right)
            (passage room_30 entrance_17 left)
            (passage room_30 entrance_18 right)
            (passage room_31 entrance_15 down)
            (passage room_31 entrance_16 right)
            (passage room_31 entrance_36 up)
            (passage room_32 entrance_21 left)
            (passage room_32 entrance_22 up)
            (passage room_33 entrance_27 down)
            (passage room_34 entrance_51 left)
            (passage room_34 entrance_52 up)
            (passage room_5 entrance_31 left)
            (passage room_5 entrance_32 up)
            (passage room_6 entrance_10 up)
            (passage room_6 entrance_9 down)
            (passage room_7 entrance_35 left))
        (:goal
            (escaped player))
)
