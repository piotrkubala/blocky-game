(define (problem problem-experiment_7x7_6_150_45)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_21 entrance_37 up)
            ...
            (passage room_35 entrance_14 right)
            (passage room_35 entrance_15 down)
            (passage room_36 entrance_20 down)
            (passage room_36 entrance_21 up)
            (passage room_37 entrance_31 up)
            (passage room_41 entrance_29 left)
            (passage room_41 entrance_30 down)
            (passage room_44 entrance_18 right)
            (passage room_45 entrance_41 down)
            (passage room_46 entrance_16 up)
            ...
            (passage room_7 entrance_25 left))
        (:goal
            (escaped player))
)
