(define (problem problem-experiment_7x7_6_150_6)
    (:domain blocky-game)
        (:objects
            gold - colour
            green - colour
        ...
        (:init
            ...
            (contains room_30 key_gold)
            (contains room_34 key_turquoise)
            (contains room_39 terminal)
            (contains room_41 key_green)
            (contains room_42 key_purple)
            (contains room_45 main_exit)
            (contains room_47 key_yellow)
            (free place33)
            ...
            (passage room_12 entrance_44 down)
            (passage room_12 entrance_45 right)
            ...
            (passage room_18 entrance_48 left)
            (passage room_18 entrance_49 right)
            (passage room_20 entrance_38 up)
            (passage room_20 entrance_39 left)
            (passage room_23 entrance_30 down)
            (passage room_23 entrance_31 left)
            (passage room_24 entrance_6 up)
            (passage room_24 entrance_7 right)
            (passage room_25 entrance_24 right)
            (passage room_25 entrance_8 left)
            (passage room_25 entrance_9 down)
            (passage room_27 entrance_33 right)
            (passage room_27 entrance_34 left)
            (passage room_28 entrance_25 right)
            (passage room_28 entrance_26 left)
            (passage room_30 entrance_43 right)
            (passage room_32 entrance_10 up)
            (passage room_32 entrance_11 down)
            (passage room_32 entrance_23 left)
            (passage room_32 entrance_32 right)
            (passage room_34 entrance_29 right)
            (passage room_35 entrance_46 left)
            (passage room_35 entrance_47 right)
            (passage room_36 entrance_27 right)
            (passage room_36 entrance_28 left)
            (passage room_37 entrance_20 right)
            (passage room_37 entrance_21 left)
            (passage room_39 entrance_12 up)
            (passage room_39 entrance_13 down)
            (passage room_39 entrance_41 left)
            (passage room_40 entrance_35 right)
            (passage room_40 entrance_36 left)
            (passage room_41 entrance_40 right)
            (passage room_42 entrance_22 right)
            (passage room_44 entrance_18 right)
            (passage room_44 entrance_19 left)
            (passage room_44 entrance_37 down)
            (passage room_45 entrance_50 left)
            (passage room_46 entrance_14 up)
            (passage room_46 entrance_15 right)
            (passage room_46 entrance_17 left)
            (passage room_47 entrance_16 left)
            (passage room_47 entrance_42 right))
        (:goal
            (escaped player))
)
