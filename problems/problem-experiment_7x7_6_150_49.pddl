(define (problem problem-experiment_7x7_6_150_49)
    (:domain blocky-game)
        (:objects
            black - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_38 key_indigo)
            (contains room_39 key_black)
            (contains room_42 key_violet)
            ...
            (passage room_33 entrance_45 right)
