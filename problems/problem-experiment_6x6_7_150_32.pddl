(define (problem problem-experiment_6x6_7_150_32)
    (:domain blocky-game)
        (:objects
            beige - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_12 entrance_27 down)
            (passage room_12 entrance_38 left)
            (passage room_13 entrance_30 up)
            (passage room_13 entrance_31 left)
            (passage room_15 entrance_10 down)
            (passage room_15 entrance_11 up)
            (passage room_16 entrance_8 down)
            (passage room_16 entrance_9 up)
            (passage room_18 entrance_28 up)
            (passage room_18 entrance_29 down)
            (passage room_18 entrance_41 left)
            (passage room_21 entrance_32 right)
            (passage room_21 entrance_42 up)
            (passage room_21 entrance_43 down)
            (passage room_22 entrance_48 up)
            (passage room_23 entrance_33 down)
            (passage room_24 entrance_4 down)
            (passage room_24 entrance_5 right)
            (passage room_26 entrance_22 right)
            (passage room_26 entrance_23 left)
            (passage room_28 entrance_15 down)
            (passage room_28 entrance_17 left)
            (passage room_28 entrance_2 right)
            (passage room_28 entrance_3 up)
            (passage room_29 entrance_1 left)
            (passage room_3 entrance_12 down)
            (passage room_3 entrance_13 up)
            (passage room_3 entrance_39 right)
            (passage room_30 entrance_49 up)
            (passage room_33 entrance_18 right)
            (passage room_33 entrance_19 down)
            (passage room_33 entrance_6 left)
            (passage room_33 entrance_7 up)
            (passage room_34 entrance_16 up)
            (passage room_4 entrance_34 right)
            (passage room_4 entrance_35 left)
            (passage room_5 entrance_36 right)
            (passage room_5 entrance_37 left)
            (passage room_6 entrance_40 up)
            (passage room_7 entrance_44 up)
            (passage room_7 entrance_45 right)
            (passage room_8 entrance_20 up)
