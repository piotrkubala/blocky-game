(define (problem problem-experiment_6x6_6_150_37)
    (:domain blocky-game)
        (:objects
            beige - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_13 entrance_14 left)
            ...
            (passage room_17 entrance_24 right)
            (passage room_17 entrance_25 left)
            (passage room_19 entrance_2 down)
            (passage room_19 entrance_3 up)
            (passage room_2 entrance_12 right)
            (passage room_2 entrance_13 left)
            (passage room_20 entrance_34 up)
            (passage room_20 entrance_35 down)
            (passage room_21 entrance_30 right)
            (passage room_21 entrance_31 left)
            (passage room_22 entrance_22 up)
            (passage room_22 entrance_23 left)
            (passage room_23 entrance_17 right)
            (passage room_25 entrance_1 up)
            (passage room_26 entrance_37 up)
            (passage room_28 entrance_26 right)
            (passage room_28 entrance_27 left)
            (passage room_3 entrance_10 down)
            (passage room_3 entrance_11 left)
            (passage room_32 entrance_29 right)
            ...
            (passage room_8 entrance_19 left)
            (passage room_8 entrance_8 down)
            (passage room_8 entrance_9 up))
        (:goal
            (escaped player))
)
