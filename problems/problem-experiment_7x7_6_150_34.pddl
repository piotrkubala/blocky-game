(define (problem problem-experiment_7x7_6_150_34)
    (:domain blocky-game)
        (:objects
            brown - colour
            orange - colour
        ...
        (:init
            ...
            (is key_white white)
            (passage room_0 entrance_41 right)
            (passage room_0 entrance_42 down)
            (passage room_1 entrance_12 right)
            (passage room_1 entrance_13 left)
            (passage room_10 entrance_36 left)
            (passage room_11 entrance_18 up)
            (passage room_11 entrance_19 left)
            (passage room_13 entrance_47 right)
            (passage room_14 entrance_17 up)
            (passage room_14 entrance_23 right)
            (passage room_14 entrance_24 left)
            (passage room_14 entrance_38 down)
            (passage room_16 entrance_6 down)
            (passage room_16 entrance_7 up)
            (passage room_17 entrance_35 down)
            (passage room_18 entrance_43 up)
            (passage room_18 entrance_44 left)
            ...
            (passage room_24 entrance_2 down)
            (passage room_24 entrance_22 up)
            (passage room_24 entrance_3 left)
            (passage room_25 entrance_45 right)
            (passage room_25 entrance_46 left)
            (passage room_27 entrance_33 down)
            (passage room_27 entrance_34 up)
            (passage room_27 entrance_37 right)
            (passage room_3 entrance_27 left)
            (passage room_31 entrance_1 up)
            (passage room_37 entrance_39 up)
            (passage room_37 entrance_40 left)
            (passage room_46 entrance_28 left)
            (passage room_46 entrance_29 up)
            (passage room_5 entrance_20 right)
            (passage room_5 entrance_21 down)
