(define (problem problem-experiment_7x7_6_150_21)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_19 key_indigo)
            (contains room_21 key_turquoise)
            (contains room_28 main_exit)
            (contains room_34 key_white)
            (contains room_38 key_orange)
            (free place55)
            ...
            (is key_white white)
            (passage room_0 entrance_41 up)
            (passage room_0 entrance_42 left)
            (passage room_10 entrance_10 left)
            (passage room_10 entrance_35 down)
            (passage room_11 entrance_25 right)
            (passage room_11 entrance_26 left)
            (passage room_13 entrance_43 right)
            (passage room_13 entrance_44 down)
            (passage room_14 entrance_2 down)
            (passage room_14 entrance_3 up)
            (passage room_15 entrance_39 right)
            (passage room_16 entrance_14 right)
            (passage room_16 entrance_15 down)
            (passage room_16 entrance_46 left)
            (passage room_17 entrance_12 up)
            (passage room_17 entrance_13 left)
            (passage room_17 entrance_27 right)
            (passage room_18 entrance_45 up)
            (passage room_19 entrance_34 down)
            ...
            (passage room_22 entrance_17 down)
            (passage room_26 entrance_28 down)
            (passage room_26 entrance_29 left)
            (passage room_28 entrance_49 right)
            (passage room_3 entrance_32 right)
            (passage room_3 entrance_33 up)
            (passage room_3 entrance_40 down)
            (passage room_30 entrance_22 up)
            (passage room_30 entrance_23 left)
            (passage room_31 entrance_18 up)
            (passage room_31 entrance_19 down)
            (passage room_34 entrance_24 right)
            (passage room_37 entrance_20 up)
            (passage room_37 entrance_21 down)
            (passage room_38 entrance_38 up)
            (passage room_4 entrance_30 right)
            (passage room_4 entrance_31 left)
            (passage room_40 entrance_36 up)
            (passage room_40 entrance_37 down)
            (passage room_7 entrance_4 down)
            (passage room_7 entrance_5 right)
            (passage room_8 entrance_6 left)
            (passage room_8 entrance_7 right)
            (passage room_9 entrance_11 down)
            (passage room_9 entrance_8 left)
            (passage room_9 entrance_9 right))
        (:goal
            (escaped player))
)
