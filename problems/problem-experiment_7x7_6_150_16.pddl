(define (problem problem-experiment_7x7_6_150_16)
    (:domain blocky-game)
        (:objects
            beige - colour
            gold - colour
        ...
        (:init
            ...
            (contains room_14 key_green)
            (contains room_28 main_exit)
            (contains room_3 key_navy)
            (contains room_38 key_beige)
            (contains room_41 key_yellow)
            (contains room_46 key_gold)
            (free place22)
            ...
            (passage room_0 entrance_54 right)
            (passage room_10 entrance_8 down)
            (passage room_10 entrance_9 right)
            (passage room_11 entrance_10 left)
            (passage room_11 entrance_11 down)
            (passage room_11 entrance_55 right)
            (passage room_14 entrance_1 right)
            (passage room_15 entrance_2 left)
            (passage room_15 entrance_3 right)
            (passage room_16 entrance_4 left)
            (passage room_16 entrance_5 right)
            (passage room_17 entrance_6 left)
            (passage room_17 entrance_7 up)
            (passage room_18 entrance_14 up)
            (passage room_18 entrance_15 down)
            (passage room_19 entrance_18 right)
            (passage room_19 entrance_19 down)
            (passage room_2 entrance_33 up)
            (passage room_2 entrance_34 left)
            (passage room_20 entrance_35 right)
            (passage room_20 entrance_36 down)
            (passage room_21 entrance_31 right)
            (passage room_21 entrance_32 down)
            (passage room_23 entrance_59 down)
            (passage room_23 entrance_60 right)
            (passage room_27 entrance_37 up)
            (passage room_27 entrance_38 left)
            (passage room_28 entrance_61 left)
            (passage room_3 entrance_48 right)
            (passage room_32 entrance_22 right)
            (passage room_32 entrance_23 left)
            (passage room_33 entrance_56 left)
            (passage room_33 entrance_57 right)
            (passage room_35 entrance_39 right)
            (passage room_35 entrance_40 down)
            (passage room_37 entrance_52 right)
            (passage room_37 entrance_53 left)
            (passage room_38 entrance_51 up)
            (passage room_39 entrance_43 up)
            (passage room_39 entrance_44 down)
            (passage room_4 entrance_49 right)
            (passage room_4 entrance_50 down)
            (passage room_40 entrance_20 up)
            (passage room_40 entrance_21 left)
            (passage room_41 entrance_28 right)
            (passage room_43 entrance_41 up)
            (passage room_43 entrance_42 down)
            (passage room_44 entrance_26 right)
            (passage room_44 entrance_27 left)
            (passage room_45 entrance_24 right)
            (passage room_45 entrance_25 left)
            (passage room_46 entrance_45 up)
            (passage room_5 entrance_12 up)
            (passage room_5 entrance_13 down)
            (passage room_6 entrance_16 up)
            (passage room_6 entrance_17 left)
            (passage room_7 entrance_29 up)
            (passage room_7 entrance_30 left)
            (passage room_8 entrance_46 right)
            (passage room_8 entrance_47 left)
            (passage room_8 entrance_58 up))
        (:goal
            (escaped player))
)
