(define (problem problem-experiment_6x6_6_150_23)
    (:domain blocky-game)
        (:objects
            brown - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_22 entrance_20 down)
