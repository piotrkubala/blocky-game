(define (problem problem-experiment_6x6_5_150_18)
    (:domain blocky-game)
        (:objects
            green - colour
            magenta - colour
        ...
        (:init
            ...
            (contains room_3 key_magenta)
            (contains room_32 key_yellow)
            (contains room_5 key_orange)
            (free place64)
            ...
            (passage room_23 entrance_38 up)
            (passage room_23 entrance_39 right)
            (passage room_24 entrance_26 right)
            ...
            (passage room_30 entrance_33 left)
            (passage room_30 entrance_34 right)
            (passage room_31 entrance_24 down)
            (passage room_31 entrance_25 left)
            (passage room_32 entrance_1 up)
            (passage room_33 entrance_16 left)
            ...
            (passage room_9 entrance_40 left)
