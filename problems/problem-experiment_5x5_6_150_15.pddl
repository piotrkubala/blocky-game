(define (problem problem-experiment_5x5_6_150_15)
    (:domain blocky-game)
        (:objects
            gold - colour
            green - colour
        ...
        (:init
            ...
            (passage room_1 entrance_30 right)
            ...
            (passage room_19 entrance_31 down)
            ...
            (passage room_4 entrance_39 left)
