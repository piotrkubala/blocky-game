(define (problem problem-experiment_6x6_9_150_5)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_22 entrance_57 up)
            (passage room_22 entrance_58 down)
            ...
            (passage room_9 entrance_60 left)
