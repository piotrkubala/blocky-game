(define (problem problem-experiment_7x7_6_150_39)
    (:domain blocky-game)
        (:objects
            blue - colour
            green - colour
        ...
        (:init
            ...
            (passage room_22 entrance_27 down)
            ...
            (passage room_28 entrance_24 right)
            (passage room_28 entrance_31 up)
            (passage room_28 entrance_32 down)
            (passage room_30 entrance_33 up)
            ...
            (passage room_35 entrance_37 down)
            ...
            (passage room_41 entrance_36 up)
