(define (problem problem-experiment_6x6_6_150_18)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_2 entrance_30 left)
            (passage room_2 entrance_31 up)
            ...
            (passage room_26 entrance_5 down)
            (passage room_28 entrance_33 left)
            (passage room_28 entrance_34 down)
            (passage room_29 entrance_40 down)
            ...
            (passage room_33 entrance_7 down)
            (passage room_33 entrance_8 up)
            (passage room_34 entrance_10 left)
