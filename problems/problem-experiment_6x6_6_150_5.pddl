(define (problem problem-experiment_6x6_6_150_5)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_11 entrance_20 right)
            (passage room_15 entrance_26 down)
            (passage room_15 entrance_27 left)
            (passage room_17 entrance_39 right)
            ...
            (passage room_21 entrance_18 right)
            (passage room_23 entrance_31 down)
            ...
            (passage room_28 entrance_43 right)
            (passage room_31 entrance_6 up)
            (passage room_31 entrance_7 right)
            (passage room_32 entrance_14 up)
            ...
            (passage room_33 entrance_11 up)
            (passage room_33 entrance_36 down)
            (passage room_34 entrance_12 down)
            (passage room_34 entrance_13 left)
            (passage room_4 entrance_21 left)
            (passage room_4 entrance_22 up)
            (passage room_6 entrance_30 down)
            (passage room_7 entrance_35 down)
