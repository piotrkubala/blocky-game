(define (problem problem-experiment_7x7_6_150_36)
    (:domain blocky-game)
        (:objects
            green - colour
            indigo - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_14 key_indigo)
            (contains room_16 key_navy)
            (contains room_26 main_exit)
            (contains room_27 key_red)
            (contains room_31 key_pink)
            (contains room_36 key_green)
            (contains room_45 terminal)
            (contains room_5 key_purple)
            (free place72)
            ...
            (is key_red red)
            (passage room_0 entrance_46 right)
            (passage room_0 entrance_47 down)
            (passage room_11 entrance_28 right)
            (passage room_11 entrance_29 left)
            (passage room_12 entrance_26 right)
            (passage room_12 entrance_27 left)
            (passage room_13 entrance_38 up)
            (passage room_13 entrance_39 down)
            (passage room_14 entrance_54 up)
            (passage room_16 entrance_55 up)
            (passage room_17 entrance_19 right)
            (passage room_17 entrance_20 left)
            (passage room_18 entrance_17 right)
            (passage room_18 entrance_18 left)
            (passage room_19 entrance_15 down)
            (passage room_19 entrance_16 left)
            (passage room_19 entrance_30 right)
            (passage room_23 entrance_21 right)
            (passage room_23 entrance_22 down)
            (passage room_24 entrance_23 up)
            (passage room_24 entrance_24 left)
            (passage room_24 entrance_50 right)
            (passage room_24 entrance_51 down)
            (passage room_25 entrance_43 right)
            (passage room_25 entrance_44 left)
            (passage room_25 entrance_58 up)
            (passage room_25 entrance_59 down)
            (passage room_26 entrance_60 up)
            (passage room_27 entrance_1 down)
            (passage room_31 entrance_25 right)
            (passage room_31 entrance_45 left)
            (passage room_31 entrance_56 up)
            (passage room_31 entrance_57 down)
            (passage room_32 entrance_48 up)
            (passage room_32 entrance_49 left)
            (passage room_33 entrance_13 right)
            (passage room_33 entrance_14 up)
            (passage room_34 entrance_2 up)
            (passage room_34 entrance_3 down)
            (passage room_36 entrance_37 up)
            (passage room_39 entrance_35 up)
            (passage room_39 entrance_36 down)
            (passage room_40 entrance_41 right)
            (passage room_40 entrance_42 left)
            (passage room_41 entrance_4 up)
            (passage room_41 entrance_5 down)
            (passage room_43 entrance_52 up)
            (passage room_43 entrance_53 down)
            (passage room_44 entrance_33 up)
            (passage room_44 entrance_34 down)
            (passage room_45 entrance_10 right)
            (passage room_45 entrance_11 up)
            (passage room_45 entrance_32 down)
            (passage room_46 entrance_12 down)
            (passage room_46 entrance_40 up)
            (passage room_46 entrance_8 right)
            (passage room_46 entrance_9 left)
            (passage room_47 entrance_6 up)
            (passage room_47 entrance_7 left)
            (passage room_5 entrance_31 right))
        (:goal
            (escaped player))
)
