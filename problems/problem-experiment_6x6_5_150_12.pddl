(define (problem problem-experiment_6x6_5_150_12)
    (:domain blocky-game)
        (:objects
            black - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_1 entrance_18 left)
            ...
            (passage room_22 entrance_14 right)
            ...
            (passage room_28 entrance_29 right)
