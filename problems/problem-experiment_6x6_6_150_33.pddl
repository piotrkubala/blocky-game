(define (problem problem-experiment_6x6_6_150_33)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_11 entrance_27 left)
            ...
            (passage room_17 entrance_12 left)
            ...
            (passage room_31 entrance_33 left)
            (passage room_8 entrance_24 down)
            (passage room_8 entrance_25 up)
            (passage room_8 entrance_29 left)
