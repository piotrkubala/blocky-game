(define (problem problem-experiment_6x6_5_150_11)
    (:domain blocky-game)
        (:objects
            beige - colour
            grey - colour
        ...
        (:init
            ...
            (at room_8 place24)
            (at room_9 place25)
            (contains room_10 key_turquoise)
            (contains room_11 terminal)
            (contains room_26 key_magenta)
            (contains room_27 key_grey)
            (contains room_29 key_beige)
            (contains room_5 key_violet)
            ...
            (passage room_1 entrance_28 down)
            (passage room_1 entrance_29 right)
            (passage room_10 entrance_1 left)
            (passage room_11 entrance_12 right)
            (passage room_11 entrance_13 up)
            (passage room_12 entrance_10 right)
            (passage room_12 entrance_11 left)
            (passage room_13 entrance_8 right)
            (passage room_13 entrance_9 left)
            (passage room_14 entrance_20 down)
            (passage room_14 entrance_6 up)
            (passage room_14 entrance_7 left)
            (passage room_15 entrance_33 left)
            (passage room_15 entrance_34 up)
            (passage room_16 entrance_35 down)
            (passage room_16 entrance_36 up)
            (passage room_17 entrance_26 down)
            (passage room_17 entrance_27 up)
            (passage room_18 entrance_39 up)
            (passage room_18 entrance_40 right)
            (passage room_19 entrance_21 down)
            (passage room_19 entrance_22 right)
            (passage room_2 entrance_44 left)
            (passage room_2 entrance_45 right)
            (passage room_21 entrance_23 left)
            (passage room_21 entrance_24 right)
            (passage room_22 entrance_52 down)
            (passage room_22 entrance_53 up)
            (passage room_23 entrance_16 down)
            (passage room_23 entrance_17 right)
            (passage room_23 entrance_32 left)
            (passage room_24 entrance_18 left)
            (passage room_24 entrance_19 up)
            (passage room_24 entrance_38 right)
            (passage room_26 entrance_37 down)
            (passage room_27 entrance_54 down)
            (passage room_28 entrance_46 left)
            (passage room_28 entrance_47 up)
            (passage room_29 entrance_43 up)
            (passage room_29 entrance_49 left)
            (passage room_30 entrance_30 down)
            (passage room_30 entrance_31 right)
            (passage room_31 entrance_41 left)
            (passage room_31 entrance_42 down)
            (passage room_4 entrance_55 left)
            (passage room_4 entrance_56 down)
            (passage room_5 entrance_25 left)
            (passage room_6 entrance_14 down)
            (passage room_6 entrance_15 up)
            (passage room_6 entrance_48 right)
            (passage room_7 entrance_57 up)
            (passage room_8 entrance_4 right)
            (passage room_8 entrance_5 down)
            (passage room_9 entrance_2 right)
            (passage room_9 entrance_3 left)
            (passage room_9 entrance_50 down)
            (passage room_9 entrance_51 up))
        (:goal
            (escaped player))
)
