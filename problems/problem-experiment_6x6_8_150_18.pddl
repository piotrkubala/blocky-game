(define (problem problem-experiment_6x6_8_150_18)
    (:domain blocky-game)
        (:objects
            black - colour
            cyan - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_0 key_black)
            (contains room_10 key_navy)
            (contains room_18 key_orange)
            (contains room_22 key_yellow)
            (contains room_23 key_purple)
            (contains room_26 main_exit)
            (contains room_31 terminal)
            (contains room_34 key_indigo)
            (contains room_4 key_cyan)
            (contains room_6 key_grey)
            (free place26)
            ...
            (passage room_0 entrance_56 up)
            (passage room_1 entrance_49 left)
            (passage room_1 entrance_50 right)
            (passage room_10 entrance_28 down)
            (passage room_13 entrance_8 up)
            (passage room_13 entrance_9 down)
            (passage room_14 entrance_24 down)
            (passage room_14 entrance_25 up)
            (passage room_14 entrance_51 left)
            (passage room_14 entrance_52 right)
            (passage room_15 entrance_34 left)
            (passage room_15 entrance_35 up)
            (passage room_18 entrance_29 left)
            (passage room_19 entrance_10 up)
            (passage room_19 entrance_11 down)
            (passage room_2 entrance_4 right)
            (passage room_2 entrance_5 down)
            (passage room_20 entrance_47 down)
            (passage room_20 entrance_48 right)
            (passage room_21 entrance_22 down)
            (passage room_21 entrance_23 up)
            (passage room_21 entrance_41 left)
            (passage room_21 entrance_42 right)
            (passage room_22 entrance_30 left)
            (passage room_22 entrance_32 up)
            (passage room_23 entrance_38 left)
            (passage room_25 entrance_12 up)
            (passage room_25 entrance_13 down)
            (passage room_26 entrance_57 down)
            (passage room_27 entrance_26 down)
            (passage room_27 entrance_27 up)
            (passage room_28 entrance_20 left)
            (passage room_28 entrance_21 up)
            (passage room_3 entrance_2 right)
            (passage room_3 entrance_3 left)
            (passage room_30 entrance_45 left)
            (passage room_30 entrance_46 up)
            (passage room_31 entrance_14 up)
            (passage room_31 entrance_15 right)
            (passage room_31 entrance_31 down)
            (passage room_32 entrance_16 left)
            (passage room_32 entrance_17 right)
            (passage room_32 entrance_40 down)
            (passage room_33 entrance_18 left)
            (passage room_33 entrance_19 right)
            (passage room_34 entrance_33 right)
            (passage room_34 entrance_53 left)
            (passage room_34 entrance_54 up)
            (passage room_4 entrance_1 left)
            (passage room_6 entrance_43 left)
            (passage room_6 entrance_44 right)
            (passage room_8 entrance_6 up)
            (passage room_8 entrance_7 down)
            (passage room_9 entrance_36 down)
            (passage room_9 entrance_37 right))
        (:goal
            (escaped player))
)
