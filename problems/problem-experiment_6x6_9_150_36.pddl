(define (problem problem-experiment_6x6_9_150_36)
    (:domain blocky-game)
        (:objects
            brown - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_1 entrance_31 left)
            ...
            (passage room_14 entrance_19 left)
            ...
            (passage room_26 entrance_5 right)
            (passage room_26 entrance_9 up)
            (passage room_27 entrance_35 left)
            (passage room_28 entrance_8 left)
            (passage room_3 entrance_29 down)
            (passage room_3 entrance_30 right)
            ...
            (passage room_7 entrance_25 right)
