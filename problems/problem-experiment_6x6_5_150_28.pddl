(define (problem problem-experiment_6x6_5_150_28)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_11 entrance_5 down)
            (passage room_14 entrance_19 right)
            (passage room_14 entrance_20 left)
            (passage room_16 entrance_27 right)
            (passage room_16 entrance_28 down)
            (passage room_16 entrance_31 left)
            (passage room_17 entrance_6 up)
            ...
            (passage room_20 entrance_32 down)
            (passage room_21 entrance_35 right)
            (passage room_21 entrance_36 down)
            ...
            (passage room_4 entrance_21 right)
