(define (problem problem-experiment_6x6_9_150_33)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_1 key_orange)
            (contains room_14 main_exit)
            (contains room_23 key_navy)
            (contains room_25 key_beige)
            (contains room_26 key_yellow)
            (contains room_27 key_blue)
            (contains room_29 key_indigo)
            (contains room_3 terminal)
            (contains room_31 key_cyan)
            ...
            (has_door entrance_43 brown)
            (has_door entrance_44 cyan)
            ...
            (has_door entrance_50 cyan)
            (has_door entrance_51 blue)
            (has_door entrance_52 orange)
            (has_door entrance_53 navy)
            (has_door entrance_54 navy)
            (has_door entrance_55 cyan)
            (has_door entrance_56 beige)
            (has_door entrance_57 beige)
            (has_door entrance_58 beige)
            (has_door entrance_59 yellow)
            (has_door entrance_6 indigo)
            (has_door entrance_60 yellow)
            (has_door entrance_61 beige)
            (has_door entrance_62 beige)
            (has_door entrance_63 turquoise)
            (has_door entrance_64 turquoise)
            ...
            (passage room_0 entrance_18 down)
            (passage room_0 entrance_19 left)
            (passage room_1 entrance_24 right)
            (passage room_1 entrance_60 left)
            (passage room_10 entrance_30 right)
            (passage room_10 entrance_31 left)
            (passage room_10 entrance_42 up)
            (passage room_11 entrance_28 up)
            (passage room_11 entrance_29 left)
            (passage room_12 entrance_22 right)
            (passage room_12 entrance_23 left)
            (passage room_13 entrance_35 right)
            (passage room_13 entrance_8 down)
            (passage room_13 entrance_9 up)
            (passage room_14 entrance_64 up)
            (passage room_15 entrance_55 right)
            (passage room_15 entrance_56 left)
            (passage room_17 entrance_20 right)
            (passage room_17 entrance_21 left)
            (passage room_18 entrance_58 right)
            (passage room_18 entrance_6 down)
            (passage room_18 entrance_7 up)
            (passage room_20 entrance_36 up)
            (passage room_20 entrance_37 down)
            (passage room_22 entrance_40 up)
            (passage room_22 entrance_41 down)
            (passage room_23 entrance_32 right)
            (passage room_23 entrance_61 down)
            (passage room_24 entrance_4 down)
            (passage room_24 entrance_5 up)
            (passage room_25 entrance_51 right)
            (passage room_26 entrance_57 right)
            (passage room_27 entrance_45 left)
            (passage room_27 entrance_49 up)
            (passage room_27 entrance_50 down)
            (passage room_29 entrance_1 right)
            (passage room_3 entrance_16 down)
            (passage room_3 entrance_17 up)
            (passage room_3 entrance_25 left)
            (passage room_3 entrance_44 right)
            (passage room_30 entrance_2 left)
            (passage room_30 entrance_3 up)
            (passage room_30 entrance_54 right)
            (passage room_31 entrance_43 right)
            (passage room_33 entrance_38 up)
            (passage room_33 entrance_39 down)
            (passage room_34 entrance_62 up)
            (passage room_34 entrance_63 down)
            (passage room_4 entrance_26 right)
            (passage room_4 entrance_27 down)
            (passage room_4 entrance_34 left)
            (passage room_5 entrance_33 up)
            (passage room_5 entrance_46 down)
            (passage room_5 entrance_52 right)
            (passage room_5 entrance_53 left)
            (passage room_6 entrance_59 down)
            (passage room_7 entrance_10 down)
            (passage room_7 entrance_11 right)
            (passage room_8 entrance_12 left)
            (passage room_8 entrance_13 right)
            (passage room_8 entrance_47 up)
            (passage room_8 entrance_48 down)
            (passage room_9 entrance_14 left)
