(define (problem problem-experiment_6x6_7_150_40)
    (:domain blocky-game)
        (:objects
            brown - colour
            green - colour
        ...
        (:init
            ...
            (passage room_15 entrance_1 down)
            (passage room_16 entrance_12 down)
            (passage room_16 entrance_21 left)
            (passage room_16 entrance_22 up)
            (passage room_17 entrance_42 down)
            (passage room_18 entrance_25 down)
            (passage room_18 entrance_26 right)
            (passage room_19 entrance_15 down)
            (passage room_19 entrance_16 right)
            (passage room_2 entrance_37 down)
            (passage room_20 entrance_2 up)
            (passage room_20 entrance_3 right)
            (passage room_21 entrance_4 left)
            (passage room_21 entrance_5 right)
            (passage room_22 entrance_43 right)
            (passage room_22 entrance_6 left)
            ...
            (passage room_26 entrance_13 down)
            (passage room_26 entrance_14 up)
            (passage room_27 entrance_36 down)
            (passage room_28 entrance_34 right)
            (passage room_28 entrance_35 up)
            ...
            (passage room_4 entrance_41 up)
            (passage room_6 entrance_38 down)
            (passage room_6 entrance_39 up)
            (passage room_7 entrance_29 left)
