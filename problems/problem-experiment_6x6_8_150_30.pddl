(define (problem problem-experiment_6x6_8_150_30)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_11 entrance_13 left)
            ...
            (passage room_15 entrance_29 up)
            ...
            (passage room_26 entrance_26 up)
            (passage room_26 entrance_27 left)
            (passage room_3 entrance_1 right)
            (passage room_32 entrance_24 right)
            (passage room_34 entrance_31 down)
