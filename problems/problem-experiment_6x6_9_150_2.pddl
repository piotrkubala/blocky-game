(define (problem problem-experiment_6x6_9_150_2)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_0 key_pink)
            (contains room_1 main_exit)
            (contains room_10 key_beige)
            (contains room_11 key_brown)
            (contains room_22 key_purple)
            (contains room_23 key_navy)
            (contains room_24 key_violet)
            (contains room_26 terminal)
            (contains room_29 key_black)
            ...
            (passage room_0 entrance_14 right)
            (passage room_1 entrance_48 up)
            (passage room_10 entrance_1 down)
            (passage room_11 entrance_39 down)
            (passage room_13 entrance_35 down)
            (passage room_13 entrance_36 up)
            (passage room_14 entrance_10 down)
            (passage room_14 entrance_11 left)
            (passage room_15 entrance_16 right)
            (passage room_15 entrance_17 left)
            ...
            (passage room_20 entrance_27 down)
            (passage room_20 entrance_28 up)
            ...
            (passage room_24 entrance_37 down)
            (passage room_26 entrance_15 left)
            (passage room_26 entrance_8 right)
            (passage room_26 entrance_9 up)
            (passage room_27 entrance_6 up)
            (passage room_27 entrance_7 left)
            (passage room_28 entrance_29 down)
            (passage room_28 entrance_30 up)
            (passage room_29 entrance_38 left)
            (passage room_3 entrance_31 down)
            (passage room_3 entrance_32 up)
            (passage room_3 entrance_47 right)
            (passage room_32 entrance_18 right)
            (passage room_32 entrance_19 up)
            (passage room_33 entrance_43 right)
            (passage room_33 entrance_44 up)
            (passage room_34 entrance_46 down)
            (passage room_4 entrance_33 down)
            (passage room_4 entrance_45 up)
            (passage room_5 entrance_25 right)
            (passage room_5 entrance_26 up)
            (passage room_6 entrance_20 down)
            (passage room_6 entrance_21 up)
            (passage room_9 entrance_23 down)
            (passage room_9 entrance_24 left))
        (:goal
            (escaped player))
)
