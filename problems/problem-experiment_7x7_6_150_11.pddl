(define (problem problem-experiment_7x7_6_150_11)
    (:domain blocky-game)
        (:objects
            blue - colour
            grey - colour
        ...
        (:init
            ...
            (is key_white white)
            (passage room_0 entrance_35 down)
            (passage room_1 entrance_33 down)
            (passage room_1 entrance_34 up)
            ...
            (passage room_15 entrance_16 left)
            (passage room_15 entrance_17 down)
            (passage room_16 entrance_27 left)
            ...
            (passage room_4 entrance_25 down)
            (passage room_4 entrance_26 right)
            (passage room_4 entrance_40 left)
            (passage room_44 entrance_2 right)
            (passage room_44 entrance_3 up)
            (passage room_45 entrance_1 left)
            (passage room_6 entrance_31 down)
            (passage room_7 entrance_36 up)
