(define (problem problem-experiment_6x6_8_150_24)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_10 entrance_25 right)
            (passage room_10 entrance_26 left)
