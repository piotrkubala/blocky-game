(define (problem problem-experiment_6x6_9_150_11)
    (:domain blocky-game)
        (:objects
            brown - colour
            cyan - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place25)
            (contains room_0 key_green)
            (contains room_14 key_pink)
            (contains room_17 key_brown)
            (contains room_20 main_exit)
            (contains room_22 key_cyan)
            (contains room_24 key_red)
            (contains room_29 key_grey)
            (contains room_6 key_violet)
            (contains room_7 key_navy)
            (contains room_8 terminal)
            (contains room_9 key_purple)
            (free place24)
            ...
            (passage room_1 entrance_55 right)
            (passage room_1 entrance_56 left)
            (passage room_10 entrance_52 right)
            (passage room_10 entrance_53 left)
            (passage room_10 entrance_61 down)
            (passage room_10 entrance_62 up)
            (passage room_12 entrance_29 down)
            (passage room_12 entrance_30 up)
            (passage room_14 entrance_37 up)
            (passage room_14 entrance_38 left)
            (passage room_14 entrance_49 down)
            (passage room_15 entrance_39 right)
            (passage room_15 entrance_40 left)
            (passage room_16 entrance_20 down)
            (passage room_16 entrance_21 left)
            (passage room_16 entrance_48 up)
            (passage room_17 entrance_36 left)
            (passage room_18 entrance_26 down)
            (passage room_18 entrance_27 left)
            (passage room_18 entrance_41 right)
            (passage room_18 entrance_59 up)
            (passage room_19 entrance_24 down)
            (passage room_19 entrance_25 up)
            (passage room_2 entrance_28 up)
            (passage room_2 entrance_6 right)
            (passage room_2 entrance_7 down)
            (passage room_20 entrance_63 left)
            (passage room_22 entrance_17 left)
            ...
            (passage room_24 entrance_60 down)
            (passage room_25 entrance_34 up)
            (passage room_25 entrance_35 right)
            (passage room_27 entrance_43 right)
            (passage room_27 entrance_44 down)
            (passage room_27 entrance_54 left)
            (passage room_29 entrance_45 up)
            (passage room_29 entrance_50 right)
            (passage room_29 entrance_51 left)
            (passage room_3 entrance_4 right)
            (passage room_3 entrance_5 left)
            (passage room_31 entrance_22 right)
            (passage room_31 entrance_23 up)
            (passage room_31 entrance_42 left)
            (passage room_31 entrance_46 down)
            (passage room_33 entrance_13 left)
            (passage room_33 entrance_14 right)
            (passage room_33 entrance_57 up)
            (passage room_34 entrance_15 left)
            (passage room_34 entrance_16 right)
            (passage room_4 entrance_2 down)
            (passage room_4 entrance_3 left)
            (passage room_6 entrance_58 down)
            (passage room_7 entrance_10 left)
            (passage room_7 entrance_31 down)
            (passage room_8 entrance_18 left)
            (passage room_8 entrance_33 down)
            (passage room_8 entrance_8 up)
