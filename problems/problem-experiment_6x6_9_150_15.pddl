(define (problem problem-experiment_6x6_9_150_15)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_12 key_cyan)
            (contains room_14 key_violet)
            (contains room_15 key_pink)
            (contains room_16 key_beige)
            (contains room_25 key_turquoise)
            (contains room_27 terminal)
            (contains room_32 key_indigo)
            (contains room_4 key_green)
            (contains room_7 key_purple)
            ...
            (passage room_0 entrance_21 left)
            (passage room_0 entrance_22 up)
            (passage room_0 entrance_48 right)
            (passage room_1 entrance_54 left)
            (passage room_12 entrance_38 down)
            (passage room_13 entrance_25 down)
            (passage room_13 entrance_26 up)
            (passage room_13 entrance_41 left)
            (passage room_13 entrance_47 right)
            (passage room_14 entrance_11 right)
            (passage room_15 entrance_36 right)
            (passage room_16 entrance_37 right)
            ...
            (passage room_2 entrance_17 right)
            (passage room_2 entrance_18 left)
            (passage room_2 entrance_35 down)
            (passage room_20 entrance_10 left)
            (passage room_20 entrance_30 up)
            (passage room_20 entrance_9 down)
            (passage room_21 entrance_12 up)
            (passage room_21 entrance_6 down)
            (passage room_21 entrance_7 left)
            (passage room_23 entrance_52 up)
            (passage room_23 entrance_53 right)
            (passage room_24 entrance_33 down)
            (passage room_24 entrance_34 up)
            (passage room_25 entrance_1 right)
            (passage room_26 entrance_2 left)
            (passage room_26 entrance_3 right)
            (passage room_26 entrance_8 up)
            (passage room_27 entrance_20 right)
            (passage room_27 entrance_4 left)
            (passage room_27 entrance_46 down)
            (passage room_27 entrance_5 up)
            (passage room_29 entrance_50 left)
            (passage room_29 entrance_51 down)
            (passage room_3 entrance_28 right)
            (passage room_3 entrance_29 up)
            (passage room_3 entrance_40 down)
            (passage room_32 entrance_49 up)
            (passage room_4 entrance_19 right)
            (passage room_4 entrance_31 down)
            (passage room_4 entrance_32 up)
            (passage room_4 entrance_44 left)
            (passage room_5 entrance_15 down)
            (passage room_5 entrance_16 left)
            (passage room_5 entrance_39 up)
            (passage room_7 entrance_27 down)
            (passage room_7 entrance_42 left)
            (passage room_7 entrance_43 right)
            (passage room_8 entrance_45 left))
        (:goal
            (escaped player))
)
