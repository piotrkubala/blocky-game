(define (problem problem-experiment_6x6_9_150_16)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (contains room_14 key_orange)
            (contains room_15 key_cyan)
            (contains room_17 terminal)
            (contains room_20 key_black)
            (contains room_24 key_magenta)
            (contains room_25 main_exit)
            (contains room_27 key_brown)
            (contains room_6 key_green)
            (contains room_7 key_beige)
            ...
            (passage room_0 entrance_24 down)
            (passage room_0 entrance_25 right)
            (passage room_12 entrance_12 down)
            (passage room_12 entrance_13 right)
            (passage room_13 entrance_1 down)
            (passage room_14 entrance_10 left)
            (passage room_14 entrance_15 right)
            (passage room_14 entrance_26 down)
            (passage room_14 entrance_27 up)
            (passage room_15 entrance_49 up)
            (passage room_15 entrance_51 right)
            (passage room_15 entrance_52 down)
            (passage room_16 entrance_28 down)
            (passage room_16 entrance_29 up)
            (passage room_17 entrance_11 up)
            (passage room_17 entrance_4 right)
            (passage room_17 entrance_5 down)
            (passage room_17 entrance_50 left)
            (passage room_18 entrance_2 up)
            (passage room_18 entrance_3 left)
            (passage room_18 entrance_37 right)
            (passage room_19 entrance_16 left)
            (passage room_19 entrance_17 up)
            (passage room_20 entrance_46 up)
            (passage room_23 entrance_6 up)
            (passage room_23 entrance_7 down)
            (passage room_24 entrance_36 up)
            (passage room_25 entrance_53 up)
            (passage room_26 entrance_18 down)
            (passage room_26 entrance_19 right)
            (passage room_27 entrance_20 left)
            (passage room_28 entrance_47 up)
            (passage room_28 entrance_48 down)
            (passage room_29 entrance_14 left)
            (passage room_29 entrance_8 up)
            (passage room_29 entrance_9 right)
            (passage room_30 entrance_40 left)
            (passage room_30 entrance_41 right)
            (passage room_31 entrance_33 right)
            (passage room_31 entrance_34 left)
            (passage room_32 entrance_31 down)
            (passage room_32 entrance_32 left)
            (passage room_33 entrance_38 left)
            (passage room_33 entrance_39 right)
            (passage room_34 entrance_42 left)
            (passage room_34 entrance_43 down)
            (passage room_5 entrance_21 left)
            (passage room_5 entrance_22 up)
            (passage room_6 entrance_30 down)
            (passage room_7 entrance_35 right)
            (passage room_8 entrance_23 down)
            (passage room_9 entrance_44 up)
            (passage room_9 entrance_45 down))
        (:goal
            (escaped player))
)
