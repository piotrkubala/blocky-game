(define (problem problem-experiment_6x6_8_150_32)
    (:domain blocky-game)
        (:objects
            beige - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_0 entrance_35 right)
            (passage room_0 entrance_6 up)
            (passage room_0 entrance_7 down)
            (passage room_11 entrance_31 left)
            (passage room_12 entrance_8 up)
            (passage room_13 entrance_16 left)
            ...
            (passage room_15 entrance_19 up)
            ...
            (passage room_26 entrance_41 left)
            ...
            (passage room_32 entrance_37 down)
            ...
            (passage room_4 entrance_22 left)
            (passage room_4 entrance_23 up)
            (passage room_5 entrance_39 left)
            (passage room_5 entrance_40 right)
            (passage room_6 entrance_43 up)
            (passage room_8 entrance_34 left)
