(define (problem problem-experiment_6x6_7_150_31)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_0 entrance_30 down)
            (passage room_0 entrance_31 up)
            (passage room_1 entrance_39 left)
            (passage room_10 entrance_46 up)
            ...
            (passage room_14 entrance_29 up)
            (passage room_15 entrance_42 up)
            (passage room_15 entrance_44 right)
            (passage room_15 entrance_45 down)
            (passage room_16 entrance_26 left)
            (passage room_18 entrance_37 left)
            (passage room_18 entrance_38 right)
            (passage room_18 entrance_51 down)
            (passage room_19 entrance_8 up)
            (passage room_19 entrance_9 down)
            (passage room_20 entrance_33 down)
            (passage room_20 entrance_34 up)
            (passage room_20 entrance_50 left)
            ...
            (passage room_25 entrance_52 up)
            (passage room_27 entrance_20 left)
            (passage room_27 entrance_21 right)
            (passage room_29 entrance_18 left)
            (passage room_29 entrance_19 right)
            (passage room_3 entrance_32 down)
            (passage room_30 entrance_12 up)
            (passage room_30 entrance_13 left)
            (passage room_30 entrance_15 down)
            (passage room_32 entrance_24 left)
            (passage room_32 entrance_25 right)
            (passage room_34 entrance_22 left)
            (passage room_34 entrance_23 right)
            (passage room_5 entrance_41 left)
            (passage room_5 entrance_43 up)
            ...
            (passage room_8 entrance_2 right)
            (passage room_8 entrance_3 left)
            (passage room_8 entrance_40 down)
            (passage room_9 entrance_1 left))
        (:goal
            (escaped player))
)
