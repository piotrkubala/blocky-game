(define (problem problem-experiment_6x6_6_150_17)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_10 entrance_16 down)
            ...
            (passage room_16 entrance_20 right)
            (passage room_17 entrance_2 down)
            (passage room_17 entrance_3 right)
            (passage room_18 entrance_4 left)
            (passage room_18 entrance_5 right)
            (passage room_19 entrance_6 left)
            (passage room_19 entrance_7 right)
            (passage room_2 entrance_21 right)
            (passage room_20 entrance_8 left)
            (passage room_20 entrance_9 right)
            (passage room_21 entrance_10 left)
            ...
            (passage room_3 entrance_27 right)
            (passage room_31 entrance_32 up)
