(define (problem problem-experiment_6x6_9_150_24)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (contains room_11 key_beige)
            (contains room_18 terminal)
            (contains room_22 key_grey)
            ...
            (is key_white white)
            (passage room_0 entrance_36 left)
            (passage room_1 entrance_34 left)
            (passage room_1 entrance_35 right)
            (passage room_1 entrance_57 down)
            (passage room_1 entrance_58 up)
            (passage room_11 entrance_54 down)
            ...
            (passage room_14 entrance_40 left)
            (passage room_14 entrance_41 right)
            (passage room_14 entrance_56 up)
            (passage room_16 entrance_15 down)
            (passage room_16 entrance_16 right)
            (passage room_17 entrance_19 down)
            (passage room_17 entrance_20 up)
            (passage room_18 entrance_31 down)
            (passage room_18 entrance_50 left)
            (passage room_18 entrance_52 up)
            (passage room_18 entrance_8 right)
            (passage room_19 entrance_6 right)
            (passage room_19 entrance_7 left)
            (passage room_2 entrance_32 up)
            (passage room_2 entrance_33 right)
            ...
            (passage room_21 entrance_2 down)
            (passage room_21 entrance_3 left)
            (passage room_22 entrance_49 down)
            (passage room_23 entrance_10 right)
            ...
            (passage room_26 entrance_11 left)
            (passage room_26 entrance_12 right)
            (passage room_26 entrance_24 down)
            (passage room_26 entrance_25 up)
            (passage room_27 entrance_1 up)
            (passage room_28 entrance_13 left)
            (passage room_28 entrance_14 up)
            (passage room_28 entrance_53 down)
            (passage room_30 entrance_46 up)
            (passage room_31 entrance_44 left)
            (passage room_31 entrance_45 down)
            (passage room_33 entrance_47 down)
            (passage room_33 entrance_48 up)
            (passage room_34 entrance_17 left)
            (passage room_34 entrance_18 up)
            (passage room_34 entrance_55 right)
            (passage room_4 entrance_21 down)
            (passage room_5 entrance_39 down)
            (passage room_7 entrance_51 right)
            (passage room_8 entrance_30 left)
            (passage room_9 entrance_28 down)
            (passage room_9 entrance_29 right))
        (:goal
            (escaped player))
)
