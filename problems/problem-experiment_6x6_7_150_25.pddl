(define (problem problem-experiment_6x6_7_150_25)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_14 key_yellow)
            (contains room_21 key_white)
            (contains room_23 main_exit)
            (contains room_25 key_red)
            (contains room_28 key_blue)
            (contains room_32 key_beige)
            (contains room_4 key_gold)
            (contains room_8 terminal)
            (contains room_9 key_brown)
            (free place26)
            ...
            (has_door entrance_31 white)
            (has_door entrance_32 white)
            ...
            (has_door entrance_51 gold)
            (has_door entrance_52 gold)
            (has_door entrance_53 white)
            (has_door entrance_54 white)
            (has_door entrance_55 red)
            (has_door entrance_56 red)
            (has_door entrance_57 blue)
            (has_door entrance_58 gold)
            (has_door entrance_59 gold)
            (has_door entrance_6 white)
            (has_door entrance_60 gold)
            (has_door entrance_61 brown)
            ...
            (passage room_0 entrance_41 down)
            (passage room_0 entrance_42 up)
            (passage room_1 entrance_44 down)
            (passage room_1 entrance_45 right)
            (passage room_10 entrance_52 left)
            (passage room_10 entrance_53 right)
            ...
            (passage room_14 entrance_48 left)
            (passage room_16 entrance_37 left)
            (passage room_16 entrance_38 up)
            (passage room_17 entrance_15 left)
            (passage room_17 entrance_16 right)
            (passage room_19 entrance_4 right)
            (passage room_19 entrance_43 down)
            (passage room_19 entrance_5 up)
            (passage room_20 entrance_2 right)
            (passage room_20 entrance_3 left)
            (passage room_20 entrance_30 up)
            (passage room_20 entrance_31 down)
            (passage room_21 entrance_1 left)
            (passage room_22 entrance_35 left)
            (passage room_22 entrance_36 right)
            (passage room_23 entrance_61 down)
            (passage room_24 entrance_27 down)
            (passage room_24 entrance_28 up)
            (passage room_25 entrance_49 up)
            (passage room_25 entrance_54 left)
            (passage room_25 entrance_55 right)
            (passage room_28 entrance_23 left)
            (passage room_28 entrance_26 up)
            (passage room_28 entrance_34 right)
            (passage room_29 entrance_11 up)
            (passage room_29 entrance_12 down)
            (passage room_29 entrance_50 left)
            (passage room_29 entrance_51 right)
            (passage room_30 entrance_19 left)
            (passage room_30 entrance_20 down)
            (passage room_30 entrance_60 up)
            (passage room_31 entrance_13 up)
            (passage room_31 entrance_14 right)
            (passage room_31 entrance_57 down)
            (passage room_32 entrance_29 down)
            (passage room_32 entrance_58 left)
            (passage room_32 entrance_59 up)
            (passage room_33 entrance_21 up)
            (passage room_33 entrance_22 right)
            (passage room_33 entrance_25 left)
            (passage room_34 entrance_17 left)
            (passage room_34 entrance_18 right)
            (passage room_4 entrance_39 down)
            (passage room_6 entrance_46 left)
            (passage room_6 entrance_47 right)
            (passage room_7 entrance_10 down)
            (passage room_7 entrance_9 up)
            (passage room_8 entrance_24 right)
            (passage room_8 entrance_40 up)
            (passage room_8 entrance_8 down)
            (passage room_9 entrance_56 left))
        (:goal
            (escaped player))
)
