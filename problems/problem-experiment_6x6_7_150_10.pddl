(define (problem problem-experiment_6x6_7_150_10)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_11 key_black)
            (contains room_14 key_brown)
            (contains room_17 key_white)
            ...
            (passage room_0 entrance_4 up)
            (passage room_1 entrance_28 up)
            (passage room_1 entrance_29 right)
            (passage room_11 entrance_36 up)
            (passage room_13 entrance_10 down)
            (passage room_13 entrance_9 up)
            (passage room_14 entrance_32 up)
            (passage room_15 entrance_18 left)
            (passage room_15 entrance_19 right)
            (passage room_15 entrance_38 down)
            (passage room_17 entrance_1 down)
            ...
            (passage room_23 entrance_34 left)
            (passage room_23 entrance_8 down)
            (passage room_24 entrance_12 up)
            (passage room_24 entrance_13 right)
            (passage room_29 entrance_14 left)
            (passage room_29 entrance_15 right)
            (passage room_29 entrance_35 down)
