(define (problem problem-experiment_6x6_8_150_38)
    (:domain blocky-game)
        (:objects
            blue - colour
            gold - colour
        ...
        (:init
            ...
            (is key_white white)
            (passage room_0 entrance_18 right)
            (passage room_0 entrance_19 down)
            (passage room_0 entrance_26 left)
            (passage room_0 entrance_29 up)
            (passage room_1 entrance_16 right)
            (passage room_1 entrance_17 left)
            (passage room_11 entrance_32 down)
            (passage room_12 entrance_36 down)
            ...
            (passage room_18 entrance_33 up)
            (passage room_18 entrance_34 left)
            (passage room_19 entrance_41 right)
            (passage room_2 entrance_14 down)
            (passage room_2 entrance_15 left)
            (passage room_20 entrance_6 right)
