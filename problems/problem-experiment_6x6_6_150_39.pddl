(define (problem problem-experiment_6x6_6_150_39)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_0 entrance_28 left)
            ...
            (passage room_13 entrance_22 left)
            ...
            (passage room_20 entrance_16 right)
