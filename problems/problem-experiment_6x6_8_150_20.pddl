(define (problem problem-experiment_6x6_8_150_20)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (is key_red red)
            (is key_white white)
            (passage room_1 entrance_32 right)
            (passage room_1 entrance_35 left)
            (passage room_1 entrance_47 up)
            (passage room_10 entrance_1 up)
            (passage room_12 entrance_39 down)
            (passage room_14 entrance_12 right)
            (passage room_14 entrance_13 down)
            (passage room_15 entrance_23 right)
            (passage room_15 entrance_24 left)
            (passage room_15 entrance_40 up)
            (passage room_16 entrance_26 up)
            (passage room_17 entrance_31 right)
            (passage room_2 entrance_21 left)
            (passage room_2 entrance_6 right)
            (passage room_2 entrance_7 down)
            (passage room_20 entrance_14 up)
            (passage room_20 entrance_15 left)
            (passage room_21 entrance_8 up)
            (passage room_21 entrance_9 down)
            (passage room_22 entrance_25 right)
            (passage room_23 entrance_29 down)
            ...
            (passage room_27 entrance_11 left)
            (passage room_27 entrance_22 right)
            (passage room_27 entrance_34 down)
            (passage room_28 entrance_43 up)
            (passage room_28 entrance_44 left)
            (passage room_3 entrance_4 right)
            (passage room_3 entrance_5 left)
            (passage room_31 entrance_48 right)
            ...
            (passage room_7 entrance_27 right)
            (passage room_7 entrance_28 up)
            (passage room_7 entrance_42 down)
