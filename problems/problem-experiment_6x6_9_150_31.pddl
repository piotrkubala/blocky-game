(define (problem problem-experiment_6x6_9_150_31)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (contains room_13 key_green)
            (contains room_14 key_blue)
            (contains room_2 key_beige)
            (contains room_20 key_cyan)
            (contains room_23 main_exit)
            (contains room_26 key_navy)
            (contains room_30 terminal)
            (contains room_33 key_purple)
            (contains room_8 key_white)
            (free place66)
            ...
            (is key_white white)
            (passage room_0 entrance_2 right)
            (passage room_0 entrance_3 down)
            (passage room_0 entrance_43 left)
            (passage room_1 entrance_1 left)
            (passage room_11 entrance_30 up)
            (passage room_11 entrance_37 right)
            ...
            (passage room_18 entrance_9 down)
            (passage room_2 entrance_49 right)
            (passage room_20 entrance_50 right)
            (passage room_21 entrance_15 down)
            (passage room_21 entrance_16 up)
            (passage room_21 entrance_26 left)
            (passage room_21 entrance_27 right)
            (passage room_22 entrance_28 left)
            (passage room_22 entrance_29 down)
            (passage room_22 entrance_46 right)
            (passage room_23 entrance_54 right)
            (passage room_24 entrance_10 up)
            (passage room_24 entrance_11 down)
            (passage room_26 entrance_31 down)
            (passage room_26 entrance_42 up)
            (passage room_26 entrance_52 left)
            (passage room_27 entrance_22 left)
            (passage room_27 entrance_23 up)
            (passage room_28 entrance_39 right)
            (passage room_28 entrance_40 left)
            (passage room_3 entrance_44 right)
            (passage room_3 entrance_45 left)
            (passage room_30 entrance_12 up)
            (passage room_30 entrance_25 right)
            (passage room_30 entrance_32 left)
            (passage room_31 entrance_18 down)
            (passage room_31 entrance_19 right)
            (passage room_33 entrance_51 right)
            (passage room_34 entrance_13 down)
            (passage room_34 entrance_14 up)
            (passage room_4 entrance_35 down)
            (passage room_4 entrance_36 left)
            (passage room_5 entrance_33 right)
            (passage room_5 entrance_34 up)
            (passage room_6 entrance_4 up)
            (passage room_6 entrance_47 right)
            (passage room_6 entrance_48 left)
            (passage room_6 entrance_5 down)
            (passage room_7 entrance_20 left)
            (passage room_7 entrance_21 right)
            (passage room_8 entrance_24 down))
        (:goal
            (escaped player))
)
