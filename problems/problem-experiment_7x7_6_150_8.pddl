(define (problem problem-experiment_7x7_6_150_8)
    (:domain blocky-game)
        (:objects
            black - colour
            orange - colour
        ...
        (:init
            ...
            (contains room_29 key_yellow)
            (contains room_30 main_exit)
            (contains room_33 key_black)
            (contains room_35 key_turquoise)
            (contains room_9 key_red)
            (free place33)
            ...
            (passage room_1 entrance_54 down)
            (passage room_1 entrance_55 up)
            (passage room_10 entrance_49 right)
            (passage room_10 entrance_50 up)
            (passage room_12 entrance_33 right)
            (passage room_12 entrance_34 down)
            ...
            (passage room_18 entrance_14 left)
            (passage room_18 entrance_26 right)
            (passage room_19 entrance_20 right)
            (passage room_19 entrance_21 up)
            (passage room_22 entrance_15 left)
            (passage room_22 entrance_2 down)
            (passage room_22 entrance_3 right)
            (passage room_23 entrance_12 up)
            (passage room_23 entrance_4 left)
            (passage room_23 entrance_5 right)
            (passage room_23 entrance_56 down)
            (passage room_24 entrance_11 down)
            (passage room_24 entrance_6 left)
            (passage room_24 entrance_7 right)
            (passage room_25 entrance_17 up)
            (passage room_25 entrance_8 left)
            (passage room_26 entrance_53 up)
            (passage room_29 entrance_1 up)
            (passage room_30 entrance_57 right)
            (passage room_31 entrance_31 right)
            (passage room_31 entrance_32 left)
            (passage room_32 entrance_18 down)
            (passage room_32 entrance_19 left)
            (passage room_33 entrance_51 down)
            (passage room_35 entrance_35 up)
            (passage room_36 entrance_37 right)
            (passage room_36 entrance_38 up)
            (passage room_36 entrance_52 down)
            (passage room_38 entrance_10 up)
            (passage room_38 entrance_30 left)
            (passage room_38 entrance_9 right)
            (passage room_39 entrance_22 down)
            (passage room_39 entrance_23 up)
            (passage room_40 entrance_28 right)
            (passage room_40 entrance_29 down)
            (passage room_40 entrance_36 left)
            (passage room_45 entrance_39 down)
            (passage room_45 entrance_40 up)
            (passage room_46 entrance_43 down)
            (passage room_46 entrance_44 left)
            (passage room_47 entrance_41 down)
            (passage room_47 entrance_42 up)
            (passage room_5 entrance_24 down)
            (passage room_5 entrance_25 up)
            (passage room_6 entrance_45 right)
