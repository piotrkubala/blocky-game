(define (problem problem-experiment_6x6_7_150_5)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_33 key_turquoise)
            (free place13)
            ...
            (passage room_11 entrance_45 left)
