(define (problem problem-experiment_6x6_6_150_10)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_6 entrance_26 right)
            (passage room_7 entrance_20 down)
            (passage room_9 entrance_4 right)
