(define (problem problem-experiment_7x7_6_150_25)
    (:domain blocky-game)
        (:objects
            brown - colour
            gold - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_13 key_violet)
            (contains room_14 key_gold)
            (contains room_26 key_brown)
            (contains room_30 key_indigo)
            (contains room_36 key_navy)
            (contains room_39 main_exit)
            (contains room_41 terminal)
            (contains room_47 key_red)
            (free place66)
            ...
            (has_door entrance_31 navy)
            (has_door entrance_31 red)
            (has_door entrance_32 navy)
            ...
            (has_door entrance_39 violet)
            (has_door entrance_4 brown)
            (has_door entrance_4 navy)
            (has_door entrance_40 violet)
            (has_door entrance_41 navy)
            (has_door entrance_42 navy)
            (has_door entrance_43 gold)
            (has_door entrance_43 navy)
            (has_door entrance_44 brown)
            (has_door entrance_45 brown)
            (has_door entrance_46 brown)
            (has_door entrance_47 red)
            (has_door entrance_48 navy)
            (has_door entrance_49 navy)
            (has_door entrance_5 navy)
            (has_door entrance_50 violet)
            (has_door entrance_51 violet)
            (has_door entrance_52 brown)
            ...
            (passage room_10 entrance_33 left)
            (passage room_10 entrance_34 right)
            (passage room_12 entrance_43 left)
            (passage room_12 entrance_44 right)
            (passage room_13 entrance_30 down)
            (passage room_14 entrance_55 up)
            (passage room_14 entrance_59 right)
            (passage room_14 entrance_60 left)
            (passage room_16 entrance_49 left)
            (passage room_16 entrance_50 right)
            (passage room_17 entrance_35 left)
            (passage room_17 entrance_36 right)
            (passage room_19 entrance_28 down)
            (passage room_19 entrance_29 up)
            (passage room_21 entrance_47 up)
            (passage room_21 entrance_48 right)
            (passage room_21 entrance_5 left)
            (passage room_21 entrance_6 down)
            (passage room_23 entrance_51 left)
            (passage room_23 entrance_52 down)
            (passage room_24 entrance_26 down)
            (passage room_24 entrance_27 up)
            (passage room_25 entrance_38 left)
            (passage room_25 entrance_39 right)
            (passage room_26 entrance_40 left)
            (passage room_30 entrance_45 left)
            (passage room_31 entrance_17 down)
            (passage room_31 entrance_18 right)
            (passage room_31 entrance_25 up)
            (passage room_32 entrance_11 left)
            (passage room_32 entrance_12 right)
            (passage room_32 entrance_42 up)
            (passage room_33 entrance_15 left)
            (passage room_33 entrance_16 up)
            (passage room_35 entrance_31 down)
            (passage room_35 entrance_32 right)
            (passage room_35 entrance_46 left)
            (passage room_36 entrance_1 down)
            (passage room_37 entrance_7 up)
            (passage room_37 entrance_8 down)
            (passage room_38 entrance_13 left)
            (passage room_38 entrance_14 right)
            (passage room_39 entrance_63 right)
            (passage room_40 entrance_57 up)
            (passage room_40 entrance_58 left)
            (passage room_41 entrance_20 up)
            (passage room_41 entrance_4 right)
            (passage room_41 entrance_41 down)
            (passage room_42 entrance_2 up)
            (passage room_42 entrance_3 left)
            (passage room_43 entrance_10 right)
            (passage room_43 entrance_9 up)
            (passage room_45 entrance_23 left)
            (passage room_45 entrance_24 up)
            (passage room_45 entrance_37 right)
            (passage room_45 entrance_56 down)
            (passage room_47 entrance_19 left)
            (passage room_47 entrance_21 down)
            (passage room_47 entrance_22 right)
            (passage room_7 entrance_53 up)
            (passage room_7 entrance_54 down)
            (passage room_7 entrance_61 right)
            (passage room_7 entrance_62 left))
        (:goal
            (escaped player))
)
