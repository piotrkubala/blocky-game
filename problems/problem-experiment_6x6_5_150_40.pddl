(define (problem problem-experiment_6x6_5_150_40)
    (:domain blocky-game)
        (:objects
            gold - colour
            pink - colour
        ...
        (:init
            ...
            (passage room_19 entrance_17 left)
            ...
            (passage room_27 entrance_26 left)
            ...
            (passage room_8 entrance_15 right)
            (passage room_9 entrance_16 left))
        (:goal
            (escaped player))
)
