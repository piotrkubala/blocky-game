(define (problem problem-experiment_6x6_6_150_20)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_21 entrance_34 down)
            (passage room_24 entrance_29 left)
            (passage room_25 entrance_41 up)
            (passage room_26 entrance_19 up)
            (passage room_26 entrance_20 right)
            (passage room_26 entrance_31 left)
            (passage room_26 entrance_32 down)
            (passage room_28 entrance_25 up)
            (passage room_29 entrance_21 left)
            (passage room_29 entrance_22 right)
