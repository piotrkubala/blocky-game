(define (problem problem-experiment_7x7_6_150_54)
    (:domain blocky-game)
        (:objects
            indigo - colour
            navy - colour
        ...
        (:init
            ...
            (contains room_18 key_yellow)
            (contains room_25 key_orange)
            (contains room_3 main_exit)
            (contains room_4 terminal)
            (contains room_42 key_indigo)
            (contains room_44 key_navy)
            ...
            (passage room_0 entrance_39 right)
            ...
            (passage room_11 entrance_15 up)
            (passage room_12 entrance_31 up)
            (passage room_12 entrance_32 left)
            (passage room_12 entrance_42 down)
            (passage room_14 entrance_28 right)
            (passage room_14 entrance_29 left)
            ...
            (passage room_19 entrance_20 left)
            ...
            (passage room_25 entrance_40 up)
            (passage room_3 entrance_43 right)
            (passage room_31 entrance_6 down)
            (passage room_31 entrance_7 up)
            (passage room_38 entrance_4 down)
            (passage room_38 entrance_5 up)
            (passage room_4 entrance_16 down)
            (passage room_4 entrance_23 left)
            (passage room_41 entrance_35 right)
            (passage room_41 entrance_36 down)
            (passage room_41 entrance_41 up)
            (passage room_42 entrance_30 right)
            (passage room_44 entrance_1 right)
            (passage room_45 entrance_2 left)
            (passage room_45 entrance_3 up)
            (passage room_6 entrance_37 up)
            (passage room_8 entrance_24 right)
            (passage room_8 entrance_25 left)
            (passage room_9 entrance_17 up)
            (passage room_9 entrance_18 down))
        (:goal
            (escaped player))
)
