(define (problem problem-experiment_6x6_9_150_26)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_11 key_magenta)
            (contains room_14 main_exit)
            (contains room_16 key_turquoise)
            (contains room_18 key_beige)
            (contains room_2 key_brown)
            (contains room_20 terminal)
            (contains room_24 key_purple)
            (contains room_28 key_cyan)
            (contains room_29 key_pink)
            (contains room_33 key_indigo)
            (free place35)
            ...
            (passage room_0 entrance_27 up)
            (passage room_0 entrance_45 down)
            (passage room_0 entrance_46 left)
            (passage room_1 entrance_24 down)
            (passage room_1 entrance_25 right)
            (passage room_10 entrance_33 up)
            (passage room_10 entrance_34 left)
            (passage room_11 entrance_26 left)
            (passage room_12 entrance_21 down)
            (passage room_12 entrance_22 left)
            (passage room_14 entrance_66 right)
            (passage room_15 entrance_51 right)
            (passage room_15 entrance_52 up)
            (passage room_15 entrance_61 left)
            (passage room_16 entrance_12 left)
            (passage room_16 entrance_56 right)
            (passage room_16 entrance_57 up)
            (passage room_18 entrance_54 left)
            (passage room_18 entrance_55 down)
            (passage room_2 entrance_35 right)
            (passage room_20 entrance_10 down)
            (passage room_20 entrance_11 right)
            (passage room_20 entrance_20 up)
            (passage room_20 entrance_28 left)
            (passage room_24 entrance_23 right)
            (passage room_25 entrance_6 down)
            (passage room_25 entrance_60 left)
            (passage room_25 entrance_7 right)
            (passage room_26 entrance_36 right)
            (passage room_26 entrance_8 left)
            (passage room_26 entrance_9 up)
            (passage room_27 entrance_17 up)
            (passage room_27 entrance_18 down)
            (passage room_28 entrance_53 down)
            (passage room_28 entrance_62 right)
            (passage room_28 entrance_63 left)
            (passage room_29 entrance_1 right)
            (passage room_3 entrance_39 right)
            (passage room_3 entrance_40 up)
            (passage room_30 entrance_2 left)
            (passage room_30 entrance_3 right)
            (passage room_31 entrance_30 right)
            (passage room_31 entrance_31 down)
            (passage room_31 entrance_4 left)
            (passage room_31 entrance_5 up)
            (passage room_33 entrance_19 up)
            (passage room_33 entrance_32 down)
            (passage room_34 entrance_41 down)
            (passage room_34 entrance_42 up)
            (passage room_4 entrance_37 right)
            (passage room_4 entrance_38 left)
            (passage room_5 entrance_15 left)
            (passage room_5 entrance_16 down)
            (passage room_5 entrance_29 right)
            (passage room_6 entrance_58 down)
            (passage room_6 entrance_59 up)
            (passage room_7 entrance_43 down)
            (passage room_7 entrance_44 up)
            (passage room_7 entrance_64 right)
            (passage room_7 entrance_65 left)
            (passage room_8 entrance_13 up)
            (passage room_8 entrance_14 right)
            (passage room_8 entrance_49 down)
            (passage room_8 entrance_50 left)
            (passage room_9 entrance_47 right)
            (passage room_9 entrance_48 up))
        (:goal
            (escaped player))
)
