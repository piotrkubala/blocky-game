(define (problem problem-experiment_6x6_7_150_1)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_13 entrance_23 left)
            ...
            (passage room_4 entrance_15 down)
            (passage room_4 entrance_16 left)
            (passage room_6 entrance_19 right)
            (passage room_7 entrance_2 right)
            (passage room_7 entrance_27 left)
