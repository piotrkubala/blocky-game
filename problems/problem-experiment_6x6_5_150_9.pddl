(define (problem problem-experiment_6x6_5_150_9)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_18 key_purple)
            (contains room_25 key_violet)
            ...
            (passage room_20 entrance_19 left)
            (passage room_22 entrance_13 down)
            (passage room_22 entrance_14 up)
            (passage room_22 entrance_35 right)
            (passage room_23 entrance_4 right)
            (passage room_23 entrance_5 down)
            (passage room_24 entrance_16 down)
            (passage room_24 entrance_2 right)
            (passage room_24 entrance_3 left)
            (passage room_25 entrance_1 left)
            (passage room_26 entrance_11 down)
            (passage room_26 entrance_12 up)
            (passage room_26 entrance_26 right)
            (passage room_27 entrance_10 up)
            (passage room_27 entrance_9 left)
            (passage room_29 entrance_23 left)
            (passage room_29 entrance_29 right)
            (passage room_29 entrance_6 up)
            (passage room_30 entrance_36 left)
            (passage room_32 entrance_17 up)
            (passage room_32 entrance_7 down)
            (passage room_32 entrance_8 right)
            (passage room_4 entrance_24 right)
            (passage room_4 entrance_25 left)
