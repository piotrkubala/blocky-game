(define (problem problem-experiment_6x6_6_150_29)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_10 entrance_27 right)
            ...
            (passage room_27 entrance_21 left)
            (passage room_27 entrance_22 down)
            (passage room_29 entrance_32 right)
            (passage room_29 entrance_33 left)
