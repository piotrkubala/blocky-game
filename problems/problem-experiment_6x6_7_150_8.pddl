(define (problem problem-experiment_6x6_7_150_8)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_10 entrance_43 right)
            (passage room_10 entrance_44 down)
            (passage room_12 entrance_39 up)
            (passage room_12 entrance_40 down)
            (passage room_14 entrance_12 down)
            ...
            (passage room_18 entrance_19 up)
            ...
            (passage room_28 entrance_42 left)
