(define (problem problem-experiment_6x6_6_150_28)
    (:domain blocky-game)
        (:objects
            black - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_1 entrance_39 up)
            (passage room_1 entrance_4 down)
            (passage room_1 entrance_5 left)
            (passage room_12 entrance_34 right)
            (passage room_13 entrance_1 up)
            (passage room_15 entrance_46 down)
            (passage room_16 entrance_21 left)
            (passage room_17 entrance_40 down)
            (passage room_17 entrance_41 left)
            (passage room_18 entrance_13 left)
            (passage room_18 entrance_14 down)
            (passage room_19 entrance_10 down)
            (passage room_19 entrance_35 left)
            (passage room_19 entrance_36 right)
            (passage room_19 entrance_9 up)
            (passage room_2 entrance_42 right)
            (passage room_2 entrance_43 up)
            (passage room_20 entrance_17 left)
            (passage room_20 entrance_18 down)
            (passage room_22 entrance_19 up)
            (passage room_22 entrance_20 right)
            (passage room_23 entrance_47 right)
            (passage room_25 entrance_24 left)
            ...
            (passage room_28 entrance_45 up)
            (passage room_30 entrance_26 left)
            (passage room_30 entrance_27 right)
            (passage room_30 entrance_31 up)
            (passage room_32 entrance_15 up)
            (passage room_32 entrance_16 right)
            ...
            (passage room_5 entrance_7 left)
            (passage room_5 entrance_8 down)
