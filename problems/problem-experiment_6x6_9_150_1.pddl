(define (problem problem-experiment_6x6_9_150_1)
    (:domain blocky-game)
        (:objects
            brown - colour
            grey - colour
        ...
        (:init
            ...
            (passage room_19 entrance_2 right)
            (passage room_19 entrance_3 up)
            (passage room_2 entrance_11 left)
            (passage room_2 entrance_12 down)
            (passage room_20 entrance_1 left)
            (passage room_21 entrance_32 right)
            (passage room_21 entrance_33 left)
            (passage room_22 entrance_25 up)
            (passage room_22 entrance_26 down)
            (passage room_23 entrance_34 right)
            (passage room_28 entrance_15 up)
            (passage room_28 entrance_16 right)
            (passage room_29 entrance_23 left)
            (passage room_29 entrance_43 right)
            (passage room_29 entrance_44 down)
            (passage room_3 entrance_27 up)
            (passage room_30 entrance_18 up)
            (passage room_30 entrance_19 right)
            (passage room_30 entrance_31 left)
            (passage room_33 entrance_41 right)
