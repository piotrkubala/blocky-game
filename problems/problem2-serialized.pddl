(define (problem problem2-serialized)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_18 entrance_20 right)
            (passage room_18 entrance_21 down)
            (passage room_19 entrance_22 up)
            (passage room_19 entrance_23 left)
            (passage room_2 entrance_7 up)
            ...
            (passage room_29 entrance_30 up)
