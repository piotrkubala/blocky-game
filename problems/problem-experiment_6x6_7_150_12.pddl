(define (problem problem-experiment_6x6_7_150_12)
    (:domain blocky-game)
        (:objects
            gold - colour
            green - colour
        ...
        (:init
            ...
            (passage room_18 entrance_18 up)
            ...
            (passage room_28 entrance_13 up)
            (passage room_28 entrance_24 down)
            (passage room_28 entrance_32 right)
            (passage room_29 entrance_15 right)
            (passage room_29 entrance_16 up)
            (passage room_29 entrance_36 left)
            (passage room_3 entrance_35 left)
