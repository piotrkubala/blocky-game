(define (problem problem-experiment_6x6_6_150_6)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (contains room_21 key_indigo)
            (contains room_24 key_cyan)
            (contains room_29 key_purple)
            ...
            (passage room_11 entrance_11 up)
            (passage room_11 entrance_12 right)
            (passage room_12 entrance_26 left)
            ...
            (passage room_19 entrance_22 up)
            (passage room_20 entrance_39 down)
            (passage room_21 entrance_1 down)
            (passage room_23 entrance_35 right)
            (passage room_23 entrance_36 up)
            (passage room_24 entrance_32 up)
            (passage room_24 entrance_9 down)
            (passage room_27 entrance_2 up)
            (passage room_27 entrance_3 down)
            ...
            (passage room_3 entrance_37 up)
            (passage room_31 entrance_16 left)
            (passage room_31 entrance_17 down)
            (passage room_31 entrance_25 right)
            (passage room_31 entrance_38 up)
            (passage room_32 entrance_13 left)
            (passage room_32 entrance_4 up)
            (passage room_32 entrance_5 right)
            (passage room_32 entrance_8 down)
            ...
            (passage room_4 entrance_29 right)
