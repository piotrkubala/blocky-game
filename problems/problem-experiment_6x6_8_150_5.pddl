(define (problem problem-experiment_6x6_8_150_5)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (contains room_26 key_violet)
            (contains room_29 key_green)
            (contains room_30 key_brown)
            (contains room_5 terminal)
            (contains room_9 key_beige)
            (free place14)
            ...
            (passage room_12 entrance_51 down)
            (passage room_12 entrance_52 up)
            (passage room_14 entrance_1 up)
            (passage room_15 entrance_24 up)
            (passage room_15 entrance_25 down)
            (passage room_15 entrance_37 left)
            (passage room_16 entrance_54 down)
            (passage room_16 entrance_55 up)
            (passage room_18 entrance_15 up)
            (passage room_18 entrance_16 down)
            (passage room_19 entrance_31 up)
            (passage room_19 entrance_32 left)
            (passage room_19 entrance_47 right)
            ...
            (passage room_25 entrance_18 down)
            (passage room_26 entrance_21 right)
            (passage room_27 entrance_19 up)
            (passage room_27 entrance_20 left)
            ...
            (passage room_3 entrance_23 down)
            (passage room_30 entrance_40 right)
            (passage room_30 entrance_42 left)
            (passage room_32 entrance_33 right)
            (passage room_32 entrance_34 left)
            (passage room_33 entrance_26 up)
            (passage room_33 entrance_27 down)
            (passage room_33 entrance_46 left)
            (passage room_34 entrance_38 right)
            (passage room_34 entrance_39 left)
            (passage room_5 entrance_36 up)
            (passage room_5 entrance_41 left)
            (passage room_5 entrance_8 right)
            (passage room_5 entrance_9 down)
            (passage room_6 entrance_48 up)
            (passage room_6 entrance_6 right)
            (passage room_6 entrance_7 left)
            (passage room_7 entrance_10 up)
            (passage room_7 entrance_4 right)
            (passage room_7 entrance_5 left)
            (passage room_8 entrance_11 right)
            (passage room_8 entrance_2 down)
            (passage room_8 entrance_3 left)
