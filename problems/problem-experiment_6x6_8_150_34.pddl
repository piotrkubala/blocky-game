(define (problem problem-experiment_6x6_8_150_34)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_12 entrance_13 up)
            ...
            (passage room_18 entrance_11 up)
