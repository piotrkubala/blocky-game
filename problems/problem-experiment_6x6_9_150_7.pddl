(define (problem problem-experiment_6x6_9_150_7)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_13 entrance_46 up)
            (passage room_14 entrance_36 left)
            ...
            (passage room_19 entrance_27 up)
            (passage room_2 entrance_17 left)
            ...
            (passage room_29 entrance_16 right)
            (passage room_3 entrance_10 up)
            (passage room_3 entrance_11 down)
            (passage room_30 entrance_40 down)
            ...
            (passage room_33 entrance_24 right)
            (passage room_33 entrance_42 down)
            (passage room_34 entrance_14 left)
            (passage room_34 entrance_43 right)
