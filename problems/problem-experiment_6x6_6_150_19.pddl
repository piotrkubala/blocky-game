(define (problem problem-experiment_6x6_6_150_19)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_12 key_beige)
            (contains room_14 key_indigo)
            (contains room_17 key_red)
            (contains room_25 key_pink)
            ...
            (passage room_16 entrance_15 up)
            (passage room_16 entrance_16 down)
            (passage room_17 entrance_12 up)
            (passage room_20 entrance_8 up)
            (passage room_20 entrance_9 down)
            (passage room_21 entrance_31 up)
            (passage room_21 entrance_32 left)
            ...
            (passage room_23 entrance_28 down)
            ...
            (passage room_28 entrance_34 left)
            (passage room_29 entrance_42 up)
            (passage room_29 entrance_43 left)
            (passage room_3 entrance_2 right)
            (passage room_3 entrance_3 down)
            (passage room_31 entrance_47 down)
            (passage room_32 entrance_23 right)
            (passage room_32 entrance_24 up)
            ...
            (passage room_5 entrance_30 down)
            (passage room_7 entrance_41 up)
            (passage room_8 entrance_13 left)
            (passage room_8 entrance_45 up)
            (passage room_8 entrance_6 right)
            (passage room_8 entrance_7 down)
            (passage room_9 entrance_22 down)
            (passage room_9 entrance_4 up)
            (passage room_9 entrance_5 left))
        (:goal
            (escaped player))
)
