(define (problem problem-experiment_6x6_7_150_9)
    (:domain blocky-game)
        (:objects
            blue - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_14 entrance_24 up)
            ...
            (passage room_22 entrance_9 left)
            ...
            (passage room_25 entrance_39 down)
            (passage room_25 entrance_6 left)
            (passage room_25 entrance_7 up)
            (passage room_26 entrance_40 up)
