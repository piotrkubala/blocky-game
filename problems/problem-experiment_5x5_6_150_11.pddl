(define (problem problem-experiment_5x5_6_150_11)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_1 entrance_14 left)
            ...
            (passage room_17 entrance_10 up)
