(define (problem problem-experiment_6x6_5_150_25)
    (:domain blocky-game)
        (:objects
            grey - colour
            indigo - colour
        ...
        (:init
            ...
            (contains room_32 key_orange)
            (contains room_4 key_indigo)
            ...
            (passage room_1 entrance_40 down)
            (passage room_1 entrance_41 left)
            (passage room_10 entrance_42 right)
            (passage room_11 entrance_23 down)
            (passage room_11 entrance_24 up)
            (passage room_13 entrance_38 down)
            (passage room_13 entrance_39 up)
            (passage room_14 entrance_32 left)
            ...
            (passage room_26 entrance_10 up)
            ...
            (passage room_30 entrance_18 left)
            (passage room_31 entrance_12 right)
            (passage room_31 entrance_13 left)
            (passage room_31 entrance_36 down)
            (passage room_31 entrance_37 up)
            (passage room_32 entrance_19 right)
            (passage room_33 entrance_21 left)
            (passage room_33 entrance_22 up)
