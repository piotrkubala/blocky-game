(define (problem problem-experiment_6x6_8_150_2)
    (:domain blocky-game)
        ...
        (:init
            ...
            (contains room_20 key_red)
            (contains room_27 key_green)
            ...
            (passage room_10 entrance_31 right)
            (passage room_10 entrance_32 down)
            (passage room_11 entrance_39 left)
            (passage room_12 entrance_24 left)
            (passage room_12 entrance_28 down)
            (passage room_12 entrance_43 up)
            (passage room_12 entrance_6 right)
            (passage room_13 entrance_4 right)
            (passage room_13 entrance_48 up)
            (passage room_13 entrance_49 down)
            (passage room_13 entrance_5 left)
            (passage room_14 entrance_2 right)
            (passage room_14 entrance_3 left)
            (passage room_14 entrance_38 up)
            (passage room_15 entrance_1 left)
            (passage room_16 entrance_51 up)
            (passage room_17 entrance_42 right)
            (passage room_18 entrance_36 up)
            (passage room_18 entrance_37 down)
            (passage room_18 entrance_7 left)
            (passage room_18 entrance_8 right)
            (passage room_20 entrance_35 up)
            (passage room_20 entrance_50 down)
            (passage room_22 entrance_21 down)
            (passage room_22 entrance_22 up)
            (passage room_24 entrance_11 left)
            (passage room_24 entrance_12 up)
            (passage room_25 entrance_10 right)
            (passage room_25 entrance_9 left)
            (passage room_27 entrance_23 down)
            (passage room_27 entrance_40 up)
            (passage room_27 entrance_41 left)
            (passage room_28 entrance_44 down)
            (passage room_29 entrance_45 up)
            (passage room_29 entrance_46 left)
            (passage room_30 entrance_25 right)
            (passage room_30 entrance_26 up)
            (passage room_31 entrance_15 left)
            (passage room_31 entrance_16 up)
            (passage room_32 entrance_13 down)
            (passage room_32 entrance_14 right)
            (passage room_33 entrance_17 down)
            (passage room_33 entrance_18 up)
            (passage room_34 entrance_19 down)
            (passage room_34 entrance_20 up)
            (passage room_34 entrance_30 left)
            (passage room_34 entrance_47 right)
            (passage room_4 entrance_33 up)
            (passage room_4 entrance_34 down)
