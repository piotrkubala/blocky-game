(define (problem problem-experiment_6x6_8_150_2)
    (:domain blocky-game)
        (:objects
            beige - colour
            grey - colour
        ...
        (:init
            ...
            (passage room_1 entrance_53 right)
            (passage room_10 entrance_50 up)
            (passage room_10 entrance_51 down)
            (passage room_11 entrance_45 down)
            (passage room_11 entrance_46 up)
            (passage room_12 entrance_1 down)
            (passage room_14 entrance_56 up)
            (passage room_15 entrance_42 down)
            (passage room_15 entrance_43 up)
            ...
            (passage room_2 entrance_24 down)
            (passage room_20 entrance_18 down)
            (passage room_20 entrance_19 up)
            (passage room_20 entrance_6 left)
            (passage room_20 entrance_7 right)
            (passage room_21 entrance_8 left)
            (passage room_21 entrance_9 right)
            (passage room_22 entrance_10 left)
            (passage room_22 entrance_11 down)
            (passage room_26 entrance_35 up)
            (passage room_27 entrance_12 up)
            (passage room_27 entrance_13 down)
            (passage room_27 entrance_39 left)
            (passage room_28 entrance_30 left)
            (passage room_28 entrance_31 right)
            (passage room_30 entrance_16 right)
            (passage room_30 entrance_17 up)
            (passage room_31 entrance_33 right)
            (passage room_31 entrance_34 down)
            (passage room_32 entrance_32 left)
            (passage room_33 entrance_14 up)
            (passage room_33 entrance_15 left)
            (passage room_33 entrance_25 down)
            (passage room_33 entrance_36 right)
            (passage room_34 entrance_26 up)
            (passage room_34 entrance_27 right)
            (passage room_4 entrance_38 down)
            (passage room_5 entrance_28 left)
            (passage room_5 entrance_29 right)
            (passage room_6 entrance_47 down)
            (passage room_6 entrance_48 right)
            (passage room_7 entrance_20 down)
            (passage room_7 entrance_21 up)
            (passage room_8 entrance_22 down)
            (passage room_8 entrance_23 up)
            (passage room_8 entrance_54 left)
            (passage room_9 entrance_37 left)
            (passage room_9 entrance_40 right)
            (passage room_9 entrance_41 up)
            (passage room_9 entrance_55 down))
        (:goal
            (escaped player))
)
