(define (problem problem-experiment_6x6_9_150_23)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_0 entrance_29 down)
            (passage room_0 entrance_30 left)
            (passage room_1 entrance_31 right)
            (passage room_1 entrance_32 up)
            (passage room_1 entrance_44 left)
            (passage room_10 entrance_1 left)
            (passage room_12 entrance_36 right)
            (passage room_13 entrance_12 down)
            (passage room_13 entrance_13 up)
            (passage room_15 entrance_4 up)
            (passage room_15 entrance_5 down)
            (passage room_16 entrance_37 up)
            (passage room_17 entrance_39 up)
            (passage room_19 entrance_10 right)
            (passage room_19 entrance_11 up)
            (passage room_19 entrance_22 left)
            (passage room_20 entrance_17 down)
            (passage room_20 entrance_24 up)
            (passage room_20 entrance_8 right)
            (passage room_20 entrance_9 left)
            ...
            (passage room_26 entrance_27 right)
            (passage room_26 entrance_28 up)
            (passage room_28 entrance_20 right)
            (passage room_28 entrance_21 left)
            (passage room_29 entrance_40 left)
            (passage room_30 entrance_23 right)
            (passage room_32 entrance_35 down)
            (passage room_33 entrance_18 up)
            (passage room_33 entrance_19 left)
            (passage room_33 entrance_43 right)
            (passage room_4 entrance_38 up)
            (passage room_4 entrance_41 left)
            (passage room_4 entrance_42 right)
            (passage room_5 entrance_16 down)
            (passage room_6 entrance_33 down)
            (passage room_6 entrance_34 up)
            (passage room_7 entrance_14 down)
            (passage room_7 entrance_15 up)
