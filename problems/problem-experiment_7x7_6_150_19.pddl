(define (problem problem-experiment_7x7_6_150_19)
    (:domain blocky-game)
        (:objects
            beige - colour
            navy - colour
        ...
        (:init
            ...
            (contains room_22 key_white)
            (contains room_28 key_navy)
            (contains room_36 key_yellow)
            ...
            (passage room_12 entrance_4 up)
            (passage room_12 entrance_5 left)
            (passage room_15 entrance_14 up)
            (passage room_15 entrance_15 right)
            (passage room_15 entrance_23 down)
            (passage room_15 entrance_31 left)
            (passage room_16 entrance_16 left)
            (passage room_16 entrance_17 down)
            (passage room_2 entrance_39 up)
            (passage room_2 entrance_40 down)
            (passage room_21 entrance_28 right)
            (passage room_22 entrance_34 down)
            (passage room_23 entrance_18 up)
            (passage room_23 entrance_19 down)
            (passage room_23 entrance_29 left)
            (passage room_24 entrance_20 up)
            (passage room_24 entrance_21 down)
            (passage room_27 entrance_32 right)
            (passage room_27 entrance_33 up)
            (passage room_28 entrance_38 up)
            (passage room_29 entrance_26 right)
            (passage room_29 entrance_27 left)
            (passage room_35 entrance_24 up)
            (passage room_35 entrance_25 left)
            (passage room_36 entrance_22 up)
            (passage room_40 entrance_43 up)
            (passage room_41 entrance_36 right)
            (passage room_41 entrance_37 down)
            (passage room_43 entrance_30 up)
            (passage room_43 entrance_35 left)
            (passage room_44 entrance_41 up)
            (passage room_44 entrance_42 down)
            (passage room_5 entrance_2 right)
            (passage room_5 entrance_3 down)
            (passage room_6 entrance_1 left)
