(define (problem problem-experiment_5x5_6_150_5)
    (:domain blocky-game)
        (:objects
            gold - colour
            indigo - colour
        ...
        (:init
            ...
            (passage room_1 entrance_11 left)
            ...
            (passage room_12 entrance_23 right)
