(define (problem problem-experiment_7x7_6_150_31)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (contains room_43 key_cyan)
            (contains room_44 main_exit)
            (contains room_45 key_black)
            (free place72)
            ...
            (passage room_1 entrance_18 down)
            (passage room_12 entrance_23 up)
