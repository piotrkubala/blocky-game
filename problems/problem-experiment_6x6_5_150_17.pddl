(define (problem problem-experiment_6x6_5_150_17)
    (:domain blocky-game)
        (:objects
            cyan - colour
            navy - colour
        ...
        (:init
            ...
            (passage room_15 entrance_26 right)
            (passage room_16 entrance_10 up)
            ...
            (passage room_22 entrance_24 left)
            (passage room_24 entrance_30 left)
            (passage room_24 entrance_31 right)
            (passage room_29 entrance_34 down)
            (passage room_3 entrance_8 up)
            ...
            (passage room_5 entrance_32 left)
