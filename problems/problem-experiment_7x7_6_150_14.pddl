(define (problem problem-experiment_7x7_6_150_14)
    (:domain blocky-game)
        (:objects
            blue - colour
            gold - colour
        ...
        (:init
            ...
            (contains room_19 main_exit)
            (contains room_21 key_purple)
            (contains room_26 key_grey)
            (contains room_35 terminal)
            (contains room_39 key_yellow)
            (contains room_5 key_white)
            (free place41)
            ...
            (passage room_1 entrance_45 down)
            (passage room_10 entrance_20 left)
            (passage room_10 entrance_21 up)
            (passage room_10 entrance_27 down)
            (passage room_12 entrance_40 left)
            (passage room_12 entrance_41 down)
            (passage room_15 entrance_51 down)
            (passage room_15 entrance_52 up)
            (passage room_16 entrance_18 down)
            (passage room_16 entrance_19 right)
            (passage room_18 entrance_53 down)
            (passage room_19 entrance_55 down)
            (passage room_21 entrance_30 left)
            (passage room_21 entrance_49 down)
            (passage room_21 entrance_50 up)
            (passage room_22 entrance_16 down)
            (passage room_22 entrance_17 up)
            (passage room_23 entrance_32 up)
            (passage room_23 entrance_33 down)
            (passage room_24 entrance_38 left)
            (passage room_24 entrance_39 right)
            (passage room_25 entrance_47 left)
            (passage room_25 entrance_48 up)
            (passage room_25 entrance_54 down)
            (passage room_26 entrance_42 up)
            ...
            (passage room_29 entrance_15 up)
            (passage room_29 entrance_31 down)
            (passage room_35 entrance_8 right)
            (passage room_35 entrance_9 up)
            (passage room_36 entrance_6 right)
            (passage room_36 entrance_7 left)
            (passage room_37 entrance_4 right)
            (passage room_37 entrance_5 left)
            (passage room_38 entrance_2 right)
            (passage room_38 entrance_3 left)
            (passage room_39 entrance_1 left)
            (passage room_42 entrance_34 up)
            (passage room_42 entrance_35 right)
            (passage room_44 entrance_10 down)
            (passage room_44 entrance_11 right)
            (passage room_45 entrance_28 up)
            (passage room_45 entrance_29 right)
            (passage room_46 entrance_36 left)
            (passage room_46 entrance_37 right)
            (passage room_5 entrance_24 down)
            (passage room_8 entrance_25 left)
            (passage room_8 entrance_26 right)
            (passage room_8 entrance_43 down)
            (passage room_8 entrance_44 up)
            (passage room_9 entrance_22 down)
            (passage room_9 entrance_23 up))
        (:goal
            (escaped player))
)
