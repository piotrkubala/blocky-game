(define (problem problem-experiment_6x6_9_150_37)
    (:domain blocky-game)
        (:objects
            green - colour
            indigo - colour
        ...
        (:init
            ...
            (contains room_13 key_red)
            (contains room_14 key_indigo)
            (contains room_18 key_green)
            (contains room_19 key_turquoise)
            (contains room_28 terminal)
            (contains room_30 key_magenta)
            (contains room_31 key_purple)
            (contains room_32 key_yellow)
            ...
            (passage room_11 entrance_30 right)
            (passage room_12 entrance_22 right)
            (passage room_12 entrance_23 down)
            ...
            (passage room_15 entrance_36 down)
            ...
            (passage room_2 entrance_37 up)
            (passage room_2 entrance_38 left)
            (passage room_20 entrance_12 right)
            (passage room_20 entrance_13 left)
            (passage room_20 entrance_32 up)
            (passage room_21 entrance_6 up)
            (passage room_21 entrance_7 right)
            (passage room_22 entrance_8 left)
            (passage room_22 entrance_9 down)
            (passage room_24 entrance_24 up)
            (passage room_24 entrance_25 left)
            (passage room_25 entrance_20 right)
            (passage room_25 entrance_21 left)
            (passage room_25 entrance_43 up)
            (passage room_25 entrance_50 down)
            (passage room_26 entrance_16 up)
            (passage room_26 entrance_17 down)
            (passage room_26 entrance_44 right)
            (passage room_28 entrance_10 up)
            (passage room_28 entrance_11 left)
            (passage room_28 entrance_31 down)
            (passage room_28 entrance_47 right)
            (passage room_29 entrance_18 up)
            (passage room_29 entrance_19 left)
            (passage room_3 entrance_27 down)
            (passage room_3 entrance_28 left)
            (passage room_30 entrance_39 right)
            (passage room_31 entrance_42 up)
            (passage room_31 entrance_45 down)
            (passage room_32 entrance_46 up)
            (passage room_34 entrance_34 up)
            (passage room_34 entrance_35 left)
            (passage room_4 entrance_51 up)
            (passage room_5 entrance_48 left)
            (passage room_5 entrance_49 right)
            (passage room_8 entrance_33 right)
            (passage room_9 entrance_14 right)
