(define (problem problem-experiment_6x6_6_150_21)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_14 entrance_25 down)
