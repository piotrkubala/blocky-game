(define (problem problem-experiment_6x6_6_150_40)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_12 entrance_14 right)
            ...
            (passage room_18 entrance_25 up)
            (passage room_19 entrance_26 up)
            (passage room_19 entrance_33 left)
            (passage room_19 entrance_34 right)
            (passage room_2 entrance_35 left)
            ...
            (passage room_25 entrance_29 left)
            (passage room_25 entrance_30 right)
            (passage room_26 entrance_1 up)
            (passage room_29 entrance_31 left)
            ...
            (passage room_6 entrance_12 right)
            (passage room_6 entrance_22 down)
            (passage room_6 entrance_27 up)
            ...
            (passage room_9 entrance_6 down)
