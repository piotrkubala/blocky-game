(define (problem problem-experiment_7x7_6_150_53)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_11 entrance_42 left)
            (passage room_16 entrance_27 down)
            (passage room_16 entrance_28 up)
            (passage room_16 entrance_32 right)
            (passage room_17 entrance_8 up)
            (passage room_17 entrance_9 right)
            (passage room_18 entrance_10 left)
            (passage room_18 entrance_11 down)
            (passage room_21 entrance_22 right)
            ...
            (passage room_26 entrance_14 left)
            ...
            (passage room_32 entrance_25 down)
            (passage room_32 entrance_26 up)
            (passage room_33 entrance_16 up)
            (passage room_33 entrance_17 left)
            (passage room_33 entrance_34 down)
            (passage room_33 entrance_39 right)
            (passage room_34 entrance_38 left)
            (passage room_37 entrance_20 right)
            (passage room_37 entrance_21 left)
            (passage room_44 entrance_23 right)
            (passage room_44 entrance_24 up)
            (passage room_5 entrance_29 down)
            (passage room_5 entrance_30 up)
            (passage room_5 entrance_40 left)
            (passage room_5 entrance_41 right)
            (passage room_7 entrance_1 right)
            (passage room_8 entrance_2 left)
