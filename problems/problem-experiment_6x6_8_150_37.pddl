(define (problem problem-experiment_6x6_8_150_37)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_1 entrance_44 right)
            (passage room_10 entrance_35 right)
            (passage room_11 entrance_13 down)
            (passage room_13 entrance_26 up)
            (passage room_14 entrance_4 down)
            (passage room_14 entrance_5 up)
            (passage room_16 entrance_16 up)
            (passage room_16 entrance_17 down)
            (passage room_17 entrance_46 down)
            (passage room_18 entrance_43 up)
            (passage room_19 entrance_1 right)
            (passage room_2 entrance_29 right)
            (passage room_2 entrance_30 down)
            (passage room_20 entrance_2 left)
            ...
            (passage room_4 entrance_39 right)
            ...
            (passage room_7 entrance_33 right)
            (passage room_7 entrance_34 left)
            (passage room_8 entrance_12 up)
            (passage room_8 entrance_6 down)
            (passage room_8 entrance_7 right)
            (passage room_9 entrance_31 down)
