(define (problem problem-experiment_6x6_6_150_2)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_19 entrance_20 up)
            (passage room_19 entrance_21 down)
            (passage room_2 entrance_14 down)
            (passage room_2 entrance_15 right)
            (passage room_2 entrance_23 up)
            ...
            (passage room_29 entrance_33 up)
            (passage room_29 entrance_44 left)
            ...
            (passage room_6 entrance_31 up)
            (passage room_6 entrance_32 down)
            (passage room_7 entrance_18 up)
