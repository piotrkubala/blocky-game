(define (problem problem-experiment_7x7_6_150_28)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_40 key_red)
            (contains room_46 main_exit)
            ...
            (passage room_0 entrance_10 down)
            (passage room_0 entrance_11 up)
            (passage room_0 entrance_45 left)
            (passage room_0 entrance_46 right)
            (passage room_1 entrance_12 down)
            (passage room_1 entrance_13 right)
            (passage room_11 entrance_22 left)
            (passage room_13 entrance_44 left)
            (passage room_14 entrance_47 left)
            (passage room_14 entrance_48 up)
            (passage room_17 entrance_51 left)
            (passage room_17 entrance_52 up)
            (passage room_18 entrance_34 left)
            (passage room_18 entrance_35 right)
            ...
            (passage room_34 entrance_36 left)
            (passage room_34 entrance_37 up)
            (passage room_35 entrance_42 left)
            (passage room_35 entrance_43 right)
            (passage room_38 entrance_25 down)
            (passage room_38 entrance_26 up)
            (passage room_39 entrance_32 left)
            (passage room_39 entrance_33 right)
            (passage room_4 entrance_29 down)
            (passage room_40 entrance_40 left)
            (passage room_41 entrance_49 down)
            (passage room_41 entrance_50 right)
            (passage room_46 entrance_56 left)
            (passage room_47 entrance_54 left)
            (passage room_47 entrance_55 right)
            (passage room_5 entrance_20 left)
            (passage room_5 entrance_21 right)
            (passage room_6 entrance_8 down)
            (passage room_6 entrance_9 up)
            (passage room_7 entrance_14 left)
            (passage room_7 entrance_15 right)
            (passage room_7 entrance_27 down)
            (passage room_7 entrance_28 up)
            (passage room_8 entrance_53 down)
            (passage room_9 entrance_18 left)
            (passage room_9 entrance_19 right))
        (:goal
            (escaped player))
)
