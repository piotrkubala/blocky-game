(define (problem problem-experiment_6x6_7_150_22)
    (:domain blocky-game)
        (:objects
            brown - colour
            gold - colour
        ...
        (:init
            ...
            (is key_pink pink)
            (passage room_0 entrance_15 right)
            (passage room_0 entrance_16 up)
            ...
            (passage room_33 entrance_24 down)
            ...
            (passage room_9 entrance_32 down))
        (:goal
            (escaped player))
)
