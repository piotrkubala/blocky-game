(define (problem problem-experiment_6x6_5_150_7)
    (:domain blocky-game)
        (:objects
            brown - colour
            gold - colour
        ...
        (:init
            ...
            (is key_white white)
            (passage room_0 entrance_43 right)
            (passage room_0 entrance_44 left)
            (passage room_1 entrance_4 down)
            (passage room_1 entrance_40 up)
            (passage room_1 entrance_5 right)
            (passage room_10 entrance_18 left)
            (passage room_10 entrance_19 down)
            (passage room_11 entrance_14 left)
            (passage room_11 entrance_15 right)
            (passage room_13 entrance_33 right)
            (passage room_13 entrance_34 down)
            (passage room_15 entrance_20 up)
            (passage room_15 entrance_21 right)
            (passage room_18 entrance_38 right)
            (passage room_19 entrance_45 right)
            (passage room_19 entrance_46 left)
            (passage room_2 entrance_6 left)
            (passage room_2 entrance_7 right)
            (passage room_21 entrance_30 up)
            (passage room_21 entrance_31 down)
            (passage room_22 entrance_16 left)
            (passage room_22 entrance_17 right)
            (passage room_25 entrance_36 right)
            (passage room_25 entrance_37 left)
            (passage room_27 entrance_41 down)
            (passage room_27 entrance_42 left)
            (passage room_28 entrance_22 left)
            (passage room_28 entrance_23 down)
            (passage room_29 entrance_35 up)
            (passage room_3 entrance_28 up)
            (passage room_3 entrance_29 down)
            (passage room_3 entrance_8 left)
            (passage room_3 entrance_9 right)
            (passage room_30 entrance_32 up)
            (passage room_31 entrance_47 right)
            (passage room_32 entrance_26 up)
            (passage room_33 entrance_24 up)
            (passage room_33 entrance_25 down)
            (passage room_4 entrance_10 left)
            (passage room_4 entrance_11 right)
            (passage room_5 entrance_12 left)
            (passage room_5 entrance_13 right)
            (passage room_5 entrance_27 down)
            (passage room_5 entrance_39 up)
            (passage room_6 entrance_1 right)
            (passage room_7 entrance_2 left)
            (passage room_7 entrance_3 up))
        (:goal
            (escaped player))
)
