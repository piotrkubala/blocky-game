(define (problem problem-experiment_6x6_9_150_4)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_0 entrance_17 down)
            (passage room_0 entrance_46 up)
            (passage room_1 entrance_29 right)
            (passage room_11 entrance_37 down)
            (passage room_11 entrance_38 right)
            (passage room_11 entrance_51 left)
            (passage room_12 entrance_49 up)
            (passage room_12 entrance_50 left)
            (passage room_14 entrance_32 up)
            (passage room_14 entrance_33 down)
            (passage room_15 entrance_22 up)
            (passage room_15 entrance_23 left)
            (passage room_16 entrance_52 right)
            (passage room_16 entrance_53 left)
            (passage room_17 entrance_56 right)
            (passage room_19 entrance_36 left)
            (passage room_20 entrance_26 right)
            (passage room_22 entrance_39 left)
            (passage room_22 entrance_40 right)
            (passage room_23 entrance_1 right)
            (passage room_24 entrance_2 left)
            (passage room_24 entrance_28 down)
            (passage room_24 entrance_3 right)
            (passage room_25 entrance_4 left)
            (passage room_25 entrance_5 right)
            (passage room_26 entrance_6 left)
            (passage room_26 entrance_7 right)
            (passage room_27 entrance_8 left)
            (passage room_27 entrance_9 right)
            (passage room_28 entrance_10 left)
            (passage room_28 entrance_11 up)
            (passage room_28 entrance_30 down)
            (passage room_28 entrance_44 right)
            (passage room_29 entrance_31 up)
            (passage room_3 entrance_15 down)
            (passage room_33 entrance_20 up)
            (passage room_33 entrance_21 down)
            (passage room_34 entrance_34 up)
            (passage room_34 entrance_35 right)
            (passage room_4 entrance_14 right)
            (passage room_4 entrance_18 up)
            (passage room_4 entrance_19 down)
            (passage room_4 entrance_54 left)
            (passage room_5 entrance_12 down)
            (passage room_5 entrance_13 left)
            (passage room_5 entrance_27 up)
            (passage room_6 entrance_43 left)
            (passage room_6 entrance_55 right)
            (passage room_7 entrance_41 left)
            (passage room_7 entrance_42 right)
            (passage room_8 entrance_24 right)
            (passage room_8 entrance_25 left)
            (passage room_9 entrance_45 left)
            (passage room_9 entrance_47 up)
            (passage room_9 entrance_48 down))
        (:goal
            (escaped player))
)
