(define (problem problem-experiment_6x6_5_150_1)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_25 entrance_14 left)
            (passage room_25 entrance_15 right)
            (passage room_26 entrance_16 left)
            (passage room_26 entrance_17 right)
