(define (problem problem-experiment_6x6_7_150_30)
    (:domain blocky-game)
        (:objects
            cyan - colour
            green - colour
        ...
        (:init
            ...
            (passage room_18 entrance_6 left)
            ...
            (passage room_20 entrance_15 down)
            (passage room_20 entrance_16 up)
            (passage room_21 entrance_12 left)
            (passage room_21 entrance_23 right)
            (passage room_21 entrance_35 down)
            (passage room_21 entrance_38 up)
            ...
            (passage room_6 entrance_33 up)
            (passage room_8 entrance_30 left)
            (passage room_8 entrance_31 up))
        (:goal
            (escaped player))
)
