(define (problem problem-experiment_7x7_6_150_27)
    (:domain blocky-game)
        (:objects
            black - colour
            grey - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_1 key_purple)
            (contains room_20 terminal)
            (contains room_23 key_indigo)
            (contains room_31 key_magenta)
            (contains room_32 key_grey)
            (contains room_38 key_turquoise)
            (contains room_43 main_exit)
            (contains room_8 key_black)
            (free place73)
            ...
            (has_door entrance_56 purple)
            (has_door entrance_57 magenta)
            (has_door entrance_58 purple)
            ...
            (has_door entrance_65 purple)
            (has_door entrance_66 purple)
            (has_door entrance_67 turquoise)
            (has_door entrance_68 grey)
            ...
            (passage room_0 entrance_47 right)
            (passage room_0 entrance_48 left)
            (passage room_1 entrance_49 right)
            (passage room_10 entrance_50 up)
            (passage room_10 entrance_51 down)
            (passage room_12 entrance_33 right)
            (passage room_12 entrance_34 up)
            (passage room_13 entrance_52 up)
            (passage room_13 entrance_53 down)
            (passage room_16 entrance_4 up)
            (passage room_16 entrance_5 right)
            (passage room_17 entrance_35 down)
            (passage room_17 entrance_6 left)
            (passage room_17 entrance_7 right)
            (passage room_18 entrance_8 left)
            (passage room_18 entrance_9 right)
            (passage room_19 entrance_10 left)
            (passage room_19 entrance_11 right)
            (passage room_20 entrance_12 left)
            (passage room_20 entrance_13 down)
            (passage room_21 entrance_64 right)
            (passage room_21 entrance_65 left)
            (passage room_22 entrance_40 right)
            (passage room_22 entrance_41 left)
            (passage room_23 entrance_42 right)
            (passage room_25 entrance_43 right)
            (passage room_25 entrance_44 up)
            (passage room_25 entrance_59 down)
            (passage room_26 entrance_14 up)
            (passage room_26 entrance_15 left)
            (passage room_26 entrance_21 right)
            (passage room_27 entrance_26 up)
            (passage room_27 entrance_27 left)
            (passage room_3 entrance_45 down)
            (passage room_3 entrance_46 left)
            (passage room_31 entrance_18 up)
            (passage room_31 entrance_22 right)
            (passage room_31 entrance_23 down)
            (passage room_32 entrance_56 up)
            (passage room_33 entrance_16 right)
            (passage room_33 entrance_17 down)
            (passage room_33 entrance_57 up)
            (passage room_33 entrance_58 left)
            (passage room_35 entrance_66 right)
            (passage room_35 entrance_67 left)
            (passage room_37 entrance_38 right)
            (passage room_37 entrance_39 left)
            (passage room_38 entrance_32 right)
            (passage room_39 entrance_28 right)
            (passage room_39 entrance_29 left)
            (passage room_4 entrance_19 up)
            (passage room_4 entrance_20 left)
            (passage room_4 entrance_60 right)
            (passage room_4 entrance_61 down)
            (passage room_40 entrance_62 up)
            (passage room_40 entrance_63 left)
            (passage room_41 entrance_24 up)
            (passage room_41 entrance_25 down)
            (passage room_43 entrance_68 right)
            (passage room_44 entrance_36 right)
            (passage room_44 entrance_37 left)
            (passage room_45 entrance_30 right)
            (passage room_45 entrance_31 left)
            (passage room_6 entrance_54 up)
            (passage room_6 entrance_55 left)
            (passage room_8 entrance_1 right)
            (passage room_9 entrance_2 left)
            (passage room_9 entrance_3 down))
        (:goal
            (escaped player))
)
