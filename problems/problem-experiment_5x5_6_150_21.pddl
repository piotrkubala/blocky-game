(define (problem problem-experiment_5x5_6_150_21)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_4 entrance_12 up)
            (passage room_4 entrance_13 left)
            (passage room_4 entrance_20 right)
            (passage room_6 entrance_15 left)
            (passage room_6 entrance_2 down)
