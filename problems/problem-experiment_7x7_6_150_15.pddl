(define (problem problem-experiment_7x7_6_150_15)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (has_door entrance_43 grey)
            (has_door entrance_44 grey)
            ...
            (is key_white white)
            (passage room_1 entrance_29 up)
            (passage room_11 entrance_21 left)
            (passage room_11 entrance_22 up)
            (passage room_13 entrance_42 left)
            (passage room_13 entrance_43 right)
            (passage room_15 entrance_2 right)
            (passage room_15 entrance_3 down)
            (passage room_16 entrance_1 left)
            (passage room_17 entrance_34 right)
            (passage room_17 entrance_35 up)
            (passage room_19 entrance_25 down)
            (passage room_2 entrance_36 down)
            (passage room_2 entrance_38 right)
            (passage room_21 entrance_27 right)
            (passage room_21 entrance_28 down)
            (passage room_22 entrance_18 left)
            (passage room_22 entrance_4 up)
            (passage room_22 entrance_5 down)
            (passage room_23 entrance_19 down)
            (passage room_23 entrance_20 right)
            (passage room_24 entrance_32 right)
            (passage room_24 entrance_33 left)
            (passage room_25 entrance_30 down)
            (passage room_25 entrance_31 left)
            (passage room_25 entrance_47 up)
            (passage room_26 entrance_48 down)
            (passage room_26 entrance_49 right)
            (passage room_27 entrance_39 left)
            (passage room_27 entrance_40 up)
            (passage room_28 entrance_16 down)
            (passage room_28 entrance_17 right)
            (passage room_29 entrance_6 up)
            (passage room_29 entrance_7 down)
            (passage room_33 entrance_53 down)
            (passage room_35 entrance_8 up)
            (passage room_35 entrance_9 down)
            (passage room_37 entrance_45 left)
            (passage room_37 entrance_46 up)
            (passage room_38 entrance_14 down)
            (passage room_38 entrance_15 up)
            (passage room_39 entrance_44 left)
            (passage room_41 entrance_12 right)
            (passage room_41 entrance_13 up)
            (passage room_41 entrance_26 left)
            (passage room_42 entrance_10 up)
            (passage room_42 entrance_11 left)
            (passage room_5 entrance_23 down)
            (passage room_5 entrance_24 up)
            (passage room_5 entrance_41 right)
            (passage room_5 entrance_52 left)
            (passage room_6 entrance_50 left)
            (passage room_6 entrance_51 right)
            (passage room_7 entrance_37 right))
        (:goal
            (escaped player))
)
