(define (problem problem-experiment_6x6_9_150_13)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_1 key_red)
            (contains room_14 key_beige)
            (contains room_15 main_exit)
            (contains room_26 key_cyan)
            (contains room_29 key_magenta)
            (contains room_30 key_violet)
            (contains room_32 key_brown)
            (contains room_33 key_black)
            (contains room_5 terminal)
            (contains room_6 key_white)
            (contains room_7 key_blue)
            (free place33)
            ...
            (passage room_0 entrance_34 left)
            (passage room_1 entrance_48 right)
            (passage room_11 entrance_18 down)
            (passage room_11 entrance_19 up)
            (passage room_11 entrance_22 right)
            (passage room_11 entrance_56 left)
            (passage room_13 entrance_31 down)
            (passage room_13 entrance_32 up)
            (passage room_14 entrance_58 down)
            (passage room_14 entrance_59 right)
            (passage room_14 entrance_60 up)
            (passage room_15 entrance_70 down)
            (passage room_16 entrance_16 down)
            (passage room_16 entrance_17 up)
            (passage room_16 entrance_23 left)
            (passage room_17 entrance_61 down)
            (passage room_17 entrance_62 left)
            (passage room_18 entrance_30 up)
            (passage room_18 entrance_6 down)
            (passage room_18 entrance_7 right)
            (passage room_19 entrance_28 down)
            (passage room_19 entrance_29 up)
            (passage room_19 entrance_8 left)
            (passage room_19 entrance_9 right)
            (passage room_2 entrance_46 right)
            (passage room_2 entrance_47 left)
            (passage room_2 entrance_66 up)
            (passage room_2 entrance_69 down)
            (passage room_20 entrance_10 left)
            (passage room_20 entrance_11 right)
            (passage room_20 entrance_50 down)
            (passage room_21 entrance_12 left)
            (passage room_21 entrance_13 right)
            (passage room_22 entrance_14 left)
            (passage room_22 entrance_15 up)
            (passage room_22 entrance_55 right)
            (passage room_23 entrance_2 down)
            (passage room_23 entrance_3 right)
            (passage room_24 entrance_4 left)
            (passage room_24 entrance_40 right)
            (passage room_24 entrance_5 up)
            (passage room_25 entrance_24 right)
            (passage room_25 entrance_25 left)
            (passage room_25 entrance_65 up)
            (passage room_26 entrance_41 right)
            (passage room_27 entrance_36 right)
            (passage room_27 entrance_37 up)
            (passage room_29 entrance_1 up)
            (passage room_3 entrance_42 right)
            (passage room_3 entrance_43 up)
            (passage room_3 entrance_53 down)
            (passage room_3 entrance_54 left)
            (passage room_30 entrance_68 right)
            (passage room_31 entrance_26 right)
            (passage room_31 entrance_27 up)
            (passage room_31 entrance_38 down)
            (passage room_31 entrance_39 left)
            (passage room_32 entrance_57 right)
            (passage room_33 entrance_63 right)
            (passage room_4 entrance_44 down)
            (passage room_4 entrance_45 left)
            (passage room_5 entrance_20 down)
            (passage room_5 entrance_21 left)
            (passage room_5 entrance_49 up)
            (passage room_6 entrance_35 right)
            (passage room_7 entrance_67 right)
            (passage room_8 entrance_51 right)
            (passage room_8 entrance_52 up)
            (passage room_8 entrance_64 down))
        (:goal
            (escaped player))
)
