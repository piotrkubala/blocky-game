(define (problem problem-experiment_6x6_9_150_21)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_11 key_cyan)
            (contains room_13 key_pink)
            (contains room_22 key_grey)
            (contains room_23 key_white)
            (contains room_24 key_orange)
            (contains room_25 key_purple)
            (contains room_29 key_green)
            (contains room_31 key_red)
            (contains room_34 main_exit)
            (contains room_7 terminal)
            (contains room_8 key_gold)
            (free place51)
            ...
            (passage room_0 entrance_22 right)
            (passage room_0 entrance_48 left)
            (passage room_0 entrance_49 down)
            (passage room_11 entrance_34 up)
            (passage room_13 entrance_1 up)
            (passage room_15 entrance_45 down)
            (passage room_15 entrance_46 left)
            (passage room_17 entrance_14 up)
            (passage room_17 entrance_15 right)
            (passage room_19 entrance_16 left)
            (passage room_19 entrance_6 up)
            (passage room_19 entrance_7 down)
            (passage room_2 entrance_36 up)
            (passage room_2 entrance_37 right)
            (passage room_20 entrance_3 up)
            (passage room_20 entrance_4 left)
            (passage room_21 entrance_26 up)
            (passage room_21 entrance_27 down)
            (passage room_21 entrance_40 left)
            (passage room_21 entrance_41 right)
            (passage room_22 entrance_12 up)
            (passage room_23 entrance_13 up)
            (passage room_24 entrance_43 up)
            (passage room_25 entrance_25 left)
            (passage room_25 entrance_5 right)
            (passage room_25 entrance_8 up)
            (passage room_25 entrance_9 down)
            (passage room_27 entrance_30 up)
            (passage room_27 entrance_31 down)
            (passage room_28 entrance_19 left)
            (passage room_28 entrance_20 down)
            (passage room_28 entrance_51 up)
            (passage room_29 entrance_47 right)
            (passage room_3 entrance_32 up)
            (passage room_3 entrance_33 down)
            (passage room_3 entrance_38 left)
            (passage room_30 entrance_10 up)
            (passage room_30 entrance_11 down)
            (passage room_31 entrance_39 up)
            (passage room_31 entrance_50 down)
            (passage room_32 entrance_28 up)
            (passage room_32 entrance_29 down)
            (passage room_32 entrance_42 left)
            (passage room_34 entrance_52 up)
            (passage room_5 entrance_17 up)
            (passage room_5 entrance_18 right)
            (passage room_5 entrance_35 down)
            (passage room_7 entrance_2 down)
            (passage room_7 entrance_24 right)
