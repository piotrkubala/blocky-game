(define (problem problem-experiment_7x7_6_150_2)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_0 main_exit)
            (contains room_16 key_purple)
            (contains room_18 key_blue)
            (contains room_32 key_beige)
            (contains room_34 key_white)
            (contains room_36 key_grey)
            ...
            (has_door entrance_22 white)
            (has_door entrance_23 turquoise)
            (has_door entrance_23 white)
            ...
            (has_door entrance_33 white)
            (has_door entrance_34 white)
            (has_door entrance_35 white)
            (has_door entrance_36 white)
            (has_door entrance_37 white)
            (has_door entrance_38 white)
            ...
            (has_door entrance_42 beige)
            (has_door entrance_42 purple)
            (has_door entrance_43 purple)
            (has_door entrance_44 purple)
            (has_door entrance_45 purple)
            (has_door entrance_46 purple)
            (has_door entrance_47 purple)
            (has_door entrance_48 beige)
            (has_door entrance_49 beige)
            ...
            (is key_white white)
            (passage room_0 entrance_62 up)
            (passage room_1 entrance_47 up)
            (passage room_1 entrance_48 down)
            (passage room_1 entrance_61 right)
            (passage room_10 entrance_14 down)
            (passage room_10 entrance_15 up)
            (passage room_11 entrance_34 up)
            (passage room_11 entrance_35 right)
            (passage room_11 entrance_50 left)
            (passage room_11 entrance_51 down)
            (passage room_12 entrance_24 up)
            (passage room_12 entrance_25 down)
            (passage room_14 entrance_45 up)
            (passage room_14 entrance_46 down)
            (passage room_15 entrance_43 right)
            (passage room_15 entrance_44 down)
            (passage room_15 entrance_55 up)
            (passage room_16 entrance_32 left)
            (passage room_16 entrance_33 down)
            (passage room_17 entrance_12 down)
            (passage room_17 entrance_13 up)
            (passage room_18 entrance_60 right)
            (passage room_19 entrance_38 up)
            (passage room_19 entrance_39 right)
            (passage room_2 entrance_41 up)
            (passage room_2 entrance_42 left)
            (passage room_2 entrance_52 down)
            (passage room_22 entrance_6 down)
            (passage room_22 entrance_7 right)
            (passage room_23 entrance_8 left)
            (passage room_23 entrance_9 right)
            (passage room_24 entrance_10 left)
            (passage room_24 entrance_11 up)
            (passage room_25 entrance_26 up)
            (passage room_25 entrance_27 right)
            (passage room_27 entrance_28 left)
            (passage room_27 entrance_29 right)
            (passage room_29 entrance_4 down)
            (passage room_29 entrance_5 up)
            (passage room_3 entrance_16 down)
            (passage room_3 entrance_17 right)
            (passage room_32 entrance_40 left)
            (passage room_33 entrance_36 left)
            (passage room_33 entrance_37 down)
            (passage room_34 entrance_1 right)
            (passage room_35 entrance_2 left)
            (passage room_35 entrance_3 up)
            (passage room_36 entrance_49 up)
            (passage room_37 entrance_58 up)
            (passage room_37 entrance_59 left)
            (passage room_4 entrance_18 left)
            (passage room_4 entrance_19 right)
            (passage room_4 entrance_53 up)
            (passage room_4 entrance_54 down)
            (passage room_47 entrance_30 left)
            (passage room_5 entrance_20 left)
            (passage room_5 entrance_21 right)
            (passage room_6 entrance_22 left)
            (passage room_6 entrance_23 down)
            (passage room_6 entrance_31 right)
            (passage room_7 entrance_56 up)
            (passage room_7 entrance_57 down))
        (:goal
            (escaped player))
)
