(define (problem problem-experiment_6x6_6_150_4)
    (:domain blocky-game)
        (:objects
            cyan - colour
            green - colour
        ...
        (:init
            ...
            (passage room_12 entrance_37 left)
            ...
            (passage room_16 entrance_21 right)
            (passage room_16 entrance_4 left)
            (passage room_16 entrance_5 down)
            (passage room_17 entrance_22 left)
            ...
            (passage room_4 entrance_8 left)
            (passage room_7 entrance_39 left)
            (passage room_7 entrance_40 right))
        (:goal
            (escaped player))
)
