(define (problem problem-experiment_6x6_6_150_25)
    (:domain blocky-game)
        (:objects
            gold - colour
            indigo - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_20 key_navy)
            (contains room_22 key_red)
            (contains room_23 key_pink)
            (contains room_24 key_indigo)
            (contains room_25 main_exit)
            (contains room_26 terminal)
            (contains room_3 key_purple)
            (contains room_9 key_gold)
            (free place41)
            ...
            (passage room_12 entrance_49 right)
            (passage room_12 entrance_50 up)
            (passage room_13 entrance_51 down)
            (passage room_13 entrance_52 left)
            (passage room_15 entrance_31 down)
            (passage room_15 entrance_32 up)
            ...
            (passage room_18 entrance_33 down)
            (passage room_18 entrance_34 up)
            ...
            (passage room_20 entrance_37 right)
            (passage room_20 entrance_40 left)
            (passage room_21 entrance_22 down)
            (passage room_21 entrance_23 up)
            (passage room_22 entrance_24 down)
            (passage room_23 entrance_1 down)
            (passage room_24 entrance_27 right)
            (passage room_24 entrance_35 down)
            (passage room_24 entrance_36 left)
            (passage room_25 entrance_53 right)
            (passage room_26 entrance_10 down)
            (passage room_26 entrance_11 right)
            (passage room_26 entrance_25 up)
            (passage room_26 entrance_39 left)
            (passage room_29 entrance_2 up)
            (passage room_29 entrance_3 right)
            (passage room_3 entrance_38 left)
            (passage room_30 entrance_4 left)
            (passage room_30 entrance_44 down)
            (passage room_30 entrance_45 up)
            (passage room_30 entrance_5 right)
            (passage room_31 entrance_6 left)
            (passage room_31 entrance_7 right)
            (passage room_32 entrance_26 down)
            (passage room_32 entrance_41 right)
            (passage room_32 entrance_8 left)
            (passage room_32 entrance_9 up)
            (passage room_33 entrance_12 left)
            (passage room_33 entrance_13 right)
            (passage room_34 entrance_16 left)
            (passage room_34 entrance_17 up)
