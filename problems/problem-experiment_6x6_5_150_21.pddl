(define (problem problem-experiment_6x6_5_150_21)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_26 entrance_27 up)
            (passage room_26 entrance_28 down)
            (passage room_26 entrance_31 left)
            (passage room_29 entrance_32 up)
            (passage room_29 entrance_33 right)
            (passage room_3 entrance_5 up)
            (passage room_3 entrance_6 right)
            ...
            (passage room_31 entrance_43 left)
            (passage room_33 entrance_45 left)
            (passage room_34 entrance_29 up)
            (passage room_34 entrance_30 right)
            (passage room_5 entrance_15 left)
            (passage room_5 entrance_16 up)
