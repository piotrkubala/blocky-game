(define (problem problem-experiment_5x5_6_150_2)
    (:domain blocky-game)
        (:objects
            cyan - colour
            orange - colour
        ...
        (:init
            ...
            (passage room_0 entrance_24 right)
            ...
            (passage room_9 entrance_17 down))
        (:goal
            (escaped player))
)
