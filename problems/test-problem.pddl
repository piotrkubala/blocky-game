(define (problem test-problem)
    (:domain blocky-game)
        ...
        (:init
            ...
            (contains room_39 key_magenta)
            (contains room_46 key_white)
            ...
            (passage room_1 entrance_42 right)
            (passage room_1 entrance_43 left)
            (passage room_14 entrance_46 right)
            (passage room_15 entrance_20 right)
            (passage room_15 entrance_21 left)
            (passage room_17 entrance_17 left)
            (passage room_17 entrance_26 up)
            (passage room_17 entrance_8 right)
            (passage room_17 entrance_9 down)
            (passage room_18 entrance_6 down)
            (passage room_18 entrance_7 left)
            (passage room_2 entrance_49 down)
            (passage room_2 entrance_50 up)
            ...
            (passage room_24 entrance_19 left)
            (passage room_25 entrance_4 down)
            (passage room_25 entrance_5 up)
            (passage room_26 entrance_39 up)
            (passage room_28 entrance_27 down)
            (passage room_28 entrance_28 up)
            (passage room_31 entrance_36 right)
            (passage room_31 entrance_37 down)
            (passage room_32 entrance_2 right)
            (passage room_32 entrance_3 up)
            (passage room_33 entrance_1 left)
            (passage room_34 entrance_44 right)
            (passage room_34 entrance_45 left)
            (passage room_36 entrance_34 right)
            (passage room_36 entrance_35 left)
            (passage room_37 entrance_29 down)
            (passage room_38 entrance_10 up)
            (passage room_38 entrance_11 down)
            (passage room_39 entrance_25 up)
            (passage room_40 entrance_30 right)
            (passage room_40 entrance_31 left)
            (passage room_42 entrance_32 right)
            (passage room_42 entrance_33 left)
            (passage room_44 entrance_14 up)
            (passage room_44 entrance_15 right)
            (passage room_45 entrance_12 up)
            (passage room_45 entrance_13 down)
            (passage room_46 entrance_16 left)
            (passage room_47 entrance_40 down)
            (passage room_47 entrance_41 left)
            (passage room_5 entrance_51 down)
