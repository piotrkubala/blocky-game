(define (problem problem-experiment_6x6_6_150_1)
    (:domain blocky-game)
        (:objects
            brown - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_19 entrance_9 left)
            ...
            (passage room_21 entrance_35 up)
            (passage room_22 entrance_26 left)
            (passage room_22 entrance_27 right)
            ...
            (passage room_30 entrance_30 up)
            (passage room_30 entrance_31 down)
            (passage room_32 entrance_14 down)
            (passage room_32 entrance_15 left)
            ...
            (passage room_9 entrance_34 right))
        (:goal
            (escaped player))
)
