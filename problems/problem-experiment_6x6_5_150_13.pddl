(define (problem problem-experiment_6x6_5_150_13)
    (:domain blocky-game)
        (:objects
            blue - colour
            cyan - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_12 key_pink)
            (contains room_29 key_gold)
            (contains room_30 key_blue)
            (contains room_33 terminal)
            (contains room_4 main_exit)
            (contains room_6 key_cyan)
            (contains room_8 key_navy)
            (free place41)
            ...
            (is key_navy navy)
            (is key_pink pink)
            (passage room_10 entrance_47 left)
            (passage room_10 entrance_48 up)
            (passage room_12 entrance_30 right)
            (passage room_13 entrance_4 up)
            (passage room_13 entrance_5 down)
            (passage room_14 entrance_20 right)
            (passage room_14 entrance_21 left)
            (passage room_16 entrance_33 right)
            (passage room_16 entrance_34 down)
            (passage room_16 entrance_36 left)
            (passage room_17 entrance_37 right)
            (passage room_17 entrance_38 left)
            (passage room_18 entrance_6 up)
            (passage room_18 entrance_7 right)
            (passage room_19 entrance_8 left)
            (passage room_19 entrance_9 down)
            (passage room_2 entrance_28 right)
            (passage room_2 entrance_29 left)
            (passage room_2 entrance_44 down)
            (passage room_21 entrance_17 down)
            (passage room_21 entrance_18 left)
            (passage room_21 entrance_27 right)
            (passage room_21 entrance_49 up)
            (passage room_22 entrance_25 down)
            (passage room_22 entrance_26 left)
            (passage room_22 entrance_32 right)
            (passage room_24 entrance_42 down)
            (passage room_24 entrance_43 up)
            (passage room_25 entrance_10 up)
            (passage room_25 entrance_11 right)
            (passage room_26 entrance_12 left)
            (passage room_26 entrance_13 right)
            (passage room_27 entrance_14 left)
            (passage room_27 entrance_15 down)
            (passage room_27 entrance_19 right)
            (passage room_28 entrance_39 right)
            (passage room_28 entrance_40 left)
            (passage room_29 entrance_24 right)
            (passage room_30 entrance_41 right)
            (passage room_32 entrance_22 right)
            (passage room_32 entrance_23 left)
            (passage room_33 entrance_16 up)
            (passage room_33 entrance_31 left)
            (passage room_4 entrance_51 down)
            (passage room_5 entrance_45 left)
            (passage room_5 entrance_46 right)
            (passage room_6 entrance_1 right)
            (passage room_7 entrance_2 left)
            (passage room_7 entrance_3 down)
            (passage room_7 entrance_50 up)
            (passage room_8 entrance_35 up))
        (:goal
            (escaped player))
)
