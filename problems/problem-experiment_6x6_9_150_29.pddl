(define (problem problem-experiment_6x6_9_150_29)
    (:domain blocky-game)
        (:objects
            brown - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_32 entrance_16 down)
            ...
            (passage room_6 entrance_19 up)
            (passage room_6 entrance_20 left)
            (passage room_6 entrance_28 right)
            (passage room_6 entrance_29 down)
