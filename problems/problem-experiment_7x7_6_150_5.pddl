(define (problem problem-experiment_7x7_6_150_5)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_17 key_indigo)
            (contains room_2 terminal)
            (contains room_21 key_blue)
            (contains room_33 key_white)
            (contains room_34 main_exit)
            (contains room_39 key_green)
            (contains room_41 key_turquoise)
            (contains room_46 key_black)
            (free place34)
            ...
            (passage room_11 entrance_33 down)
            (passage room_13 entrance_34 up)
            ...
            (passage room_3 entrance_18 left)
            (passage room_3 entrance_19 down)
            ...
            (passage room_38 entrance_45 left)
            (passage room_39 entrance_1 up)
            (passage room_40 entrance_36 up)
            (passage room_40 entrance_37 down)
            (passage room_41 entrance_46 right)
            (passage room_45 entrance_28 up)
            (passage room_45 entrance_29 down)
            (passage room_46 entrance_42 down)
