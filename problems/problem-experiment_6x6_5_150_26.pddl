(define (problem problem-experiment_6x6_5_150_26)
    (:domain blocky-game)
        (:objects
            beige - colour
            green - colour
        ...
        (:init
            ...
            (contains room_3 key_beige)
            (contains room_34 key_grey)
            (contains room_5 key_green)
            ...
            (passage room_31 entrance_19 left)
            (passage room_31 entrance_20 up)
            ...
            (passage room_4 entrance_2 right)
            (passage room_4 entrance_23 left)
            (passage room_4 entrance_3 down)
            (passage room_5 entrance_1 left)
            (passage room_6 entrance_29 up)
            (passage room_6 entrance_30 right)
