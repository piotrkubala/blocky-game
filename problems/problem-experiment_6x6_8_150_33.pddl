(define (problem problem-experiment_6x6_8_150_33)
    (:domain blocky-game)
        (:objects
            beige - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_20 entrance_39 right)
            (passage room_21 entrance_24 left)
            (passage room_22 entrance_37 right)
            (passage room_22 entrance_38 left)
            (passage room_23 entrance_16 up)
            (passage room_23 entrance_17 down)
            (passage room_24 entrance_34 up)
            (passage room_25 entrance_23 left)
            ...
            (passage room_30 entrance_27 down)
            (passage room_31 entrance_25 down)
            (passage room_31 entrance_26 up)
            (passage room_33 entrance_35 up)
            (passage room_33 entrance_36 left)
            (passage room_4 entrance_1 down)
            ...
            (passage room_8 entrance_7 left)
