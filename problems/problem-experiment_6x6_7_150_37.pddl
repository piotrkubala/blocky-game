(define (problem problem-experiment_6x6_7_150_37)
    (:domain blocky-game)
        (:objects
            black - colour
            cyan - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_10 key_black)
            (contains room_11 key_purple)
            ...
            (passage room_15 entrance_20 left)
            ...
            (passage room_19 entrance_17 right)
            (passage room_19 entrance_18 up)
            (passage room_20 entrance_46 left)
            ...
            (passage room_23 entrance_37 right)
