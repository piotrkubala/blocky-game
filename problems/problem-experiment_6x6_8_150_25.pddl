(define (problem problem-experiment_6x6_8_150_25)
    (:domain blocky-game)
        (:objects
            gold - colour
            magenta - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_0 key_yellow)
            (contains room_13 key_gold)
            (contains room_15 key_turquoise)
            (contains room_16 key_white)
            (contains room_21 main_exit)
            (contains room_23 key_magenta)
            (contains room_26 terminal)
            (contains room_28 key_violet)
            (contains room_34 key_red)
            ...
            (passage room_0 entrance_39 up)
            (passage room_10 entrance_29 left)
            (passage room_10 entrance_30 right)
            (passage room_11 entrance_31 left)
            (passage room_11 entrance_32 down)
            (passage room_13 entrance_1 down)
            (passage room_15 entrance_24 left)
            (passage room_15 entrance_33 up)
            (passage room_15 entrance_34 down)
            ...
            (passage room_20 entrance_15 right)
            (passage room_20 entrance_40 down)
            (passage room_21 entrance_52 right)
            (passage room_22 entrance_35 up)
            (passage room_22 entrance_36 right)
            (passage room_23 entrance_49 left)
            ...
            (passage room_27 entrance_44 left)
            (passage room_27 entrance_45 down)
            (passage room_28 entrance_37 left)
            (passage room_28 entrance_48 right)
            (passage room_30 entrance_10 left)
            (passage room_30 entrance_11 right)
            (passage room_31 entrance_46 up)
            (passage room_31 entrance_47 right)
            (passage room_32 entrance_42 up)
            (passage room_32 entrance_43 right)
            (passage room_32 entrance_51 left)
            (passage room_34 entrance_50 right)
            (passage room_4 entrance_38 up)
            (passage room_5 entrance_20 up)
            (passage room_5 entrance_21 right)
            (passage room_6 entrance_25 left)
            (passage room_6 entrance_26 down)
            (passage room_7 entrance_22 left)
            (passage room_7 entrance_23 right)
            (passage room_8 entrance_16 left)
            (passage room_8 entrance_17 up))
        (:goal
            (escaped player))
)
