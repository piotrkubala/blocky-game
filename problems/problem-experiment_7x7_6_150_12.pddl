(define (problem problem-experiment_7x7_6_150_12)
    (:domain blocky-game)
        (:objects
            brown - colour
            cyan - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_14 key_red)
            (contains room_16 main_exit)
            (contains room_38 key_turquoise)
            (contains room_39 key_cyan)
            (contains room_43 key_violet)
            (contains room_45 terminal)
            (contains room_46 key_brown)
            ...
            (passage room_14 entrance_42 down)
            (passage room_16 entrance_50 down)
            (passage room_19 entrance_20 down)
            (passage room_19 entrance_21 left)
            (passage room_21 entrance_45 left)
            (passage room_21 entrance_8 down)
            (passage room_21 entrance_9 right)
            (passage room_22 entrance_24 down)
            (passage room_22 entrance_25 left)
            (passage room_23 entrance_26 right)
            (passage room_23 entrance_27 left)
            (passage room_24 entrance_48 down)
            (passage room_24 entrance_49 up)
            (passage room_30 entrance_31 right)
            (passage room_30 entrance_32 up)
            ...
            (passage room_32 entrance_39 left)
            (passage room_34 entrance_15 right)
            (passage room_34 entrance_16 left)
            (passage room_34 entrance_4 down)
            (passage room_34 entrance_5 up)
            (passage room_35 entrance_40 right)
            (passage room_35 entrance_41 up)
            (passage room_38 entrance_28 right)
            (passage room_39 entrance_13 left)
            (passage room_39 entrance_18 down)
            (passage room_39 entrance_19 up)
            (passage room_4 entrance_46 right)
            (passage room_4 entrance_47 up)
            (passage room_41 entrance_33 left)
            (passage room_41 entrance_6 down)
            (passage room_41 entrance_7 up)
            (passage room_42 entrance_35 right)
            (passage room_42 entrance_36 up)
            (passage room_43 entrance_17 right)
            (passage room_44 entrance_37 right)
            (passage room_44 entrance_38 up)
            ...
            (passage room_6 entrance_29 right)
            (passage room_6 entrance_30 left))
        (:goal
            (escaped player))
)
