(define (problem problem-experiment_6x6_9_150_28)
    (:domain blocky-game)
        (:objects
            black - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_10 entrance_10 down)
            (passage room_10 entrance_11 left)
            ...
            (passage room_20 entrance_37 up)
            ...
            (passage room_29 entrance_27 right)
            (passage room_29 entrance_28 up)
            (passage room_3 entrance_38 down)
