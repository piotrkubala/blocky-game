(define (problem problem-experiment_6x6_5_150_3)
    (:domain blocky-game)
        (:objects
            cyan - colour
            magenta - colour
        ...
        (:init
            ...
            (passage room_21 entrance_16 down)
            (passage room_21 entrance_17 left)
            ...
            (passage room_27 entrance_10 right)
