(define (problem problem-experiment_6x6_6_150_27)
    (:domain blocky-game)
        (:objects
            blue - colour
            gold - colour
        ...
        (:init
            ...
            (contains room_13 key_indigo)
            (contains room_18 key_white)
            (contains room_2 key_grey)
            (contains room_29 terminal)
            (contains room_4 key_pink)
            ...
            (has_door entrance_27 grey)
            (has_door entrance_28 grey)
            ...
            (has_door entrance_45 white)
            (has_door entrance_46 white)
            (has_door entrance_47 gold)
            (has_door entrance_48 gold)
            (has_door entrance_49 white)
            (has_door entrance_5 grey)
            (has_door entrance_50 white)
            (has_door entrance_51 white)
            ...
            (passage room_0 entrance_56 right)
            (passage room_0 entrance_57 down)
            (passage room_1 entrance_46 up)
            (passage room_1 entrance_47 down)
            (passage room_10 entrance_28 right)
            (passage room_10 entrance_29 down)
            (passage room_12 entrance_25 right)
            (passage room_12 entrance_26 down)
            (passage room_13 entrance_37 right)
            (passage room_15 entrance_6 up)
            (passage room_15 entrance_7 right)
            (passage room_16 entrance_15 right)
            (passage room_16 entrance_30 up)
            (passage room_16 entrance_8 left)
            (passage room_16 entrance_9 down)
            (passage room_17 entrance_16 up)
            (passage room_17 entrance_17 down)
            (passage room_17 entrance_31 right)
            (passage room_17 entrance_32 left)
            (passage room_18 entrance_39 up)
            (passage room_19 entrance_54 right)
            (passage room_19 entrance_55 left)
            (passage room_2 entrance_1 down)
            (passage room_20 entrance_50 right)
            (passage room_20 entrance_51 down)
            (passage room_22 entrance_10 up)
            (passage room_22 entrance_11 down)
            (passage room_22 entrance_43 left)
            (passage room_23 entrance_18 up)
            (passage room_23 entrance_19 left)
            (passage room_26 entrance_35 right)
            (passage room_26 entrance_36 left)
            (passage room_27 entrance_33 right)
            (passage room_27 entrance_34 left)
            (passage room_28 entrance_12 up)
            (passage room_28 entrance_13 right)
            (passage room_28 entrance_20 left)
            (passage room_28 entrance_38 down)
            (passage room_29 entrance_14 left)
            (passage room_29 entrance_40 up)
            (passage room_29 entrance_45 down)
            (passage room_30 entrance_21 right)
            (passage room_30 entrance_22 left)
            (passage room_30 entrance_42 down)
            (passage room_31 entrance_52 up)
            (passage room_31 entrance_53 left)
            (passage room_32 entrance_23 right)
            (passage room_32 entrance_24 left)
            (passage room_34 entrance_48 up)
            (passage room_34 entrance_49 left)
            (passage room_4 entrance_44 down)
            (passage room_6 entrance_58 up)
            (passage room_7 entrance_41 down)
            (passage room_8 entrance_2 up)
            (passage room_8 entrance_3 right)
            (passage room_9 entrance_4 left)
            (passage room_9 entrance_5 down))
        (:goal
            (escaped player))
)
