(define (problem problem-experiment_6x6_9_150_20)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_0 key_gold)
            (contains room_12 key_violet)
            (contains room_16 key_red)
            (contains room_19 key_navy)
            (contains room_24 key_turquoise)
            (contains room_30 key_black)
            (contains room_33 terminal)
            (contains room_34 main_exit)
            (contains room_4 key_white)
            (contains room_6 key_beige)
            (contains room_7 key_grey)
            (free place25)
            ...
            (has_door entrance_22 gold)
            (has_door entrance_23 gold)
            (has_door entrance_24 gold)
            (has_door entrance_25 gold)
            (has_door entrance_26 gold)
            (has_door entrance_27 gold)
            (has_door entrance_28 gold)
            (has_door entrance_29 gold)
            (has_door entrance_3 gold)
            (has_door entrance_30 gold)
            (has_door entrance_31 gold)
            (has_door entrance_32 gold)
            (has_door entrance_33 gold)
            (has_door entrance_34 gold)
            ...
            (has_door entrance_52 grey)
            (has_door entrance_53 grey)
            (has_door entrance_54 gold)
            (has_door entrance_55 gold)
            (has_door entrance_56 black)
            (has_door entrance_57 black)
            (has_door entrance_58 black)
            (has_door entrance_59 violet)
            (has_door entrance_6 gold)
            (has_door entrance_60 violet)
            (has_door entrance_61 grey)
            (has_door entrance_62 grey)
            (has_door entrance_63 black)
            (has_door entrance_64 black)
            (has_door entrance_65 turquoise)
            (has_door entrance_66 navy)
            ...
            (passage room_1 entrance_61 up)
            (passage room_10 entrance_34 left)
            (passage room_10 entrance_35 up)
            (passage room_10 entrance_41 down)
            (passage room_11 entrance_46 right)
            (passage room_11 entrance_47 left)
            (passage room_11 entrance_54 up)
            (passage room_12 entrance_57 down)
            (passage room_13 entrance_8 up)
            (passage room_13 entrance_9 right)
            (passage room_14 entrance_10 left)
            (passage room_14 entrance_11 down)
            (passage room_16 entrance_36 down)
            (passage room_16 entrance_52 left)
            (passage room_16 entrance_59 right)
            (passage room_18 entrance_29 down)
            (passage room_18 entrance_30 up)
            (passage room_19 entrance_60 left)
            (passage room_2 entrance_4 left)
            (passage room_2 entrance_5 down)
            (passage room_20 entrance_12 up)
            (passage room_20 entrance_13 down)
            (passage room_20 entrance_26 left)
            (passage room_20 entrance_27 right)
            (passage room_21 entrance_64 left)
            (passage room_21 entrance_65 up)
            (passage room_24 entrance_23 down)
            (passage room_24 entrance_44 right)
            (passage room_24 entrance_45 left)
            (passage room_25 entrance_24 down)
            (passage room_25 entrance_25 right)
            (passage room_26 entrance_14 up)
            (passage room_26 entrance_15 right)
            (passage room_26 entrance_28 left)
            (passage room_27 entrance_16 left)
            (passage room_27 entrance_17 down)
            (passage room_27 entrance_50 up)
            (passage room_29 entrance_62 down)
            (passage room_29 entrance_63 right)
            (passage room_3 entrance_39 right)
            (passage room_3 entrance_40 up)
            (passage room_30 entrance_53 right)
            (passage room_30 entrance_55 down)
            (passage room_30 entrance_56 up)
            (passage room_31 entrance_19 down)
            (passage room_31 entrance_20 left)
            (passage room_32 entrance_21 right)
            (passage room_32 entrance_22 up)
            (passage room_33 entrance_18 up)
            (passage room_33 entrance_43 left)
            (passage room_33 entrance_49 down)
            (passage room_33 entrance_58 right)
            (passage room_34 entrance_66 down)
            (passage room_4 entrance_42 right)
            (passage room_5 entrance_31 down)
            (passage room_5 entrance_32 up)
            (passage room_6 entrance_48 right)
            (passage room_7 entrance_51 right)
            (passage room_8 entrance_33 right)
            (passage room_8 entrance_6 up)
            (passage room_8 entrance_7 down)
            (passage room_9 entrance_37 down)
            (passage room_9 entrance_38 left))
        (:goal
            (escaped player))
)
