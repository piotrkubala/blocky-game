(define (problem problem-experiment_7x7_6_150_3)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (at room_8 place22)
            (at room_9 place23)
            (contains room_17 key_cyan)
            (contains room_28 main_exit)
            (contains room_31 key_grey)
            (contains room_34 terminal)
            (contains room_36 key_beige)
            (contains room_40 key_purple)
            (contains room_6 key_turquoise)
            (contains room_7 key_pink)
            (free place72)
            ...
            (has_door entrance_16 turquoise)
            (has_door entrance_17 turquoise)
            (has_door entrance_18 turquoise)
            (has_door entrance_19 turquoise)
            (has_door entrance_2 turquoise)
            (has_door entrance_20 turquoise)
            (has_door entrance_21 turquoise)
            (has_door entrance_22 turquoise)
            (has_door entrance_23 turquoise)
            (has_door entrance_24 turquoise)
            (has_door entrance_25 turquoise)
            (has_door entrance_26 turquoise)
            (has_door entrance_27 turquoise)
            (has_door entrance_28 turquoise)
            (has_door entrance_29 turquoise)
            ...
            (has_door entrance_34 grey)
            (has_door entrance_35 grey)
            ...
            (has_door entrance_40 purple)
            (has_door entrance_41 purple)
            (has_door entrance_42 purple)
            (has_door entrance_43 turquoise)
            ...
            (passage room_1 entrance_33 down)
            (passage room_1 entrance_34 left)
            (passage room_13 entrance_2 up)
            (passage room_13 entrance_3 down)
            (passage room_16 entrance_31 down)
            (passage room_16 entrance_32 up)
            (passage room_17 entrance_40 right)
            (passage room_18 entrance_21 right)
            (passage room_18 entrance_22 left)
            (passage room_20 entrance_11 left)
            (passage room_20 entrance_4 up)
            (passage room_20 entrance_5 down)
            (passage room_22 entrance_29 down)
            (passage room_22 entrance_30 up)
            (passage room_23 entrance_25 down)
            (passage room_23 entrance_26 left)
            (passage room_24 entrance_14 right)
            (passage room_24 entrance_15 left)
            (passage room_24 entrance_44 down)
            (passage room_25 entrance_12 right)
            (passage room_25 entrance_13 left)
            (passage room_25 entrance_63 down)
            (passage room_25 entrance_64 up)
            (passage room_26 entrance_19 down)
            (passage room_26 entrance_20 left)
            (passage room_27 entrance_37 left)
            (passage room_27 entrance_6 up)
            (passage room_27 entrance_7 down)
            (passage room_28 entrance_65 down)
            (passage room_29 entrance_59 right)
            (passage room_29 entrance_60 up)
            (passage room_30 entrance_16 right)
            (passage room_30 entrance_17 left)
            (passage room_30 entrance_53 down)
            (passage room_30 entrance_54 up)
            (passage room_31 entrance_18 right)
            (passage room_32 entrance_47 down)
            (passage room_32 entrance_48 left)
            (passage room_32 entrance_55 right)
            (passage room_32 entrance_56 up)
            (passage room_33 entrance_10 up)
            (passage room_33 entrance_9 down)
            (passage room_34 entrance_41 left)
            (passage room_34 entrance_8 up)
            (passage room_35 entrance_27 right)
            (passage room_35 entrance_28 up)
            (passage room_36 entrance_49 right)
            (passage room_37 entrance_51 right)
            (passage room_37 entrance_52 up)
            (passage room_40 entrance_36 down)
            (passage room_40 entrance_38 right)
            (passage room_40 entrance_39 left)
            (passage room_41 entrance_45 right)
            (passage room_41 entrance_46 up)
            (passage room_43 entrance_42 right)
            (passage room_43 entrance_43 up)
            (passage room_43 entrance_50 left)
            (passage room_45 entrance_23 right)
            (passage room_45 entrance_24 up)
            (passage room_47 entrance_57 down)
            (passage room_47 entrance_58 left)
            (passage room_6 entrance_1 down)
            (passage room_7 entrance_35 right)
            (passage room_7 entrance_61 down)
            (passage room_7 entrance_62 up))
        (:goal
            (escaped player))
)
