(define (problem problem-experiment_6x6_8_150_16)
    (:domain blocky-game)
        (:objects
            brown - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_10 entrance_11 down)
            (passage room_10 entrance_16 right)
            (passage room_10 entrance_38 up)
            (passage room_11 entrance_30 left)
            ...
            (passage room_3 entrance_46 down)
            (passage room_30 entrance_37 right)
            (passage room_31 entrance_44 down)
            ...
            (passage room_5 entrance_23 right)
            (passage room_5 entrance_24 down)
            (passage room_7 entrance_39 down)
