(define (problem problem-experiment_7x7_6_150_48)
    (:domain blocky-game)
        (:objects
            brown - colour
            navy - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_15 key_navy)
            (contains room_16 key_brown)
            (contains room_19 main_exit)
            (contains room_21 terminal)
            (contains room_30 key_yellow)
            (contains room_34 key_purple)
            (contains room_39 key_violet)
            ...
            (passage room_0 entrance_15 left)
            (passage room_0 entrance_16 right)
            (passage room_10 entrance_45 left)
            (passage room_10 entrance_46 right)
            (passage room_13 entrance_7 left)
            (passage room_13 entrance_8 up)
            (passage room_14 entrance_37 left)
            (passage room_14 entrance_38 right)
            (passage room_15 entrance_11 left)
            (passage room_16 entrance_31 right)
            (passage room_17 entrance_47 left)
            (passage room_17 entrance_48 up)
            (passage room_19 entrance_49 down)
            (passage room_20 entrance_13 up)
            (passage room_20 entrance_14 right)
            (passage room_20 entrance_34 left)
            (passage room_21 entrance_12 down)
            (passage room_21 entrance_25 up)
            ...
            (passage room_28 entrance_32 left)
            (passage room_28 entrance_33 right)
            (passage room_29 entrance_17 left)
            (passage room_29 entrance_18 right)
            (passage room_30 entrance_1 up)
            (passage room_32 entrance_41 down)
            (passage room_32 entrance_42 up)
            (passage room_34 entrance_28 right)
            (passage room_34 entrance_29 down)
            (passage room_34 entrance_30 left)
            (passage room_36 entrance_19 left)
            (passage room_36 entrance_20 down)
            (passage room_38 entrance_39 left)
            (passage room_38 entrance_40 up)
            (passage room_39 entrance_23 left)
            (passage room_4 entrance_26 down)
            (passage room_4 entrance_27 left)
            (passage room_41 entrance_21 up)
            (passage room_41 entrance_22 right)
            (passage room_5 entrance_35 down)
            (passage room_5 entrance_36 right)
            (passage room_6 entrance_24 up)
            (passage room_7 entrance_10 right)
            (passage room_7 entrance_9 down)
            (passage room_8 entrance_43 down)
            (passage room_8 entrance_44 right))
        (:goal
            (escaped player))
)
