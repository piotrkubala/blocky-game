(define (problem problem-experiment_7x7_6_150_48)
    (:domain blocky-game)
        ...
        (:init
            ...
            (contains room_17 key_blue)
            (contains room_25 key_orange)
            (contains room_31 key_pink)
            (contains room_33 terminal)
            (contains room_37 key_green)
            (contains room_41 key_white)
            ...
            (is key_pink pink)
            (is key_white white)
            (passage room_0 entrance_34 right)
            (passage room_0 entrance_35 left)
            (passage room_12 entrance_54 right)
            (passage room_13 entrance_50 down)
            (passage room_13 entrance_51 up)
            (passage room_16 entrance_38 right)
            (passage room_16 entrance_39 up)
            (passage room_17 entrance_1 right)
            (passage room_18 entrance_2 left)
            (passage room_18 entrance_3 right)
            (passage room_18 entrance_46 down)
            (passage room_18 entrance_47 up)
            (passage room_19 entrance_4 left)
            (passage room_19 entrance_5 down)
            (passage room_2 entrance_36 right)
            (passage room_2 entrance_37 left)
            (passage room_20 entrance_42 right)
            (passage room_20 entrance_43 left)
            (passage room_25 entrance_24 right)
            (passage room_25 entrance_25 up)
            (passage room_26 entrance_45 right)
            (passage room_26 entrance_6 up)
            (passage room_26 entrance_7 down)
            (passage room_28 entrance_17 right)
            (passage room_28 entrance_18 up)
            (passage room_30 entrance_19 down)
            (passage room_30 entrance_20 left)
            (passage room_31 entrance_14 right)
            (passage room_32 entrance_30 down)
            (passage room_32 entrance_31 up)
            (passage room_32 entrance_55 right)
            (passage room_32 entrance_56 left)
            (passage room_33 entrance_8 up)
            (passage room_33 entrance_9 left)
            (passage room_35 entrance_21 right)
            (passage room_35 entrance_22 left)
            (passage room_36 entrance_52 down)
            (passage room_36 entrance_53 left)
            (passage room_37 entrance_44 right)
            (passage room_38 entrance_15 right)
            (passage room_38 entrance_16 left)
            (passage room_39 entrance_12 right)
            (passage room_39 entrance_13 left)
            (passage room_4 entrance_32 down)
            (passage room_4 entrance_33 left)
            (passage room_41 entrance_23 right)
            (passage room_45 entrance_26 down)
            (passage room_45 entrance_27 up)
            (passage room_47 entrance_10 right)
            (passage room_47 entrance_11 left)
            (passage room_5 entrance_48 down)
            (passage room_5 entrance_49 up)
            (passage room_6 entrance_28 down)
            (passage room_6 entrance_29 up)
            (passage room_6 entrance_57 right)
            (passage room_7 entrance_40 down)
            (passage room_7 entrance_41 left)
            (passage room_8 entrance_58 down))
        (:goal
            (escaped player))
)
