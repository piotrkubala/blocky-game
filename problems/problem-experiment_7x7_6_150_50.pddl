(define (problem problem-experiment_7x7_6_150_50)
    (:domain blocky-game)
        (:objects
            black - colour
            cyan - colour
        ...
        (:init
            ...
            (contains room_3 key_black)
            (contains room_37 key_purple)
            (contains room_4 main_exit)
            (contains room_5 key_cyan)
            ...
            (passage room_10 entrance_6 right)
            (passage room_10 entrance_7 left)
            (passage room_11 entrance_4 right)
            (passage room_11 entrance_5 left)
            (passage room_12 entrance_2 right)
            (passage room_12 entrance_3 left)
            (passage room_13 entrance_1 left)
            (passage room_15 entrance_46 up)
            (passage room_15 entrance_47 down)
            (passage room_16 entrance_11 left)
            (passage room_16 entrance_12 down)
            (passage room_17 entrance_15 up)
            (passage room_17 entrance_16 down)
            (passage room_18 entrance_40 up)
            (passage room_18 entrance_41 left)
            (passage room_21 entrance_19 up)
            (passage room_21 entrance_20 right)
            (passage room_22 entrance_51 right)
            (passage room_22 entrance_52 left)
            (passage room_23 entrance_31 up)
            (passage room_23 entrance_32 left)
            (passage room_25 entrance_55 right)
            (passage room_25 entrance_56 down)
            (passage room_26 entrance_37 left)
            (passage room_28 entrance_17 up)
            (passage room_28 entrance_18 down)
            (passage room_28 entrance_34 right)
            (passage room_29 entrance_29 up)
            (passage room_29 entrance_53 right)
            (passage room_29 entrance_54 left)
            (passage room_3 entrance_33 right)
            (passage room_30 entrance_23 left)
            (passage room_30 entrance_24 right)
            (passage room_34 entrance_42 right)
            (passage room_34 entrance_43 down)
            (passage room_34 entrance_50 left)
            (passage room_36 entrance_35 left)
            (passage room_36 entrance_36 right)
            (passage room_37 entrance_48 up)
            (passage room_38 entrance_44 up)
            (passage room_38 entrance_45 down)
            (passage room_39 entrance_25 left)
            (passage room_39 entrance_26 right)
            (passage room_4 entrance_57 up)
            (passage room_43 entrance_21 left)
            (passage room_43 entrance_22 right)
            (passage room_45 entrance_27 left)
            (passage room_45 entrance_28 down)
            (passage room_5 entrance_39 down)
            (passage room_8 entrance_10 right)
            (passage room_8 entrance_30 down)
            (passage room_8 entrance_38 up)
            (passage room_8 entrance_49 left)
            (passage room_9 entrance_8 right)
