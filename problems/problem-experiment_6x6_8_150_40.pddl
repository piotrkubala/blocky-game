(define (problem problem-experiment_6x6_8_150_40)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_10 entrance_20 right)
            (passage room_11 entrance_6 down)
            (passage room_11 entrance_7 up)
            (passage room_16 entrance_25 up)
            ...
            (passage room_20 entrance_43 right)
            (passage room_21 entrance_44 left)
            (passage room_22 entrance_30 right)
            (passage room_23 entrance_2 down)
            (passage room_23 entrance_3 up)
            (passage room_24 entrance_34 down)
            (passage room_24 entrance_35 up)
            (passage room_25 entrance_37 down)
            (passage room_25 entrance_38 up)
            (passage room_28 entrance_39 down)
            (passage room_29 entrance_1 up)
            (passage room_3 entrance_12 right)
            (passage room_3 entrance_13 left)
            (passage room_3 entrance_22 down)
            (passage room_31 entrance_40 up)
            (passage room_33 entrance_36 down)
            (passage room_34 entrance_32 down)
            (passage room_34 entrance_33 up)
            (passage room_4 entrance_10 right)
            (passage room_4 entrance_11 left)
            (passage room_5 entrance_8 down)
            (passage room_5 entrance_9 left)
            (passage room_8 entrance_17 left)
            (passage room_8 entrance_18 right)
            (passage room_9 entrance_21 left)
            (passage room_9 entrance_23 up)
            (passage room_9 entrance_24 down)
            (passage room_9 entrance_42 right))
        (:goal
            (escaped player))
)
