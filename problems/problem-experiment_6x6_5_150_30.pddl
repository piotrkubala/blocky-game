(define (problem problem-experiment_6x6_5_150_30)
    (:domain blocky-game)
        (:objects
            indigo - colour
            navy - colour
        ...
        (:init
            ...
            (contains room_31 key_violet)
            (contains room_34 key_pink)
            ...
            (passage room_1 entrance_21 right)
            (passage room_13 entrance_14 down)
            (passage room_13 entrance_15 right)
            (passage room_14 entrance_12 down)
            (passage room_14 entrance_13 up)
            ...
            (passage room_16 entrance_22 left)
            (passage room_18 entrance_26 up)
            ...
            (passage room_29 entrance_24 left)
            (passage room_31 entrance_28 up)
            ...
            (passage room_9 entrance_33 down))
        (:goal
            (escaped player))
)
