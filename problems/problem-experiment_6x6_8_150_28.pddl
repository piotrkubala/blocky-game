(define (problem problem-experiment_6x6_8_150_28)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (at room_8 place24)
            (at room_9 place25)
            (contains room_10 key_green)
            (contains room_11 key_blue)
            (contains room_23 key_beige)
            (contains room_24 key_navy)
            ...
            (passage room_18 entrance_35 up)
            (passage room_19 entrance_32 right)
            (passage room_19 entrance_33 up)
            ...
            (passage room_23 entrance_17 up)
            (passage room_24 entrance_24 down)
            (passage room_25 entrance_15 right)
            (passage room_25 entrance_16 down)
            (passage room_26 entrance_19 right)
            (passage room_27 entrance_18 left)
            (passage room_27 entrance_25 down)
            (passage room_27 entrance_38 right)
            (passage room_27 entrance_8 up)
            (passage room_28 entrance_40 down)
            (passage room_29 entrance_45 left)
            ...
            (passage room_32 entrance_36 up)
            (passage room_32 entrance_9 down)
            (passage room_33 entrance_39 left)
            (passage room_34 entrance_27 down)
            (passage room_34 entrance_28 left)
            (passage room_4 entrance_43 left)
            (passage room_4 entrance_44 right)
