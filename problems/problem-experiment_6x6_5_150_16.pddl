(define (problem problem-experiment_6x6_5_150_16)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_10 entrance_30 down)
            (passage room_11 entrance_4 down)
            ...
            (passage room_23 entrance_15 right)
            (passage room_23 entrance_16 left)
            (passage room_27 entrance_10 down)
            (passage room_27 entrance_9 right)
            (passage room_28 entrance_11 up)
            (passage room_28 entrance_12 down)
            (passage room_29 entrance_13 up)
