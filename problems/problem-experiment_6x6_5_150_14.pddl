(define (problem problem-experiment_6x6_5_150_14)
    (:domain blocky-game)
        (:objects
            blue - colour
            grey - colour
        ...
        (:init
            ...
            (passage room_16 entrance_22 right)
            ...
            (passage room_22 entrance_13 up)
            (passage room_22 entrance_20 right)
            (passage room_22 entrance_4 down)
            (passage room_22 entrance_5 left)
            (passage room_24 entrance_30 right)
            (passage room_24 entrance_31 left)
            (passage room_27 entrance_1 right)
            (passage room_28 entrance_2 left)
            (passage room_28 entrance_3 up)
            (passage room_29 entrance_10 down)
            (passage room_29 entrance_11 left)
            ...
            (passage room_32 entrance_15 down)
            (passage room_33 entrance_34 right)
            (passage room_34 entrance_14 down)
            (passage room_34 entrance_6 right)
            (passage room_34 entrance_7 up)
            (passage room_7 entrance_32 right)
            (passage room_7 entrance_33 left))
        (:goal
            (escaped player))
)
