(define (problem problem-experiment_6x6_9_150_12)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place25)
            (contains room_12 key_turquoise)
            (contains room_16 key_indigo)
            (contains room_28 main_exit)
            (contains room_29 key_grey)
            (contains room_3 key_green)
            (contains room_30 key_cyan)
            (contains room_31 key_beige)
            (contains room_33 terminal)
            (contains room_34 key_gold)
            (contains room_4 key_orange)
            (contains room_7 key_brown)
            (free place24)
            ...
            (has_door entrance_40 brown)
            (has_door entrance_41 brown)
            ...
            (passage room_10 entrance_34 up)
            (passage room_11 entrance_39 right)
            (passage room_11 entrance_40 down)
            (passage room_12 entrance_38 up)
            ...
            (passage room_18 entrance_22 down)
            ...
            (passage room_21 entrance_4 up)
            (passage room_21 entrance_5 down)
            (passage room_22 entrance_12 down)
            (passage room_22 entrance_13 left)
            (passage room_22 entrance_31 up)
            (passage room_24 entrance_16 right)
            (passage room_24 entrance_17 left)
            (passage room_24 entrance_43 down)
            ...
            (passage room_30 entrance_23 up)
            (passage room_31 entrance_24 right)
            (passage room_32 entrance_10 right)
            (passage room_32 entrance_11 up)
            (passage room_32 entrance_20 left)
            (passage room_33 entrance_19 down)
            (passage room_33 entrance_8 up)
            (passage room_33 entrance_9 left)
            (passage room_34 entrance_30 down)
            (passage room_4 entrance_36 left)
            (passage room_5 entrance_28 right)
            (passage room_5 entrance_29 up)
            (passage room_7 entrance_37 down)
            (passage room_9 entrance_25 down)
            (passage room_9 entrance_26 up)
            (passage room_9 entrance_35 right))
        (:goal
            (escaped player))
)
