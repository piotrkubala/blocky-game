(define (problem problem-experiment_6x6_8_150_12)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_16 key_green)
            (contains room_17 key_violet)
            (contains room_20 key_yellow)
            (contains room_22 main_exit)
            (contains room_24 key_blue)
            (contains room_28 key_turquoise)
            (contains room_3 terminal)
            (contains room_6 key_gold)
            (free place21)
            ...
            (passage room_10 entrance_2 down)
            (passage room_10 entrance_3 up)
            (passage room_12 entrance_24 up)
            (passage room_12 entrance_25 left)
            (passage room_13 entrance_21 up)
            (passage room_13 entrance_45 left)
            (passage room_13 entrance_46 right)
            (passage room_14 entrance_36 up)
            (passage room_14 entrance_37 down)
            (passage room_14 entrance_47 left)
            (passage room_15 entrance_39 left)
            (passage room_16 entrance_1 up)
            (passage room_17 entrance_28 up)
            (passage room_19 entrance_26 right)
            (passage room_19 entrance_27 down)
            (passage room_2 entrance_34 up)
            (passage room_2 entrance_35 down)
            (passage room_20 entrance_16 up)
            (passage room_21 entrance_10 right)
            (passage room_21 entrance_11 left)
            ...
            (passage room_27 entrance_33 left)
            (passage room_28 entrance_41 down)
            (passage room_28 entrance_43 left)
            (passage room_28 entrance_44 right)
            (passage room_29 entrance_19 right)
            (passage room_29 entrance_20 down)
            (passage room_3 entrance_17 down)
            (passage room_3 entrance_40 up)
            (passage room_3 entrance_8 right)
            (passage room_3 entrance_9 left)
            (passage room_31 entrance_22 up)
            (passage room_31 entrance_23 down)
            (passage room_31 entrance_29 left)
            (passage room_31 entrance_42 right)
            (passage room_4 entrance_6 right)
            (passage room_4 entrance_7 left)
            (passage room_5 entrance_18 up)
            (passage room_5 entrance_4 down)
            (passage room_5 entrance_5 left)
            (passage room_6 entrance_32 right)
            (passage room_9 entrance_12 right)
            (passage room_9 entrance_13 down))
        (:goal
            (escaped player))
)
