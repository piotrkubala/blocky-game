(define (problem problem-experiment_6x6_6_150_35)
    (:domain blocky-game)
        (:objects
            cyan - colour
            grey - colour
        ...
        (:init
            ...
            (passage room_0 entrance_10 right)
            (passage room_0 entrance_11 up)
            (passage room_1 entrance_37 down)
            (passage room_10 entrance_22 right)
            ...
            (passage room_14 entrance_16 left)
            (passage room_14 entrance_23 right)
            (passage room_16 entrance_4 down)
            (passage room_16 entrance_5 up)
            ...
            (passage room_22 entrance_2 right)
            (passage room_22 entrance_3 up)
            (passage room_23 entrance_1 left)
            (passage room_30 entrance_24 left)
            (passage room_30 entrance_25 up)
            (passage room_31 entrance_30 down)
            (passage room_32 entrance_35 down)
            (passage room_32 entrance_36 up)
            (passage room_33 entrance_26 down)
            (passage room_34 entrance_33 right)
            (passage room_34 entrance_34 up)
            (passage room_5 entrance_28 down)
            ...
            (passage room_7 entrance_18 down))
        (:goal
            (escaped player))
)
