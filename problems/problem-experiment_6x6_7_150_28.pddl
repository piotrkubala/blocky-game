(define (problem problem-experiment_6x6_7_150_28)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_32 entrance_14 left)
            ...
            (passage room_6 entrance_19 left)
