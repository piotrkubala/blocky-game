(define (problem problem-experiment_6x6_6_150_30)
    (:domain blocky-game)
        (:objects
            grey - colour
            indigo - colour
        ...
        (:init
            ...
            (passage room_10 entrance_24 up)
            (passage room_11 entrance_31 up)
            (passage room_12 entrance_32 down)
            (passage room_12 entrance_33 right)
            (passage room_13 entrance_49 right)
            (passage room_14 entrance_2 up)
            (passage room_14 entrance_3 down)
            (passage room_18 entrance_35 right)
            (passage room_18 entrance_36 left)
            ...
            (passage room_21 entrance_40 up)
            ...
            (passage room_26 entrance_45 up)
            (passage room_27 entrance_21 down)
            (passage room_27 entrance_22 up)
            (passage room_27 entrance_43 right)
            (passage room_28 entrance_16 left)
            ...
            (passage room_31 entrance_10 up)
            (passage room_31 entrance_26 left)
            (passage room_31 entrance_30 down)
            (passage room_32 entrance_18 left)
            (passage room_32 entrance_19 up)
            (passage room_6 entrance_27 right)
            (passage room_6 entrance_28 left)
            (passage room_6 entrance_46 down)
            (passage room_8 entrance_1 down)
            (passage room_9 entrance_37 right)
            (passage room_9 entrance_38 up))
        (:goal
            (escaped player))
)
