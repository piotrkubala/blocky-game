(define (problem problem-experiment_6x6_7_150_18)
    (:domain blocky-game)
        (:objects
            black - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_19 entrance_42 up)
            (passage room_20 entrance_34 right)
