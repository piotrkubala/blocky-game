(define (problem problem-experiment_5x5_6_150_16)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_21 entrance_15 left)
            (passage room_23 entrance_24 right)
            (passage room_3 entrance_6 right)
            (passage room_3 entrance_7 left)
