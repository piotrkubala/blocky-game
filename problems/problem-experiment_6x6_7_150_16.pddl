(define (problem problem-experiment_6x6_7_150_16)
    (:domain blocky-game)
        (:objects
            beige - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_10 entrance_21 right)
            ...
            (passage room_13 entrance_23 right)
            (passage room_13 entrance_24 down)
            (passage room_15 entrance_47 down)
            (passage room_16 entrance_19 up)
            (passage room_16 entrance_20 left)
            (passage room_16 entrance_39 down)
            (passage room_16 entrance_40 right)
            ...
            (passage room_21 entrance_29 right)
            ...
            (passage room_4 entrance_16 left)
            (passage room_5 entrance_14 down)
