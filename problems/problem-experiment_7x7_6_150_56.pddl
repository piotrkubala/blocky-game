(define (problem problem-experiment_7x7_6_150_56)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_10 entrance_31 up)
            (passage room_10 entrance_32 down)
            (passage room_12 entrance_29 right)
            (passage room_12 entrance_30 down)
            (passage room_13 entrance_38 right)
            ...
            (passage room_18 entrance_12 down)
            ...
            (passage room_25 entrance_10 down)
            (passage room_25 entrance_11 up)
            ...
            (passage room_37 entrance_2 down)
            (passage room_37 entrance_3 right)
            (passage room_38 entrance_4 left)
            (passage room_38 entrance_5 right)
            (passage room_39 entrance_6 left)
            (passage room_39 entrance_7 up)
            (passage room_4 entrance_24 right)
            (passage room_4 entrance_25 left)
            (passage room_40 entrance_20 up)
            (passage room_43 entrance_1 up)
