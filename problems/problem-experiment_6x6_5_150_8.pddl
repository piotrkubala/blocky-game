(define (problem problem-experiment_6x6_5_150_8)
    (:domain blocky-game)
        (:objects
            green - colour
            magenta - colour
        ...
        (:init
            ...
            (passage room_14 entrance_26 right)
            ...
            (passage room_16 entrance_9 right)
            (passage room_17 entrance_10 left)
            (passage room_17 entrance_11 down)
            (passage room_17 entrance_21 right)
            ...
            (passage room_28 entrance_15 left)
            (passage room_28 entrance_32 right)
            ...
            (passage room_31 entrance_19 up)
