(define (problem problem-experiment_7x7_6_150_43)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_25 key_gold)
            (contains room_28 main_exit)
            (contains room_31 key_beige)
            (contains room_34 key_cyan)
            (contains room_42 key_turquoise)
            (free place76)
            ...
            (passage room_14 entrance_27 right)
            (passage room_15 entrance_22 down)
            (passage room_15 entrance_23 right)
            (passage room_16 entrance_10 right)
            (passage room_17 entrance_8 right)
            (passage room_17 entrance_9 left)
            ...
            (passage room_23 entrance_17 left)
            (passage room_23 entrance_4 right)
            (passage room_23 entrance_5 up)
            (passage room_24 entrance_2 right)
            (passage room_24 entrance_3 left)
            (passage room_25 entrance_1 left)
            (passage room_26 entrance_12 up)
            (passage room_26 entrance_13 left)
            (passage room_28 entrance_42 down)
            (passage room_29 entrance_18 right)
            (passage room_29 entrance_19 left)
            (passage room_29 entrance_29 down)
            (passage room_29 entrance_41 up)
            (passage room_30 entrance_14 right)
            (passage room_30 entrance_15 left)
            (passage room_30 entrance_20 down)
            (passage room_31 entrance_16 right)
            (passage room_31 entrance_32 down)
            (passage room_31 entrance_33 up)
            (passage room_32 entrance_36 down)
            (passage room_32 entrance_37 up)
            (passage room_34 entrance_28 left)
            (passage room_35 entrance_38 down)
            (passage room_35 entrance_39 up)
            (passage room_38 entrance_34 down)
            (passage room_38 entrance_35 up)
            (passage room_40 entrance_24 left)
            (passage room_40 entrance_25 right)
            (passage room_42 entrance_21 up)
            (passage room_45 entrance_30 left)
            (passage room_45 entrance_31 up))
        (:goal
            (escaped player))
)
