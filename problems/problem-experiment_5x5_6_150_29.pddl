(define (problem problem-experiment_5x5_6_150_29)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_10 entrance_9 down)
            (passage room_11 entrance_20 down)
            (passage room_11 entrance_21 up)
            (passage room_12 entrance_27 right)
            (passage room_12 entrance_28 left)
            (passage room_13 entrance_18 down)
            (passage room_13 entrance_19 up)
            ...
            (passage room_19 entrance_12 up)
            (passage room_19 entrance_15 left)
            (passage room_2 entrance_29 right)
            (passage room_21 entrance_37 right)
            (passage room_22 entrance_25 right)
            (passage room_23 entrance_38 right)
            (passage room_3 entrance_33 right)
            (passage room_3 entrance_34 down)
            (passage room_5 entrance_26 left)
            (passage room_5 entrance_6 right)
            (passage room_5 entrance_7 down)
            (passage room_6 entrance_22 down)
            (passage room_6 entrance_23 up)
            (passage room_6 entrance_4 right)
            (passage room_6 entrance_5 left)
            (passage room_7 entrance_13 down)
            (passage room_7 entrance_2 right)
            (passage room_7 entrance_3 left)
            (passage room_8 entrance_1 left)
            (passage room_9 entrance_35 up)
