(define (problem problem-experiment_6x6_9_150_40)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_10 key_cyan)
            (contains room_12 key_green)
            (contains room_15 key_brown)
            (contains room_16 key_turquoise)
            (contains room_19 key_orange)
            (contains room_2 key_white)
            (contains room_24 key_pink)
            (contains room_25 key_yellow)
            ...
            (has_door entrance_54 pink)
            (has_door entrance_55 pink)
            (has_door entrance_56 pink)
            (has_door entrance_57 turquoise)
            ...
            (passage room_0 entrance_40 down)
            (passage room_0 entrance_41 left)
            (passage room_0 entrance_50 up)
            (passage room_1 entrance_24 down)
            (passage room_1 entrance_25 up)
            (passage room_1 entrance_47 right)
            (passage room_1 entrance_48 left)
            (passage room_10 entrance_58 down)
            (passage room_11 entrance_7 up)
            (passage room_11 entrance_8 left)
            (passage room_12 entrance_21 left)
            ...
            (passage room_14 entrance_49 up)
            (passage room_15 entrance_1 up)
            (passage room_16 entrance_55 down)
            (passage room_17 entrance_51 down)
            (passage room_17 entrance_52 up)
            (passage room_19 entrance_57 left)
            (passage room_2 entrance_19 down)
            (passage room_2 entrance_22 left)
            (passage room_20 entrance_59 up)
            (passage room_20 entrance_60 left)
            (passage room_21 entrance_38 right)
            (passage room_21 entrance_39 up)
            (passage room_22 entrance_34 right)
            (passage room_22 entrance_35 left)
            (passage room_23 entrance_26 down)
            (passage room_23 entrance_27 up)
            (passage room_24 entrance_46 down)
            (passage room_25 entrance_17 right)
            (passage room_25 entrance_20 down)
            (passage room_25 entrance_23 up)
            (passage room_27 entrance_11 up)
            (passage room_27 entrance_12 left)
            (passage room_28 entrance_61 right)
            (passage room_3 entrance_28 down)
            (passage room_3 entrance_29 left)
            (passage room_30 entrance_44 down)
            (passage room_30 entrance_45 up)
            (passage room_32 entrance_15 right)
            (passage room_32 entrance_16 left)
            (passage room_32 entrance_53 down)
            (passage room_32 entrance_54 up)
            (passage room_33 entrance_10 down)
            (passage room_33 entrance_9 right)
            (passage room_34 entrance_13 right)
            (passage room_34 entrance_14 left)
            (passage room_4 entrance_3 up)
            (passage room_4 entrance_4 down)
            (passage room_5 entrance_5 up)
            (passage room_5 entrance_6 down)
            (passage room_7 entrance_42 right)
            (passage room_7 entrance_43 up)
            (passage room_8 entrance_32 right)
            (passage room_9 entrance_18 up)
            (passage room_9 entrance_2 down)
            (passage room_9 entrance_33 left)
            (passage room_9 entrance_56 right))
        (:goal
            (escaped player))
)
