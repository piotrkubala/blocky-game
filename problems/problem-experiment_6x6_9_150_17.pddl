(define (problem problem-experiment_6x6_9_150_17)
    (:domain blocky-game)
        (:objects
            beige - colour
            blue - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_0 key_brown)
            (contains room_1 main_exit)
            (contains room_16 terminal)
            (contains room_18 key_red)
            (contains room_2 key_cyan)
            (contains room_21 key_grey)
            (contains room_23 key_navy)
            (contains room_27 key_indigo)
            (contains room_29 key_beige)
            (contains room_33 key_white)
            (contains room_8 key_blue)
            (free place26)
            ...
            (is key_red red)
            (is key_white white)
            (passage room_0 entrance_29 left)
            (passage room_1 entrance_64 down)
            (passage room_10 entrance_27 left)
            (passage room_10 entrance_28 right)
            (passage room_11 entrance_38 up)
            (passage room_11 entrance_39 right)
            (passage room_11 entrance_43 down)
            (passage room_12 entrance_2 down)
            (passage room_12 entrance_3 right)
            (passage room_13 entrance_21 down)
            (passage room_13 entrance_22 up)
            (passage room_13 entrance_4 left)
            (passage room_13 entrance_5 right)
            (passage room_14 entrance_6 left)
            (passage room_14 entrance_7 right)
            (passage room_15 entrance_59 up)
            (passage room_15 entrance_8 left)
            (passage room_15 entrance_9 right)
            (passage room_16 entrance_10 left)
            (passage room_16 entrance_11 up)
            (passage room_16 entrance_30 down)
            (passage room_16 entrance_36 right)
            (passage room_18 entrance_1 up)
            (passage room_19 entrance_25 down)
            (passage room_19 entrance_26 right)
            (passage room_19 entrance_47 left)
            (passage room_2 entrance_53 left)
            (passage room_20 entrance_12 down)
            (passage room_20 entrance_13 up)
            (passage room_20 entrance_42 right)
            (passage room_21 entrance_35 left)
            (passage room_23 entrance_48 left)
            (passage room_23 entrance_58 right)
            (passage room_24 entrance_17 left)
            (passage room_24 entrance_18 right)
            (passage room_24 entrance_44 up)
            (passage room_24 entrance_45 down)
            (passage room_26 entrance_15 down)
            (passage room_26 entrance_16 right)
            (passage room_26 entrance_37 left)
            (passage room_26 entrance_41 up)
            (passage room_27 entrance_14 down)
            (passage room_28 entrance_19 left)
            (passage room_28 entrance_20 up)
            (passage room_29 entrance_40 left)
            (passage room_29 entrance_49 up)
            (passage room_29 entrance_50 down)
            (passage room_29 entrance_54 right)
            (passage room_3 entrance_62 down)
            (passage room_3 entrance_63 up)
            (passage room_30 entrance_60 down)
            (passage room_30 entrance_61 up)
            (passage room_33 entrance_46 right)
            (passage room_34 entrance_51 up)
            (passage room_34 entrance_52 down)
            (passage room_4 entrance_31 up)
            (passage room_4 entrance_32 down)
            (passage room_5 entrance_33 up)
            (passage room_5 entrance_34 right)
            (passage room_6 entrance_55 up)
            (passage room_6 entrance_56 down)
            (passage room_8 entrance_57 up)
            (passage room_9 entrance_23 down)
            (passage room_9 entrance_24 up))
        (:goal
            (escaped player))
)
