(define (problem problem-experiment_6x6_8_150_10)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_1 entrance_31 down)
            (passage room_1 entrance_32 left)
            (passage room_1 entrance_33 right)
            (passage room_10 entrance_6 left)
            (passage room_10 entrance_7 down)
            (passage room_13 entrance_30 up)
            (passage room_13 entrance_41 left)
            (passage room_13 entrance_42 down)
            (passage room_14 entrance_49 up)
            (passage room_14 entrance_50 right)
            (passage room_14 entrance_51 left)
            (passage room_15 entrance_1 right)
            (passage room_16 entrance_2 left)
            (passage room_16 entrance_3 down)
            (passage room_17 entrance_47 up)
            (passage room_18 entrance_36 down)
            (passage room_18 entrance_37 right)
            (passage room_19 entrance_23 right)
            ...
            (passage room_22 entrance_20 left)
            (passage room_22 entrance_4 up)
            (passage room_22 entrance_48 down)
            (passage room_22 entrance_5 right)
            (passage room_23 entrance_43 up)
            (passage room_23 entrance_44 down)
            ...
            (passage room_31 entrance_45 up)
            (passage room_31 entrance_46 down)
            (passage room_33 entrance_38 left)
            (passage room_33 entrance_39 right)
            (passage room_34 entrance_19 left)
            (passage room_4 entrance_52 right)
            (passage room_6 entrance_10 up)
            (passage room_6 entrance_11 right)
            (passage room_6 entrance_27 down)
            (passage room_7 entrance_12 left)
            (passage room_7 entrance_13 right)
            (passage room_8 entrance_21 right)
            (passage room_8 entrance_22 left)
            (passage room_8 entrance_8 up)
            (passage room_8 entrance_9 down)
