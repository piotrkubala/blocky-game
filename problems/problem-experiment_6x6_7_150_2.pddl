(define (problem problem-experiment_6x6_7_150_2)
    (:domain blocky-game)
        (:objects
            brown - colour
            magenta - colour
        ...
        (:init
            ...
            (passage room_0 entrance_21 down)
            ...
            (passage room_18 entrance_12 right)
            ...
            (passage room_19 entrance_37 up)
            (passage room_2 entrance_30 right)
            (passage room_20 entrance_8 up)
            (passage room_20 entrance_9 left)
            (passage room_21 entrance_32 down)
            (passage room_22 entrance_28 right)
            (passage room_23 entrance_35 left)
            (passage room_23 entrance_36 right)
            (passage room_24 entrance_16 up)
            (passage room_29 entrance_24 up)
            (passage room_29 entrance_25 down)
            ...
            (passage room_32 entrance_33 left)
