(define (problem problem-experiment_6x6_8_150_13)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_27 entrance_41 up)
            (passage room_27 entrance_42 down)
            (passage room_28 entrance_45 left)
            (passage room_3 entrance_35 up)
            (passage room_3 entrance_36 down)
            (passage room_30 entrance_12 up)
            (passage room_30 entrance_13 right)
            (passage room_30 entrance_33 down)
            (passage room_30 entrance_47 left)
            (passage room_31 entrance_50 up)
            (passage room_32 entrance_4 right)
            (passage room_32 entrance_5 up)
            (passage room_33 entrance_2 right)
            (passage room_33 entrance_3 left)
            (passage room_34 entrance_1 left)
            (passage room_4 entrance_48 right)
            (passage room_6 entrance_23 left)
            (passage room_6 entrance_24 down)
            (passage room_6 entrance_43 up)
            (passage room_6 entrance_44 right)
            (passage room_7 entrance_25 up)
            (passage room_7 entrance_26 right)
            (passage room_7 entrance_34 down)
            (passage room_8 entrance_27 left)
            (passage room_8 entrance_28 right)
            (passage room_9 entrance_29 left)
            (passage room_9 entrance_30 right))
        (:goal
            (escaped player))
)
