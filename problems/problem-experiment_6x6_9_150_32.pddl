(define (problem problem-experiment_6x6_9_150_32)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (at room_8 place23)
            (at room_9 place24)
            (contains room_1 key_gold)
            (contains room_11 terminal)
            (contains room_12 key_yellow)
            (contains room_13 key_magenta)
            (contains room_18 main_exit)
            (contains room_22 key_green)
            (contains room_26 key_pink)
            (contains room_28 key_indigo)
            (contains room_33 key_cyan)
            (contains room_7 key_turquoise)
            (contains room_9 key_white)
            (free place65)
            ...
            (has_door entrance_55 yellow)
            (has_door entrance_56 yellow)
            ...
            (passage room_0 entrance_43 up)
            (passage room_0 entrance_44 right)
            (passage room_0 entrance_55 down)
            (passage room_1 entrance_20 down)
            (passage room_11 entrance_13 up)
            (passage room_11 entrance_40 left)
            (passage room_11 entrance_51 right)
            (passage room_11 entrance_6 down)
            (passage room_12 entrance_45 up)
            (passage room_12 entrance_58 left)
            (passage room_12 entrance_59 right)
            (passage room_13 entrance_29 down)
            (passage room_17 entrance_23 right)
            (passage room_17 entrance_24 left)
            (passage room_17 entrance_4 down)
            (passage room_17 entrance_5 up)
            (passage room_18 entrance_63 left)
            (passage room_19 entrance_56 up)
            (passage room_19 entrance_57 right)
            (passage room_2 entrance_16 down)
            (passage room_2 entrance_17 up)
            (passage room_20 entrance_53 left)
            (passage room_20 entrance_54 down)
            (passage room_22 entrance_1 right)
            (passage room_23 entrance_11 down)
            (passage room_23 entrance_2 left)
            (passage room_23 entrance_3 up)
            (passage room_24 entrance_48 up)
            (passage room_24 entrance_49 right)
            (passage room_24 entrance_60 left)
            (passage room_24 entrance_61 down)
            (passage room_26 entrance_12 up)
            (passage room_27 entrance_36 right)
            (passage room_27 entrance_37 left)
            (passage room_27 entrance_41 down)
            (passage room_28 entrance_32 up)
            (passage room_29 entrance_21 down)
            (passage room_29 entrance_22 left)
            (passage room_29 entrance_42 up)
            (passage room_3 entrance_18 down)
            (passage room_3 entrance_19 up)
            (passage room_30 entrance_27 right)
            (passage room_30 entrance_28 up)
            (passage room_32 entrance_30 up)
            (passage room_32 entrance_31 down)
            (passage room_33 entrance_50 left)
            (passage room_34 entrance_34 right)
            (passage room_34 entrance_35 left)
            (passage room_4 entrance_25 right)
            (passage room_4 entrance_26 left)
            (passage room_4 entrance_7 up)
            (passage room_4 entrance_8 down)
            (passage room_5 entrance_10 down)
            (passage room_5 entrance_38 right)
            (passage room_5 entrance_47 left)
            (passage room_5 entrance_9 up)
            (passage room_7 entrance_39 right)
            (passage room_7 entrance_62 up)
            (passage room_8 entrance_14 down)
            (passage room_8 entrance_15 up)
            (passage room_8 entrance_33 left)
            (passage room_8 entrance_46 right)
            (passage room_9 entrance_52 left))
        (:goal
            (escaped player))
)
