(define (problem problem-experiment_6x6_8_150_6)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_18 entrance_28 right)
            (passage room_19 entrance_36 down)
            ...
            (passage room_34 entrance_20 down)
