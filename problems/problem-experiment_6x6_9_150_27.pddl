(define (problem problem-experiment_6x6_9_150_27)
    (:domain blocky-game)
        (:objects
            beige - colour
            brown - colour
        ...
        (:init
            ...
            (contains room_13 key_yellow)
            (contains room_14 key_purple)
            (contains room_24 key_indigo)
            (contains room_3 terminal)
            (contains room_31 key_red)
            (contains room_32 key_gold)
            (contains room_33 key_navy)
            (contains room_5 key_beige)
            (contains room_6 key_brown)
            (contains room_9 key_orange)
            (free place45)
            ...
            (has_door entrance_48 brown)
            (has_door entrance_49 brown)
            (has_door entrance_5 orange)
            (has_door entrance_50 brown)
            (has_door entrance_51 yellow)
            (has_door entrance_52 yellow)
            ...
            (passage room_1 entrance_57 down)
            (passage room_1 entrance_58 left)
            (passage room_10 entrance_17 up)
            (passage room_10 entrance_18 down)
            (passage room_11 entrance_34 down)
            (passage room_11 entrance_50 right)
            (passage room_11 entrance_6 up)
            (passage room_11 entrance_7 left)
            (passage room_12 entrance_62 down)
            (passage room_13 entrance_32 down)
            (passage room_13 entrance_44 right)
            (passage room_14 entrance_26 up)
            (passage room_14 entrance_35 right)
            (passage room_15 entrance_10 up)
            (passage room_15 entrance_11 left)
            (passage room_17 entrance_38 right)
            (passage room_17 entrance_39 left)
            (passage room_17 entrance_60 down)
            (passage room_17 entrance_61 up)
            (passage room_18 entrance_28 down)
            (passage room_18 entrance_29 up)
            (passage room_19 entrance_14 right)
            (passage room_19 entrance_15 left)
            (passage room_2 entrance_40 right)
            (passage room_2 entrance_41 left)
            (passage room_2 entrance_56 up)
            (passage room_21 entrance_24 up)
            (passage room_21 entrance_25 down)
            (passage room_22 entrance_36 down)
            (passage room_22 entrance_37 left)
            (passage room_22 entrance_54 right)
            (passage room_23 entrance_45 up)
            (passage room_23 entrance_46 left)
            (passage room_23 entrance_51 down)
            (passage room_24 entrance_16 right)
            (passage room_25 entrance_12 right)
            (passage room_25 entrance_13 left)
            (passage room_26 entrance_30 down)
            (passage room_26 entrance_31 up)
            (passage room_26 entrance_49 left)
            (passage room_27 entrance_22 up)
            (passage room_27 entrance_23 down)
            (passage room_28 entrance_20 up)
            (passage room_28 entrance_21 down)
            (passage room_28 entrance_33 right)
            (passage room_3 entrance_2 down)
            (passage room_3 entrance_27 up)
            (passage room_3 entrance_3 left)
            (passage room_30 entrance_52 up)
            (passage room_30 entrance_53 left)
            (passage room_31 entrance_55 right)
            (passage room_31 entrance_59 up)
            (passage room_32 entrance_48 right)
            (passage room_33 entrance_42 right)
            (passage room_4 entrance_8 right)
            (passage room_4 entrance_9 down)
            (passage room_5 entrance_19 up)
            (passage room_6 entrance_43 right)
            (passage room_6 entrance_47 left)
            (passage room_8 entrance_4 right)
            (passage room_8 entrance_5 down)
            (passage room_9 entrance_1 up))
        (:goal
            (escaped player))
)
