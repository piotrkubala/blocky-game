(define (problem problem-experiment_6x6_6_150_12)
    (:domain blocky-game)
        (:objects
            gold - colour
            grey - colour
        ...
        (:init
            ...
            (contains room_1 key_yellow)
            (contains room_14 key_grey)
            ...
            (passage room_1 entrance_21 down)
            (passage room_10 entrance_25 down)
            (passage room_10 entrance_26 up)
            (passage room_12 entrance_30 down)
            (passage room_12 entrance_31 right)
            (passage room_14 entrance_15 right)
            (passage room_14 entrance_19 down)
            (passage room_14 entrance_20 up)
            (passage room_16 entrance_29 left)
            (passage room_21 entrance_43 left)
            (passage room_21 entrance_44 right)
            (passage room_22 entrance_13 right)
            (passage room_22 entrance_14 left)
            (passage room_22 entrance_16 up)
            (passage room_22 entrance_48 down)
            (passage room_23 entrance_2 down)
            (passage room_23 entrance_3 right)
            (passage room_23 entrance_37 up)
            (passage room_24 entrance_4 left)
            (passage room_24 entrance_5 right)
            (passage room_25 entrance_17 down)
            (passage room_25 entrance_18 up)
            ...
            (passage room_28 entrance_22 up)
            (passage room_29 entrance_1 up)
            (passage room_30 entrance_32 left)
            (passage room_30 entrance_33 right)
            (passage room_31 entrance_45 left)
            (passage room_32 entrance_36 left)
            (passage room_4 entrance_27 down)
            (passage room_4 entrance_28 right)
            (passage room_4 entrance_42 left)
            (passage room_5 entrance_46 right)
            (passage room_5 entrance_47 up)
            (passage room_6 entrance_40 left)
            (passage room_6 entrance_41 right)
            (passage room_7 entrance_38 down)
