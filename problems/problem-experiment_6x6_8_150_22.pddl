(define (problem problem-experiment_6x6_8_150_22)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (is key_white white)
            (passage room_0 entrance_42 down)
            (passage room_0 entrance_43 up)
            (passage room_1 entrance_14 down)
            (passage room_1 entrance_15 right)
            (passage room_10 entrance_18 left)
            (passage room_10 entrance_19 right)
            (passage room_11 entrance_40 right)
            (passage room_11 entrance_41 up)
            (passage room_12 entrance_8 down)
            ...
            (passage room_19 entrance_23 up)
            (passage room_2 entrance_16 left)
            (passage room_2 entrance_17 right)
            (passage room_20 entrance_24 down)
            (passage room_21 entrance_25 left)
            (passage room_21 entrance_39 right)
            (passage room_24 entrance_21 left)
            (passage room_24 entrance_4 right)
            (passage room_24 entrance_5 up)
            (passage room_25 entrance_2 down)
            (passage room_25 entrance_26 up)
            (passage room_25 entrance_3 left)
            (passage room_26 entrance_36 down)
            (passage room_27 entrance_31 down)
            (passage room_27 entrance_32 right)
            (passage room_27 entrance_45 left)
            (passage room_28 entrance_46 right)
            (passage room_28 entrance_47 up)
            (passage room_29 entrance_53 down)
            (passage room_3 entrance_37 left)
            (passage room_31 entrance_1 up)
            (passage room_32 entrance_34 right)
            (passage room_32 entrance_35 up)
            (passage room_33 entrance_50 right)
            (passage room_33 entrance_51 left)
            (passage room_34 entrance_27 down)
            ...
            (passage room_6 entrance_13 up)
            (passage room_6 entrance_52 right)
            (passage room_7 entrance_29 down)
            (passage room_7 entrance_30 up)
            (passage room_8 entrance_44 down)
            (passage room_9 entrance_48 down)
            (passage room_9 entrance_49 left))
        (:goal
            (escaped player))
)
