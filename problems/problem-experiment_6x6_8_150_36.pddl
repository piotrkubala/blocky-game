(define (problem problem-experiment_6x6_8_150_36)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (is key_white white)
            (passage room_0 entrance_31 down)
            (passage room_0 entrance_32 left)
            (passage room_0 entrance_38 up)
            (passage room_1 entrance_12 down)
            (passage room_1 entrance_25 left)
            (passage room_1 entrance_27 up)
            (passage room_1 entrance_35 right)
            (passage room_10 entrance_30 left)
            ...
            (passage room_14 entrance_6 right)
            (passage room_14 entrance_7 left)
            (passage room_15 entrance_4 down)
            (passage room_15 entrance_5 left)
            (passage room_16 entrance_13 up)
            (passage room_16 entrance_14 right)
            (passage room_17 entrance_28 down)
            (passage room_17 entrance_29 right)
            (passage room_2 entrance_16 up)
            (passage room_2 entrance_17 right)
            (passage room_2 entrance_39 down)
            ...
            (passage room_23 entrance_41 down)
            (passage room_25 entrance_37 up)
            (passage room_26 entrance_34 up)
