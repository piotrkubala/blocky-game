(define (problem problem-experiment_5x5_6_150_40)
    (:domain blocky-game)
        (:objects
            blue - colour
            magenta - colour
        ...
        (:init
            ...
            (passage room_15 entrance_2 down)
            ...
            (passage room_7 entrance_24 left)
            (passage room_8 entrance_10 left)
