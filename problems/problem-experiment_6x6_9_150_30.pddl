(define (problem problem-experiment_6x6_9_150_30)
    (:domain blocky-game)
        (:objects
            black - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_0 entrance_30 right)
            (passage room_0 entrance_31 left)
            (passage room_0 entrance_33 down)
            (passage room_0 entrance_34 up)
            (passage room_10 entrance_14 left)
            (passage room_10 entrance_37 down)
            (passage room_10 entrance_38 right)
            (passage room_10 entrance_42 up)
            (passage room_11 entrance_35 left)
            (passage room_11 entrance_36 up)
            (passage room_12 entrance_20 right)
            ...
            (passage room_14 entrance_32 right)
            (passage room_15 entrance_47 left)
            (passage room_15 entrance_48 right)
            (passage room_15 entrance_8 down)
            (passage room_15 entrance_9 up)
            (passage room_16 entrance_26 down)
            (passage room_16 entrance_27 up)
            (passage room_17 entrance_15 left)
            (passage room_17 entrance_41 right)
            ...
            (passage room_2 entrance_11 up)
            (passage room_20 entrance_24 right)
            (passage room_20 entrance_25 up)
            ...
            (passage room_23 entrance_5 up)
            (passage room_24 entrance_40 up)
            (passage room_27 entrance_43 down)
            (passage room_27 entrance_44 up)
            (passage room_28 entrance_46 down)
            (passage room_29 entrance_2 down)
            (passage room_29 entrance_3 up)
            (passage room_3 entrance_39 left)
            (passage room_3 entrance_49 right)
            (passage room_30 entrance_29 up)
            ...
            (passage room_7 entrance_18 right)
            (passage room_7 entrance_19 left)
            (passage room_7 entrance_23 down))
        (:goal
            (escaped player))
)
