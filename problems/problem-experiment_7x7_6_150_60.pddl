(define (problem problem-experiment_7x7_6_150_60)
    (:domain blocky-game)
        (:objects
            brown - colour
            grey - colour
        ...
        (:init
            ...
            (contains room_26 key_white)
            (contains room_36 key_pink)
            (contains room_40 terminal)
            (contains room_44 key_brown)
            (contains room_9 key_violet)
            (free place71)
            ...
            (passage room_33 entrance_25 right)
            (passage room_33 entrance_26 left)
            (passage room_34 entrance_10 up)
            (passage room_34 entrance_9 down)
            (passage room_36 entrance_27 right)
            (passage room_38 entrance_2 down)
            (passage room_38 entrance_3 right)
            (passage room_39 entrance_4 left)
            (passage room_39 entrance_5 right)
            (passage room_40 entrance_16 up)
            (passage room_40 entrance_36 right)
            (passage room_40 entrance_6 left)
            (passage room_41 entrance_30 left)
            (passage room_41 entrance_7 right)
            (passage room_41 entrance_8 up)
            (passage room_42 entrance_28 right)
            (passage room_42 entrance_29 left)
            (passage room_43 entrance_17 down)
            (passage room_43 entrance_18 right)
            (passage room_44 entrance_1 up)
            (passage room_46 entrance_33 down)
            (passage room_46 entrance_34 left)
            (passage room_6 entrance_45 right)
            (passage room_6 entrance_46 left)
            (passage room_9 entrance_24 down)
