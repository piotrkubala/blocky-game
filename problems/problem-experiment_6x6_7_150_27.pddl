(define (problem problem-experiment_6x6_7_150_27)
    (:domain blocky-game)
        (:objects
            beige - colour
            grey - colour
        ...
        (:init
            ...
            (passage room_0 entrance_27 right)
            (passage room_1 entrance_43 up)
            (passage room_10 entrance_40 left)
            (passage room_11 entrance_41 up)
            (passage room_11 entrance_42 down)
            ...
            (passage room_14 entrance_8 left)
            (passage room_14 entrance_9 right)
            (passage room_15 entrance_10 left)
            (passage room_15 entrance_11 right)
