(define (problem problem-experiment_7x7_6_150_41)
    (:domain blocky-game)
        (:objects
            grey - colour
            indigo - colour
        ...
        (:init
            ...
            (passage room_0 entrance_52 right)
            (passage room_1 entrance_53 left)
            ...
            (passage room_44 entrance_50 left)
            (passage room_44 entrance_51 right)
