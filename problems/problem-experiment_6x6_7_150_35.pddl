(define (problem problem-experiment_6x6_7_150_35)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (at room_8 place24)
            (at room_9 place25)
            (contains room_12 key_grey)
            (contains room_15 key_white)
            (contains room_22 key_black)
            (contains room_26 key_yellow)
            (contains room_27 key_blue)
            (contains room_28 key_cyan)
            (contains room_29 key_navy)
            ...
            (passage room_10 entrance_50 left)
            (passage room_10 entrance_51 down)
            (passage room_10 entrance_57 right)
            (passage room_12 entrance_48 up)
            (passage room_13 entrance_44 right)
            (passage room_13 entrance_45 down)
            (passage room_14 entrance_36 right)
            (passage room_14 entrance_37 left)
            (passage room_15 entrance_18 down)
            (passage room_16 entrance_29 right)
            (passage room_16 entrance_30 left)
            (passage room_18 entrance_12 left)
            (passage room_18 entrance_13 up)
            (passage room_19 entrance_14 down)
            (passage room_19 entrance_15 right)
            (passage room_20 entrance_16 left)
            (passage room_20 entrance_17 up)
            (passage room_21 entrance_21 down)
            (passage room_21 entrance_22 up)
            (passage room_22 entrance_54 left)
            (passage room_23 entrance_40 right)
            (passage room_23 entrance_41 left)
            (passage room_24 entrance_8 left)
            (passage room_24 entrance_9 right)
            (passage room_25 entrance_10 left)
            (passage room_25 entrance_11 right)
            (passage room_26 entrance_1 down)
            (passage room_27 entrance_19 down)
            (passage room_27 entrance_20 up)
            (passage room_27 entrance_35 left)
            (passage room_28 entrance_25 down)
            (passage room_28 entrance_26 left)
            (passage room_28 entrance_52 up)
            (passage room_28 entrance_53 right)
            (passage room_29 entrance_33 down)
            (passage room_29 entrance_38 right)
            (passage room_29 entrance_39 left)
            (passage room_29 entrance_49 up)
            (passage room_3 entrance_55 right)
            (passage room_3 entrance_56 left)
            (passage room_30 entrance_6 down)
            (passage room_30 entrance_7 right)
            (passage room_32 entrance_2 up)
            (passage room_32 entrance_3 right)
            (passage room_33 entrance_34 down)
            (passage room_33 entrance_4 left)
            (passage room_33 entrance_5 up)
            (passage room_34 entrance_23 down)
            (passage room_34 entrance_24 up)
            (passage room_34 entrance_27 right)
            (passage room_34 entrance_28 left)
            (passage room_4 entrance_31 right)
            (passage room_4 entrance_32 up)
            (passage room_6 entrance_42 right)
            (passage room_6 entrance_43 left)
            (passage room_9 entrance_58 right))
        (:goal
            (escaped player))
)
