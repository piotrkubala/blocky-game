(define (problem problem-experiment_6x6_7_150_20)
    (:domain blocky-game)
        (:objects
            gold - colour
            grey - colour
        ...
        (:init
            ...
            (passage room_7 entrance_22 right)
            (passage room_8 entrance_41 right)
            (passage room_8 entrance_42 left)
