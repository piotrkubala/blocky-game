(define (problem problem-experiment_7x7_6_150_58)
    (:domain blocky-game)
        (:objects
            brown - colour
            green - colour
        ...
        (:init
            ...
            (contains room_31 key_purple)
            (contains room_33 main_exit)
            (contains room_34 key_grey)
            (contains room_37 key_turquoise)
            (contains room_44 key_violet)
            ...
            (passage room_11 entrance_38 left)
            (passage room_11 entrance_39 right)
            (passage room_15 entrance_13 down)
            (passage room_15 entrance_14 up)
            (passage room_16 entrance_11 down)
            (passage room_16 entrance_12 up)
            (passage room_20 entrance_25 left)
            (passage room_20 entrance_26 down)
            (passage room_23 entrance_10 up)
            (passage room_23 entrance_9 down)
            (passage room_25 entrance_34 left)
            (passage room_26 entrance_32 left)
            (passage room_26 entrance_33 right)
            (passage room_28 entrance_7 down)
            (passage room_28 entrance_8 up)
            (passage room_30 entrance_20 left)
            (passage room_30 entrance_5 right)
            (passage room_30 entrance_6 up)
            (passage room_31 entrance_27 up)
            (passage room_33 entrance_44 left)
            (passage room_34 entrance_29 right)
            (passage room_34 entrance_36 down)
            (passage room_37 entrance_28 right)
            (passage room_37 entrance_37 left)
            (passage room_38 entrance_23 left)
            (passage room_38 entrance_24 right)
            (passage room_39 entrance_17 left)
            (passage room_39 entrance_18 up)
            (passage room_39 entrance_31 right)
            (passage room_4 entrance_42 left)
            (passage room_4 entrance_43 right)
            (passage room_41 entrance_40 left)
            (passage room_41 entrance_41 right)
            (passage room_44 entrance_1 right)
            (passage room_45 entrance_19 down)
            (passage room_45 entrance_2 left)
            (passage room_45 entrance_3 right)
            (passage room_46 entrance_16 right)
            (passage room_46 entrance_30 down)
            (passage room_46 entrance_35 up)
            (passage room_46 entrance_4 left)
            (passage room_47 entrance_21 left)
            (passage room_47 entrance_22 right)
            (passage room_9 entrance_15 down))
        (:goal
            (escaped player))
)
