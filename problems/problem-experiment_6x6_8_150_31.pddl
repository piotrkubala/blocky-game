(define (problem problem-experiment_6x6_8_150_31)
    (:domain blocky-game)
        (:objects
            blue - colour
            brown - colour
        ...
        (:init
            ...
            (passage room_21 entrance_19 left)
            (passage room_22 entrance_24 down)
            (passage room_23 entrance_21 down)
            ...
            (passage room_29 entrance_17 right)
            (passage room_30 entrance_6 right)
            (passage room_30 entrance_7 down)
            (passage room_31 entrance_32 down)
            (passage room_31 entrance_35 left)
            (passage room_33 entrance_23 left)
            (passage room_5 entrance_46 left)
            (passage room_6 entrance_36 right)
            (passage room_6 entrance_37 up)
            (passage room_7 entrance_31 left)
            (passage room_8 entrance_42 down)
            (passage room_8 entrance_43 up))
        (:goal
            (escaped player))
)
