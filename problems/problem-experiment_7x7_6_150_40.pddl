(define (problem problem-experiment_7x7_6_150_40)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (contains room_13 key_black)
            (contains room_21 main_exit)
            ...
            (is key_pink pink)
            (is key_white white)
            (passage room_0 entrance_47 up)
            (passage room_0 entrance_48 down)
            (passage room_1 entrance_37 left)
            (passage room_1 entrance_38 right)
            (passage room_10 entrance_4 right)
            (passage room_10 entrance_5 down)
            (passage room_11 entrance_2 right)
            (passage room_11 entrance_3 left)
            (passage room_12 entrance_1 left)
            (passage room_13 entrance_41 down)
            (passage room_14 entrance_43 up)
            (passage room_14 entrance_44 down)
            (passage room_15 entrance_25 left)
            (passage room_15 entrance_26 up)
            (passage room_16 entrance_6 up)
            (passage room_16 entrance_7 down)
            (passage room_21 entrance_49 up)
            (passage room_22 entrance_23 down)
            (passage room_22 entrance_24 right)
            (passage room_23 entrance_8 up)
            (passage room_23 entrance_9 down)
            (passage room_24 entrance_21 down)
            (passage room_24 entrance_36 right)
            (passage room_27 entrance_45 up)
            (passage room_27 entrance_46 down)
            (passage room_29 entrance_34 down)
            ...
            (passage room_37 entrance_12 up)
            (passage room_37 entrance_13 right)
            (passage room_37 entrance_42 down)
            (passage room_38 entrance_18 down)
            (passage room_38 entrance_19 up)
            (passage room_4 entrance_31 down)
            (passage room_4 entrance_32 up)
            (passage room_4 entrance_35 left)
            (passage room_40 entrance_16 left)
            (passage room_40 entrance_17 up)
            (passage room_45 entrance_20 down)
            (passage room_5 entrance_27 down)
            (passage room_5 entrance_28 up)
            (passage room_7 entrance_39 left)
            (passage room_7 entrance_40 up)
            (passage room_9 entrance_29 down)
            (passage room_9 entrance_30 up))
        (:goal
            (escaped player))
)
