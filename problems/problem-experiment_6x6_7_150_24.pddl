(define (problem problem-experiment_6x6_7_150_24)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_1 entrance_9 right)
            ...
            (passage room_32 entrance_27 left)
            ...
            (passage room_6 entrance_7 right)
            (passage room_6 entrance_8 left)
