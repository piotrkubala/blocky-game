(define (problem problem-experiment_6x6_8_150_9)
    (:domain blocky-game)
        (:objects
            black - colour
            blue - colour
        ...
        (:init
            ...
            (passage room_12 entrance_48 down)
            (passage room_13 entrance_30 left)
            (passage room_13 entrance_40 down)
            ...
            (passage room_15 entrance_45 right)
