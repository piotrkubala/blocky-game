(define (problem problem-experiment_6x6_6_150_32)
    (:domain blocky-game)
        (:objects
            black - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_0 entrance_16 down)
            (passage room_0 entrance_17 right)
            (passage room_1 entrance_23 left)
            (passage room_1 entrance_24 up)
            (passage room_1 entrance_26 right)
            (passage room_10 entrance_29 left)
            (passage room_10 entrance_30 right)
            (passage room_10 entrance_36 up)
            (passage room_13 entrance_33 down)
            ...
            (passage room_22 entrance_21 left)
            (passage room_22 entrance_22 right)
            (passage room_22 entrance_37 down)
            (passage room_23 entrance_10 down)
            (passage room_23 entrance_11 up)
            ...
            (passage room_28 entrance_41 right)
            (passage room_3 entrance_20 left)
            (passage room_3 entrance_31 right)
            ...
            (passage room_5 entrance_25 down)
