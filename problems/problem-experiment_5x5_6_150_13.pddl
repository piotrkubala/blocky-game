(define (problem problem-experiment_5x5_6_150_13)
    (:domain blocky-game)
        (:objects
            cyan - colour
            green - colour
        ...
        (:init
            ...
            (passage room_16 entrance_18 right)
            (passage room_16 entrance_19 left)
            (passage room_16 entrance_8 down)
            (passage room_17 entrance_12 right)
