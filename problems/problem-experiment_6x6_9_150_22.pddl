(define (problem problem-experiment_6x6_9_150_22)
    (:domain blocky-game)
        (:objects
            beige - colour
            black - colour
        ...
        (:init
            ...
            (passage room_22 entrance_34 left)
            (passage room_22 entrance_35 up)
            (passage room_23 entrance_43 left)
            (passage room_23 entrance_44 up)
            (passage room_23 entrance_45 down)
            (passage room_24 entrance_1 up)
            (passage room_25 entrance_28 up)
            (passage room_26 entrance_22 up)
            (passage room_27 entrance_36 down)
            (passage room_3 entrance_12 left)
