(define (problem problem-experiment_6x6_5_150_36)
    (:domain blocky-game)
        (:objects
            brown - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_10 entrance_22 down)
            (passage room_11 entrance_31 right)
            (passage room_11 entrance_32 left)
            (passage room_12 entrance_37 up)
            (passage room_13 entrance_35 up)
            (passage room_13 entrance_36 down)
