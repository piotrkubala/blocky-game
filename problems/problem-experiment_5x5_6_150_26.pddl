(define (problem problem-experiment_5x5_6_150_26)
    (:domain blocky-game)
        (:objects
            beige - colour
            cyan - colour
        ...
        (:init
            ...
            (passage room_9 entrance_15 right)
            (passage room_9 entrance_4 left)
            (passage room_9 entrance_5 up)
            (passage room_9 entrance_9 down))
        (:goal
            (escaped player))
)
