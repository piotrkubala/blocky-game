(define (problem problem-experiment_6x6_8_150_17)
    (:domain blocky-game)
        (:objects
            cyan - colour
            gold - colour
        ...
        (:init
            ...
            (passage room_0 entrance_26 down)
            (passage room_0 entrance_28 right)
            (passage room_0 entrance_29 up)
            (passage room_1 entrance_38 right)
            (passage room_1 entrance_39 down)
            (passage room_11 entrance_24 down)
            (passage room_11 entrance_30 up)
            (passage room_12 entrance_15 left)
            (passage room_12 entrance_27 right)
            (passage room_13 entrance_22 down)
            (passage room_13 entrance_23 up)
            (passage room_13 entrance_25 right)
            (passage room_14 entrance_18 down)
            (passage room_14 entrance_34 right)
            (passage room_14 entrance_35 left)
            (passage room_15 entrance_40 up)
            (passage room_17 entrance_31 down)
            (passage room_19 entrance_19 left)
            (passage room_19 entrance_32 up)
            (passage room_19 entrance_8 down)
            (passage room_19 entrance_9 right)
            (passage room_20 entrance_16 left)
            (passage room_20 entrance_17 up)
            (passage room_21 entrance_46 down)
            (passage room_22 entrance_12 left)
            ...
            (passage room_25 entrance_7 up)
            (passage room_29 entrance_1 up)
            (passage room_3 entrance_36 right)
            (passage room_3 entrance_37 left)
            (passage room_30 entrance_13 left)
            (passage room_30 entrance_14 right)
            (passage room_31 entrance_10 left)
            (passage room_31 entrance_11 right)
            (passage room_31 entrance_33 down)
            (passage room_31 entrance_41 up)
            (passage room_33 entrance_42 down)
            (passage room_33 entrance_43 up)
            (passage room_34 entrance_44 down)
            (passage room_34 entrance_45 up)
